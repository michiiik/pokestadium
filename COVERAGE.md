...
<!-- AUTO_COVERAGE:START -->
- Functions with C implementations: **7,244 / 7,437 (97.4%)**
- Remaining `GLOBAL_ASM` owners: **193** (across 68 source files)
<!-- AUTO_COVERAGE:END -->
...
| `src/fragments/battle_engine/battle_engine_3020D0.c` | 1 |
| `src/fragments/battle_engine/battle_engine_317E70.c` | 1 |
...
| `src/fragments/credits/credits_15A2B0.c` | 2 |
| `src/fragments/demo_scenes/demo_scenes_169510.c` | 1 |
| `src/fragments/gallery_album/gallery_album.c` | 2 |
| `src/fragments/gallery_camera/gallery_camera_14CA70.c` | 1 |
...
| `src/fragments/gb_tower_emulator/gb_tower_emulator_7F9A0.c` | 19 |
| `src/fragments/gb_tower_emulator/gb_tower_emulator_86920.c` | 1 |
| `src/fragments/gb_tower_emulator/gb_tower_emulator_86C30.c` | 1 |
| `src/fragments/gb_tower_emulator/gb_tower_emulator_86CB0.c` | 13 |
| `src/fragments/lab_pc/lab_pc_1A9780.c` | 4 |
| `src/fragments/lab_pc/lab_pc_1AE680.c` | 6 |
| `src/fragments/lab_pc/lab_pc_1B4EA0.c` | 3 |
...
| `src/fragments/minigame_actor_framework/minigame_actor_framework_119FB0.c` | 1 |
| `src/fragments/minigame_actor_framework/minigame_actor_framework_11BF90.c` | 1 |
...
| `src/fragments/particle_data_library/particle_data_library_2558B0.c` | 7 |
...
| `src/fragments/particle_data_library/particle_data_library_258080.c` | 7 |
| `src/fragments/particle_math/particle_math_264380.c` | 1 |
| `src/fragments/pokedex/pokedex_214920.c` | 2 |
| `src/fragments/pokedex/pokedex_2190D0.c` | 2 |
| `src/fragments/rattata_game/rattata_game.c` | 2 |
| `src/fragments/stadium_select/stadium_select.c` | 1 |
| `src/fragments/sushi_game/sushi_game_144300.c` | 3 |
| `src/fragments/sushi_game/sushi_game_1462A0.c` | 2 |
