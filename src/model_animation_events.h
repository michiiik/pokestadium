...
typedef struct unk_D_800ABD00 {
    /* 0x00 */ u8 isActive; // ModelAnim_BeginEventContext: 1 when eventData != NULL, else 0
    /* 0x02 */ s16 currentFrame;
    /* 0x04 */ unk_D_86002F58_004_000_054_004* eventData;
    /* 0x08 */ void* eventIndexTable; // unk_func_80017540_arg1[], resolved via ModelAnim_ResolveEventIndex
    /* 0x0C */ void* eventIdTable; // per-frame event id bytes, indexed by the resolved index
} unk_D_800ABD00; // size = 0x10

typedef struct unk_func_80017540_arg1 {
    /* 0x00 */ u16 keyCount; // ModelAnim_ResolveEventIndex: frame-count span for this key
    /* 0x02 */ u16 baseIndex;
