...
void TeamSelection_DrawTitleHeader(void) {
    ...
    Font_Printf(0x6A, 0x2C, TeamSelection_GetLabelText(D_84210D70[D_800AE540.sessionMode]));
    Gfx_SetEnvColor(0xFF, 0xFF, 0x77, 0xFF);
    Font_Printf(0x68, 0x2A, TeamSelection_GetLabelText(D_84210D70[D_800AE540.sessionMode]));
...
void TeamSelection_DrawCategoryScreen(s16 arg0, s16 arg1, s16 arg2) {
    ...
    if (arg2 > 0) {
        ...
        if (arg2 == 9) {
            ...
            Font_BeginTranslucentTextRendering();
            Font_SetActive(0x10, 0);
            Font_Printf(0x7D, 0x8B, "%s %s", TeamSelection_GetLabelText(D_800AE540.modeCategory + 0x3F), TeamSelection_GetLabelText(0x48));
...
void TeamSelection_DrawFrame(s16 arg0, s16 arg1) {
    ...
    if ((D_800AE540.sessionMode == 0) && (arg1 >= 0)) {
        if (D_84210D48 == 0) {
            var_t0 = 1;
        } else {
            if ((D_84210D48 % 12) >= 5) {
...
void TeamSelection_RunInputLoop(s16 arg0, s16 arg1, s16 arg2) {
    ...
    Input_SetRepeatController(&gControllers[D_842168A0.controllerIndex]);
...
void TeamSelection_InitializeSlots(void) {
    ...
    for (i = 0; i < 4; i++, var_v0++) {
        if (var_v0->slotState & 1) {
            if (!(var_v0->slotState & 2)) {
                D_8423D3D8[var_v0->trainerSlotId].unk_00 = 1;
                D_8423D3D8[var_v0->trainerSlotId].unk_04 = var_v0;
            } else if (D_800AE540.sessionMode == 0) {
                D_8423D3D8[var_v0->trainerSlotId].unk_00 = 1;
                D_8423D3D8[var_v0->trainerSlotId].unk_04 = var_v0;
                D_8423D3D8[var_v0->trainerSlotId].unk_01 = 4;
                D_8423D3D8[var_v0->trainerSlotId].unk_02 = 0;
            }
        }
    }
}
...
void TeamSelection_InitializeSlot(unk_D_8423D3D8* arg0, s16 arg1) {
    ...
    if (arg1 < 4) {
        ...
        Text_UntranscodeName(sp50, sp38.playerName);
        var_v1 = sp38.trainerId;
    } else {
...
s32 Team_CommitSelectionToTrainer(unk_D_8423D3D8* arg0, s16 arg1) {
    ...
    arg0->unk_04->partyCount = 0;
    if (arg1 == 4) {
        temp_s3 = RegisteredTeam_LoadSelected(&D_84229EB0, &sp34);
        if (sp34 != NULL) {
            arg0->unk_04->trainerId = sp34->trainerId;
            if (D_800AE540.sessionMode != 0) {
                HAL_Strcpy(arg0->unk_04->shortName, sp34->playerName);
            }
            HAL_Strcpy(arg0->unk_04->extendedRoster->shortName, sp34->playerName);

            for (i = 0; i < temp_s3; i++) {
                Trainer_AddPokemon(arg0->unk_04, &sp34->monSlots[i].mon);
            }
            var_s0 = 1;
        }
    } else {
        arg0->unk_04->trainerId = D_84211B50.unk_001C;
        if (D_800AE540.sessionMode != 0) {
            HAL_Strcpy(arg0->unk_04->shortName, D_84211B50.unk_001E);
        }
        HAL_Strcpy(arg0->unk_04->extendedRoster->shortName, D_84211B50.unk_001E);

        if (D_84211B50.filledCount > 0) {
            for (i = 0; i < D_84211B50.filledCount; i++) {
                Trainer_AddPokemon(arg0->unk_04, &D_84211B50.monSlots[i].mon);
            }
            var_s0 = 1;
        }
    }
...
void TeamSelection_ApplySlotSelection(s16 arg0, s16 arg1) {
    ...
    if (temp_v1->partyCount != 0) {
        if (arg1 == 4) {
            TeamSelection_RegisteredTeam_ApplySelection(&D_84229EB0, temp_v1->extendedRoster->party[0].sourceSlot);
        } else {
            Rental_CopyRosterToTeam(&D_84211B50, &temp_v1->extendedRoster->party, temp_v1->extendedRoster->partyCount);
        }
    }
}
...
s32 Team_SelectTeams(void) {
    ...
    if ((D_800AE540.sessionMode == 7) && (D_800AE540.progressIndex == 9)) {
    ...
    while (var_s1 >= 0 && var_s1 < 4) {
        if (D_8423D3D8[var_s1].unk_00 != 0) {
            ...
            D_8423D3D8[var_s1].unk_04->partyCount = 0;

            if (var_s2 < 0) {
                var_s1 -= 1;
                while (var_s1 >= 0) {
                    if (D_8423D3D8[var_s1].unk_00 != 0) {
                        var_s2 = (D_8423D3D8[var_s1].unk_04->party[0].sourceAndFlags & 0x70) >> 4;
                        break;
                    }
                    var_s1--;
                }
...
s32 Team_SelectRegisteredTeams(void) {
    ...
    while ((var_s1 >= 0) && (var_s1 < 4)) {
        if (D_8423D3D8[var_s1].unk_00 != 0) {
            if (D_8423D3D8[var_s1].unk_04->partyCount == 0) {
                var_s2 = TeamSelection_RunModal(D_8423D3D8[var_s1].unk_02, 0, D_8423D3D8[var_s1].unk_01, 1);
            } else {
                var_s2 = ((D_8423D3D8[var_s1].unk_04->party[0].sourceAndFlags & 0x70) >> 4);
            }
...
void RegisteredTeam_Register(void) {
    ...
    while (true) {
        ...
        if (temp_v0 < 4) {
            ...
            Text_UntranscodeName(sp74, sp60.playerName);
            var_s1 = sp60.trainerId;
        } else {
...
void Rental_LoadBackgroundImage(void) {
    ...
    if (D_800AE540.sessionMode == 7) {
        ...
        D_84211B34 = BinArchive_GetFile(D_84211B30, D_84210D4C[D_800AE540.sessionMode]);
    }
}
...
s32 Rental_Main(s32 arg0, UNUSED s32 arg1) {
    ...
    Save_EnsureBankLoaded(D_800AE540.modeCategory / 4);
    Save_SetActiveRecordBank(D_800AE540.modeCategory);
    ...
    } else if (D_800AE540.battleFlowFlags & 0x20) {
        var_v1 = Team_SelectRegisteredTeams();
        D_800AE540.battleFlowFlags = D_800AE540.battleFlowFlags & 0xFFDF;
    } else {
        D_800AE540.sessionFlowFlags &= 0xFFFD;
