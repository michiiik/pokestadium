...
Gfx* Particle31_BuildDisplayList(Gfx* gfx, unk_D_810047E0* arg1, unk_arg2_func_81001D80* arg2, s16 arg3) {
    ...
    for (i = 0; i < 10; i++, arg1++) {
        if (arg1->active == 1) {
            gfx = Particle31_BuildSlotDisplayList(gfx, arg1, arg2, arg3);
        }
    }
    return gfx;
}
...
#ifdef NON_MATCHING
void Particle31_UnpackSlotData(unk_arg0_func_81002260* arg0, unk_arg0_func_81002174* arg1) {
