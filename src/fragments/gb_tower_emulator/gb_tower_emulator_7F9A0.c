...
void GbEmu_DrawStatusScreen(s32, s32);
void func_8120241C(void);
void GbEmu_ComposeBorderFrame(u8*, u16 (*)[6][0x640], s32, s32);
void GbApu_Init(void);
...
void GbEmu_Init(unk_D_800AA660* arg0) {
  D_8122C4FC = 0;
  gGbEmuPresentationMode = arg0->launchData.presentationMode;
  if ((gGbEmuPresentationMode < 0) || (gGbEmuPresentationMode >= 3)) {
      gGbEmuPresentationMode = 0;
  }
  gGbEmuButtonBindingSelections.unk_00 = ((arg0->launchData.buttonBindingsPacked & 0xFF00) >> 8);
  gGbEmuButtonBindingSelections.unk_01 = (arg0->launchData.buttonBindingsPacked + 1) & 0xFF;
  GbEmu_ApplyButtonMapping();
  gGbEmuFont1Data = arg0->font1 + 0x90;
  gGbEmuFont2Data = arg0->font2 + 0x90;
  GbEmu_Startup(0, GbSave_GetActivePort(), 5, 0x50, &gSIEventMesgQueue, arg0->launchData.partyIconFrames);
}

void GbEmu_RunFrame(unk_D_800AA660* arg0) {
  if (GbEmu_ProcessFrameStateMachine(0) != 0) {
      arg0->launchData.buttonBindingsPacked = ((gGbEmuButtonBindingSelections.unk_01 - 1) & 0xFF) | (gGbEmuButtonBindingSelections.unk_00 << 8);
...
void GbEmu_AudioVideoTick(UNUSED unk_D_800AA664* arg0) {
  if ((D_800A62E0.shutdownCounter == 0) && (D_8122C4FC == 2) && ((D_8122C4DC == 0) || (D_8122C4DC == 6))) {
      GbAudio_ServiceOutputBuffer();
  }
}
