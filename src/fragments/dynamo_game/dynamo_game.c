...
void DynamoGame_ComputeAIChargeDelta(unk_D_8650A528* arg0, u8 arg1) {
    if (arg0->unk_000 == 4) {
        arg0->unk_00D = 0;
        return;
    }
    ...
    if (arg1 == 0) {
        arg0->unk_00D = MiniGame_RandomRange(3);
    } else if ((D_8650AD84 + 1) == D_8650AD85) {
        arg0->unk_00D = DynamoGame_RollAIChargeBias(arg0->unk_000, 1);
    } else {
        arg0->unk_00D = DynamoGame_RollAIChargeBias(arg0->unk_000, 0);
    }
}

void DynamoGame_InitPlayerSlots(void) {
    s8 i;
...
void DynamoGame_AssignTeams(void) {
    u8 i;
...
void DynamoGame_UpdatePlayerAnimState(void) {
    u8 i;
    s8 temp_ft2;
    u8 var_s1;
    s32 sp58;
    ...
    if (D_8780FC94 != 1) {
        for (i = 0; i < 4; i++) {
            ...
            if (D_87B000C8 != 0) {
                ...
                } else if (ModelAnim_IsFinished(&D_8650AB28->unk_014) != 0) {
                ...
                if ((D_8780FC92 == 0) && (D_8780FC94 == 0)) {
                    Audio_DispatchSoundBankCommand(0x80001, i, 0);
                }
            } else if ((D_86502CD4 == 0) && (D_8650AB28->unk_00E < 3) && (D_8650AB28->unk_008 == 2)) {
                D_8650AB28->unk_008 = 3;
                var_s1 = 1;
                if ((D_8780FC92 == 0) && (D_8780FC94 == 0)) {
                    Audio_DispatchSoundBankCommand(0x80001, i, 5);
                }
            } else {
                if ((D_8780FC92 == 0) && (D_8780FC94 == 0)) {
                    ...
                    Audio_DispatchSoundBankCommand(0x80001, i, var_s0_2);
                    Audio_DispatchSoundBankCommand(0x80002, i, var_s0_2);
                }

                if (ModelAnim_IsFinished(&D_8650AB28->unk_014) != 0) {
                    switch (D_8650AB28->unk_008) {
                        case 0:
                        case 3:
                            var_s1 = 1;
            ...
            if (!!var_s1) {
                if (D_8650AB28->unk_008 != sp58) {
                    ModelAnim_SetAnimation(&D_8650AB28->unk_014, D_8650AB28->unk_008);
                    if (D_8650AB28->unk_008 != 0) {
                        ModelAnim_SetEventTrack(&D_8650AB28->unk_014, D_8650AB28->unk_008);
                    }
                } else if (D_8650AB28->unk_008 == 6) {
                    if (D_8650AB28->unk_004 == 0) {
                        ModelAnim_SetFrame(&D_8650AB28->unk_014, 0x1B);
                        ModelAnim_SetEventFrame(&D_8650AB28->unk_014, 0x1B);
                    } else if (D_8650AB28->unk_004 == 1) {
                        ModelAnim_SetFrame(&D_8650AB28->unk_014, 0x4B);
                    ...
                    if (D_8650AB28->unk_008 != 0) {
                        ModelAnim_SetEventFrame(&D_8650AB28->unk_014, 0);
                    }
                }
            }
        }
...
void DynamoGame_SyncChainLinkAnimations(void) {
    u8 i;
    u32 var_a0;
    ...
    for (i = 0; i < 13; i++) {
        ...
        if (var_a0 != 0) {
            ModelAnim_SetFrame(D_86502CA0[i], 0);
            ModelAnim_SetEventTrack(D_86502CA0[i], 0);
            ModelAnim_SetEventFrame(D_86502CA0[i], 0);
        }
    }
}

void DynamoGame_DetermineWinners(void) {
    u8 i;
    s16 var_s4 = 0;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if ((D_8650AB28->unk_010 >= D_8650AB28->unk_012) && (var_s4 == D_8650AB28->unk_010)) {
            ...
            if ((D_8780FC92 == 0) && (D_8780FC94 == 0)) {
                Audio_DispatchSoundBankCommand(0x80003, i, 0);
            }
        }
    }
...
void DynamoGame_UpdateCountdownAndCue(UNUSED s32 arg0) {
    Widget_CountdownUpdate();
    DynamoGame_DrawCrankIcon();
}

void DynamoGame_ReadPlayerCrankInput(void) {
    u8 i;
    ...
    if (D_8650AD84 == 2) {
        ...
        if ((D_8650AD84 + 2) == D_8650AD85) {
            ...
            DynamoGame_PickNextCrankCue();
        }
    }
}

void DynamoGame_DrawTutorialScreen(s32 arg0) {
    u8 i;
    ...
    if ((arg0 == 0) || ((arg0 == 3) && (D_87B000D0 == 1))) {
        ...
        Widget_DrawAnimIcon16B(0x62, 0xB0, D_86502CDC);
        Widget_DrawAnimIcon16(0x74, 0xB0, D_86502D4C);
        Widget_DrawAnimIcon16C(0x74, 0xC6, D_86502DBC);
        ...
        for (i = 0; i < 4; i++) {
            if (D_8650A528[i].unk_000 == 4) {
                Widget_DrawPlayerIcon(i, sp5C[i], 0xC6, 0.75f);
            } else {
                Widget_DrawPlayerIcon(-1 - i, sp5C[i], 0xC6, 0.75f);
            }
        }
    ...
    if ((arg0 == 1) || (arg0 == 2) || ((arg0 == 3) && (D_87B000D0 == 0))) {
        for (i = 0; i < 4; i++) {
            ...
            Widget_DrawProgressBar((i * 0x47) + 0x1C, 0xDB, 0x32, D_8650AB28->unk_010, D_8650AB28->unk_012 + 1);
        }
    }
    ...
    if ((arg0 == 0) || ((arg0 == 3) && (D_87B000D0 == 1))) {
        ...
        s32 sp48;
        s32 sp44;
        char* sp40 = Text_GetString(NULL, 0, D_87806330, 0x2D);

        Font_SetActive(2, 0);
        Font_SetLineHeight(0xC);
        Gfx_SetEnvColor(0xFF, 0xFF, 0xFF, 0xFF);
        Gfx_SetPrimColor(0xF9, 0xF4, 0, 0xFF);
        Font_Printf(0xA0 - (Text_MeasureStringWidth(D_87B000E0, Text_GetString(NULL, 0, D_87806330, 0x2C)) / 2), 0x20,
                      Text_GetString(NULL, 0, D_87806330, 0x2C));
        Gfx_SetEnvColor(0xFF, 0xFF, 0xFF, 0xFF);
        Gfx_SetPrimColor(0xFF, 0xFF, 0xFF, 0xFF);
        Font_Printf(0x28, 0x34, sp40);

        temp_s0 = (Text_CountLines(sp40) * 0xC) + 0xC;
        Font_Printf(0x28, temp_s0 + 0x34, Text_GetString(NULL, 0, D_87806330, 0x2E));

        temp_s0 += (Text_CountLines(Text_GetString(NULL, 0, D_87806330, 0x2E)) * 0xC) + 0xC;
        Font_Printf(0x28, temp_s0 + 0x34, Text_GetString(NULL, 0, D_87806330, 0x2F));
        ...
        Widget_MeasureLabelBox(&sp48, &sp44, sp40, Text_GetString(NULL, 0, D_87806330, 0x5F), 0xC);
        Font_Printf(sp48 + 0x28, sp44 + 0x34, Text_GetString(NULL, 0, D_87806330, 0x5F));
        Gfx_SetEnvColor(0xC8, 0xFA, 0xD2, 0xFF);
        Gfx_SetPrimColor(0x32, 0xE6, 0x82, 0xFF);
        Widget_MeasureLabelBox(&sp48, &sp44, sp40, Text_GetString(NULL, 0, D_87806330, 0x60), 0xC);
        Font_Printf(sp48 + 0x28, sp44 + 0x34, Text_GetString(NULL, 0, D_87806330, 0x60));
        Gfx_SetEnvColor(0xC8, 0xC8, 0xFF, 0xFF);
        Gfx_SetPrimColor(0x50, 0x50, 0xFF, 0xFF);
        Font_Printf(0xA2, 0xB2, Text_GetString(NULL, 0, D_87806330, 0x30));
        Gfx_SetEnvColor(0xFF, 0xFF, 0xFF, 0xFF);
...
void DynamoGame_DrawFrame(s32 arg0) {
    u8 i;
    ...
    if (D_8780FC98 == 0) {
        DynamoGame_DrawTutorialScreen(arg0);
    }
            ...
            if (D_87B000C8 == 0) {
                ...
                if (D_86502CD4 >= 0xF) {
                    ...
                    for (i = 0; i < 4; i++) {
                        ...
                        DynamoGame_ComputeAIChargeDelta(D_8650AB28, 1);
                    }

                    if (D_87B000C8 != 0) {
                        DynamoGame_DetermineWinners();
                        DynamoGame_SyncChainLinkAnimations();
                    }
                }
                ...
                switch (D_86502CD8) {
                    ...
                    case 0x83:
                        if ((D_87B000D4 != 4) && (D_8780FC92 == 0)) {
                            Audio_DispatchSoundBankCommand(0x80004, 0, 0);
                            Audio_DispatchSoundBankCommand(0x80005, 0, 0);
                        }
                        break;

                    case 0x96:
                        if ((D_87B000D4 != 4) && (D_8780FC92 == 0)) {
                            Audio_DispatchSoundBankCommand(0x80006, 0, 0);
                        }
                        break;
...
void DynamoGame_WaitForStart(void) {
    u8 i;
    u8 var_s1;
    s32 var_s2;
    ...
    while (var_s2 != 0) {
        ...
        MiniGame_ReadInputs();
        DynamoGame_UpdateCountdownAndCue(0);
        DynamoGame_UpdatePlayerAnimState();
        DynamoGame_DrawFrame(0);
        ...
        while (true) {
            ...
            for (i = 3; i > 0; i--) {
                ...
                if (tmp == D_87B000C4) {
                    ...
                    Audio_DispatchSoundBankCommand(0x80007, 0, 0);
                }
            }
            ...
            MiniGame_ReadInputs();
            DynamoGame_UpdateCountdownAndCue(1);
            DynamoGame_UpdatePlayerAnimState();
            DynamoGame_DrawFrame(1);
        }
    }
}

void DynamoGame_MainLoop(void) {
    ...
    if (D_8780FC92 == 0) {
        DynamoGame_PickNextCrankCue();
        Audio_DispatchSoundBankCommand(0x80008, 0, 0);
        MiniGame_ReadInputs();
        DynamoGame_UpdateCountdownAndCue(2);
        DynamoGame_UpdatePlayerAnimState();
        DynamoGame_DrawFrame(2);
        ...
        while (var_s0 != 0) {
            ...
            if ((D_86502E7C == 0) && (Widget_CountdownGetState() == -2)) {
                Audio_StartMusicTrack(0x1D);
                D_86502E7C = 1;
            }
            ...
            if (D_87B000C8 == 0) {
                DynamoGame_ReadPlayerCrankInput();
            } else if (D_8780FC96 != 0) {
                var_s0 = 0;
            }

            DynamoGame_DrawSparkEffects(2);
            DynamoGame_UpdatePlayerAnimState();
            DynamoGame_DrawFrame(2);
        }
    }
...
void DynamoGame_ShowResultText(void) {
    u8 i;
    ...
    for (i = 0; i < 30; i++) {
        MiniGame_ReadInputs();
        DynamoGame_UpdateCountdownAndCue(3);
        DynamoGame_DrawSparkEffects(3);
        DynamoGame_UpdatePlayerAnimState();
        DynamoGame_DrawFrame(3);
    }
}
...
void DynamoGame_LoadAssets(void) {
    u8 j;
    u8 i;
    MemoryBlock* temp_v0;
    ...
    DynamoGame_InitPlayerSlots();
    DynamoGame_AssignTeams();

    for (i = 0; i < 2; i++) {
        if (i == 0) {
            D_87B000E4 = Model_LoadByArchiveIndex(0xC5);
        } else {
            D_87B000E4 = Model_LoadByArchiveIndex(0xC6);
        }
        ...
        for (j = 0; j < 4; j++) {
            if (i == D_8650A528[j].unk_004) {
                ...
                if (i == 0) {
                    Model_InitDisplayObject(D_8650AB2C, 0, 0xC5, D_87B000E4->unk_08->unk_00[0]);
                } else {
                    Model_InitDisplayObject(D_8650AB2C, 0, 0xC6, D_87B000E4->unk_08->unk_00[0]);
                }
                ...
                DynamoGame_ComputeAIChargeDelta(D_8650AB28, 0);
...

    {
        ...
        for (j = 0; j < 13; j++) {
            if ((j != 2) && (j != 3) && (j != 4)) {
                D_87B000E4 = Model_LoadByArchiveIndex(sp5C[j]);
            }
    ...
    DynamoGame_InitCrankIconDisplay();
    DynamoGame_InitSparkEffects();
    DynamoGame_InitCamera();
    Widget_CountdownInit();
    Widget_PauseMenuInit();
    Widget_DrawAnimIcon16(0, 0, NULL);
    Widget_DrawAnimIcon16B(0, 0, NULL);
}

void DynamoGame_Main(UNUSED s32 arg0, UNUSED s32 arg1) {
    ...
    DynamoGame_LoadAssets();
    StageContext_Activate(sp24);
    DynamoGame_WaitForStart();
    DynamoGame_MainLoop();
    DynamoGame_ShowResultText();
...
s8 DynamoGame_RollAIChargeBias(s32 arg0, s32 arg1) {
    ...
    temp_v0 = MiniGame_RandomRange(var_a0);
