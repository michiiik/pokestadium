...
void SushiGame_NameTagGeoCallback(s32 arg0, UNUSED s32 arg1) {
    UNUSED s32 pad;
    s32 idx;
...
s32 SushiGame_OrthonormalizeBasis(unk_D_86807558_098* arg0) {
    f32 temp_fs0;
...
s16 SushiGame_FindCrossedAnimEvent(unk_D_86002F58_004_000* arg0, s16 arg1) {
    ...
    for (i = 0; i < arg1; i++) {
        if (ModelAnim_HasCrossedFrame(arg0, i) != 0) {
            sp2A = i;
            break;
        }
    }
...
s16 SushiGame_ClassifyDifficultyTier(s16 arg0) {
    s16 ret;
...
f32 SushiGame_ScaleAnimSpeed(s16 arg0) {
...
void SushiGame_ResetPlayerSubState(unk_D_86807558_040* arg0) {
    arg0->unk_00 = 0;
    arg0->unk_02 = 0;
    arg0->unk_18 = 0xFF;
    arg0->unk_0C = 0.0f;
...
void SushiGame_InitPlayerSlot(unk_D_86807558* arg0, s32 arg1, s32 arg2) {
    ...
    arg0->playerIndex = arg1;
    arg0->flags = 0;

    if (D_8780FA30[arg0->playerIndex] == 1) {
        arg0->flags |= 4;
    }
    ...
    arg0->skillLevel = 0x32;
    arg0->eatTimer = 0;

    if (arg0->flags & 4) {
        arg0->unk_008 = D_868070BC[D_8780FA38][(D_8680847C + D_8680847A) % D_8680847E];
        arg0->turnOrder = D_8680847A;
        if (arg0->turnOrder == 0) {
            D_86808478 = arg0->playerIndex;
        }

        D_8680847A++;

        if ((arg2 != 0) && (Rand_Range(4) == 0) && (D_86808480 <= 0)) {
            arg0->unk_008 = 4;
            D_86808480++;
        }
    } else {
    ...
    SushiGame_ResetPlayerSubState(&arg0->unk_040);
    arg0->unk_060 = 0;
    arg0->controller = *D_868070AC[arg0->playerIndex];

    angle = 0xE000 - (arg0->playerIndex << 0xE);

    arg0->position.x = SINS(angle) * D_86806FB8;
    arg0->position.y = 0.0f;
    arg0->position.z = COSS(angle) * D_86806FB8;
    ...
    arg0->unk_098.unk_00.x = arg0->position.x;
    arg0->unk_098.unk_00.y = 0.0f;
    arg0->unk_098.unk_00.z = arg0->position.z;
    ...
    arg0->unk_0BC = 0;
    arg0->unk_0BE = Rand_Range(0x5B) + 0x1E;
    arg0->unk_0C0 = 0;
    arg0->unk_0C4 = 0;
    arg0->unk_0CC = 0;
    arg0->unk_0D0.rgba = -0x100;
    arg0->unk_0C8 = 1.0f;
    arg0->unk_0D4 = SushiGame_ClassifyDifficultyTier(arg0->skillLevel);
    arg0->unk_0D8 = SushiGame_ScaleAnimSpeed(arg0->skillLevel);
    arg0->unk_0DC = 0;
    arg0->unk_0E0 = 0;
    arg0->unk_0E2 = 0;
    ...
    arg0->unk_24C.unk_000.unk_14 = arg0->playerIndex;
    ...
    if (arg2 != 0) {
        arg0->unk_3B4 = D_8780633C[arg0->playerIndex];
    } else if (arg0->flags & 4) {
        arg0->unk_3B4 = D_8780634C[arg0->playerIndex];
    } else {
        arg0->unk_3B4 = D_8780633C[arg0->playerIndex];
    }
}

f32 SushiGame_StickToPanValue(s16 arg0) {
    f32 temp_fv0;
    s16 var_v1;
    s32 var_v0 = 0;
...
s32 SushiGame_ClampPlayerToBelt(unk_D_86807558* arg0) {
    s32 sp1C = 0;
    f32 temp_fa0 = SQ(arg0->position.x) + SQ(arg0->position.z);
    ...
    if (SQ(D_86806FB8) < temp_fa0) {
        ...
        arg0->position.x *= temp_fa0;
        arg0->position.z *= temp_fa0;
    }

    if (arg0->position.y <= 0.0f) {
        arg0->position.y = 0.0f;
        arg0->velocity.y = 0.0f;
        sp1C = 1;
    }
...
s32 SushiGame_ComputeStereoPan(unk_D_86807558* arg0) {
    f32 var_fv0 = arg0->position.x - D_86808498.unk_0C.x;
    s32 var_v1;
...
void SushiGame_SetPlayerEatState(unk_D_86807558* arg0, u32 arg1) {
    arg0->unk_060 = arg1;
    ...
    switch (arg1) {
        ...
        case 1:
            ...
            arg0->velocity.z = 0.0f;
            arg0->velocity.x = 0.0f;
            Audio_DispatchSoundBankCommand(0x50008, arg0->playerIndex + 1, SushiGame_ComputeStereoPan(arg0));
            arg0->unk_0C0 = 2;
            arg0->unk_0C8 = 1.0f;
            break;
        ...
        case 2:
            ...
            arg0->unk_0DC = 0;
            arg0->unk_0C8 = 1.0f;
            Audio_DispatchSoundBankCommand(0x50009, arg0->playerIndex + 1, SushiGame_ComputeStereoPan(arg0));
            break;
        ...
        case 3:
            ...
            arg0->unk_0DC = 0;
            arg0->unk_0C8 = 1.0f;
            Audio_DispatchSoundBankCommand(0x5000A, arg0->playerIndex + 1, SushiGame_ComputeStereoPan(arg0));
            break;
        ...
        case 4:
            ...
            arg0->velocity.x = arg0->velocity.z = 0.0f;
            arg0->unk_0C8 = 1.0f;
            break;
    }
}

s32 SushiGame_IsPlateGrabbable(unk_D_868084D8* arg0, s32 arg1, s32 arg2) {
    if (arg0 == NULL) {
        return 1;
    }
    ...
    if ((arg1 != 0) && (arg0->sushiType == 1)) {
        return 0;
    }

    if (arg2 != 0) {
        if ((arg0->state != 1) && (arg0->state != 2)) {
            return 0;
        }
...
unk_D_86807558* SushiGame_FindPlateClaimant(unk_D_86807558* arg0, unk_D_868084D8* arg1) {
    s32 i;
    unk_D_86807558* ret = NULL;
    unk_D_86807558* ptr;

    for (i = 0, ptr = D_86807558; i < 4; i++, ptr++) {
        if ((ptr != arg0) && (arg1 == ptr->currentPlate)) {
            ret = ptr;
            break;
        }
    }
...
unk_D_868084D8* SushiGame_FindNearestGrabbablePlate(unk_D_86807558* arg0) {
    s32 i;
    f32 temp_fa0;
    f32 var_fs0;
    s32 var_s4;
    ...
    for (i = 0, var_s0 = D_868084D8; i < 12; i++, var_s0++) {
        if (SushiGame_IsPlateGrabbable(var_s0, var_s6, var_s4) == 0) {
            continue;
        }

        temp_v0_2 = SushiGame_FindPlateClaimant(arg0, var_s0);
        if (temp_v0_2 != NULL) {
            if (temp_v0_2->turnOrder >= arg0->turnOrder) {
                temp_v0_2->currentPlate = 0;
            } else {
                continue;
            }
        }

        temp_fa0 = SQ(var_s0->unk_14.x - arg0->position.x) + SQ(var_s0->unk_14.z - arg0->position.z);
        if (temp_fa0 < var_fs0) {
            var_s5 = var_s0;
            var_fs0 = temp_fa0;
        }
...
unk_D_868084D8* SushiGame_FindHighestValuePlate(unk_D_86807558* arg0) {
    s32 i;
    f32 temp_fa0;
    f32 var_fs0;
    s16 var_a0;
    ...
    for (i = 0, var_s0 = D_868084D8; i < 12; i++, var_s0++) {
        if (SushiGame_IsPlateGrabbable(var_s0, var_s7, var_s5) == 0) {
            continue;
        }
        ...
        if (temp_v0_2 != NULL) {
            if (temp_v0_2->turnOrder >= arg0->turnOrder) {
                temp_v0_2->currentPlate = NULL;
            } else {
                continue;
            }
        }

        var_v1 = SushiGame_GetPlateValue(var_s0);
        if (var_s0->sushiType == arg0->unk_05C) {
            var_a0 = arg0->unk_03E;
            if (var_a0 < 5) {
                var_a0++;
            }
        ...
        if (var_s2 < var_v1) {
            var_s4 = var_s0;
            var_s2 = var_v1;
            var_fs0 = SQ(var_s0->unk_14.x - arg0->position.x) + SQ(var_s0->unk_14.z - arg0->position.z);
...
unk_D_868084D8* SushiGame_FindComboOrAbundantPlate(unk_D_86807558* arg0) {
    s32 i;
    s16 sp4A;
    f32 temp_fa0;
    f32 var_fs0;
    ...
    if (arg0->unk_05C != 0) {
        for (i = 0, var_s0 = D_868084D8; i < 12; i++, var_s0++) {
            if ((SushiGame_IsPlateGrabbable(var_s0, var_s6, var_s7) == 0) || (arg0->unk_05C != var_s0->sushiType)) {
                continue;
            }
    ...
    if (var_s5 == NULL) {
        ...
        for (i = 0; i < 8; i++) {
            s32 v = D_86807160[i];
            if (v != 1) {
                if (sp4A < SushiGame_GetActivePlateCount(v)) {
                    var_s4 = v;
                    sp4A = SushiGame_GetActivePlateCount(v);
                }
            }
        }
        ...
        if (var_s4 != 0) {
            for (i = 0, var_s0 = D_868084D8; i < 12; i++, var_s0++) {
                if ((SushiGame_IsPlateGrabbable(var_s0, var_s6, var_s7) == 0) || (var_s4 != var_s0->sushiType)) {
                    continue;
                }
        ...
        if (var_s5 == NULL) {
            var_s5 = SushiGame_FindHighestValuePlate(arg0);
        }
    }
...
unk_D_868084D8* SushiGame_FindTypeOnePlate(unk_D_86807558* arg0) {
    s32 i;
    f32 temp_fa0;
    f32 var_fs0;
    unk_D_868084D8* var_s0;
    ...
    for (i = 0, var_s0 = D_868084D8; i < 12; i++, var_s0++) {
        if ((SushiGame_IsPlateGrabbable(var_s0, 0, 1) == 0) || (var_s0->sushiType != 1)) {
            continue;
        }
    ...
    for (i = 0, var_s0 = D_868084D8; i < 12; i++, var_s0++) {
        if ((SushiGame_IsPlateGrabbable(var_s0, 0, 1) == 0) || !(var_s0->flags & 2)) {
            continue;
        }
...
void SushiGame_DirectionToStickInput(Vec3f* arg0, f32 arg1, s16* arg2, s16* arg3, f32 arg4) {
...
void SushiGame_ComputeCpuInput(unk_D_86807558* arg0, Controller* arg1) {
    s16 var_a1;
    s16 var_a2;
    f32 sp60;
    Vec3f sp54;
    ...
    if (arg0->unk_014 <= 0) {
        ...
        arg0->currentPlate = NULL;
    } else {
        if (SushiGame_IsPlateGrabbable(arg0->currentPlate, var_a1, var_a2) == 0) {
            arg0->currentPlate = NULL;
        }
    }
    ...
    if (sp50 != 0) {
        switch (arg0->unk_008) {
            case 1:
                arg0->currentPlate = SushiGame_FindNearestGrabbablePlate(arg0);
                break;

            case 2:
                arg0->currentPlate = SushiGame_FindComboOrAbundantPlate(arg0);
                break;

            case 3:
                arg0->currentPlate = SushiGame_FindHighestValuePlate(arg0);
                break;

            case 4:
                arg0->currentPlate = SushiGame_FindTypeOnePlate(arg0);
                break;
        }
    }

    if (arg0->currentPlate == NULL) {
        if (arg0->unk_008 == 4) {
            sp54.x = 0.0f - arg0->position.x;
            sp54.y = 0.0f;
            sp54.z = 0.0f - arg0->position.z;

            temp_fv0 = SQ(sp54.x) + SQ(sp54.z);
            if (temp_fv0 > 30.0f) {
                SushiGame_DirectionToStickInput(&sp54, temp_fv0, &arg1->rawStickX, &arg1->rawStickY, 0.5f);
            }
        }
    } else {
        sp54.y = 0.0f;
        sp60 = SushiGame_ComputePlateDistance(arg0->currentPlate, &arg0->position, &sp54);
        ...
        if ((sp60 <= 13225.0f) && (sp60 != 0.0f)) {
            ...
            if (tmp >= 0.8f) {
                ...
                SushiGame_DirectionToStickInput(&sp54, sp60, &arg1->rawStickX, &arg1->rawStickY, sp30[D_8780FA38]);
            }
        } else {
            SushiGame_DirectionToStickInput(&sp54, sp60, &arg1->rawStickX, &arg1->rawStickY, sp30[D_8780FA38]);
        }
...
f32 SushiGame_ComputeEatFadeEnvelope(s16 arg0, s32 arg1) {
...
void SushiGame_UpdatePlayerPhysics(unk_D_86807558* arg0) {
    ...
    if (arg0->flags & 2) {
        if (!(arg0->flags & 4)) {
            spA4 = arg0->controller;
        } else {
            SushiGame_ComputeCpuInput(arg0, &sp80);
            spA4 = &sp80;
        }
    } else {
        spA4 = &D_86808450;
    ...
    switch (arg0->unk_060) {
        case 0:
            if (spA4->buttonPressed & 0x8000) {
                SushiGame_SetPlayerEatState(arg0, 1);
                return;
            }

            spAC = SushiGame_StickToPanValue(spA4->rawStickX);
            spA8 = SushiGame_StickToPanValue(spA4->rawStickY);
            break;
        ...
        case 3:
            arg0->eatTimer--;
            if (arg0->unk_060 == 2) {
                spB8 = SushiGame_ComputeEatFadeEnvelope(arg0->eatTimer, 0);
            } else {
                spB8 = SushiGame_ComputeEatFadeEnvelope(arg0->eatTimer, 1);
            }

            if (arg0->eatTimer <= 0) {
                arg0->eatTimer = 0;
                SushiGame_SetPlayerEatState(arg0, 0);
                return;
            }

            if (!(arg0->eatTimer & 0xF)) {
    ...
    arg0->velocity.x = sp64.x + sp58.x;
    arg0->velocity.y = sp64.y + sp58.y;
    arg0->velocity.z = sp64.z + sp58.z;

    arg0->velocity.x = ABS_NORMALIZED(arg0->velocity.x);
    arg0->velocity.y = ABS_NORMALIZED(arg0->velocity.y);
    arg0->velocity.z = ABS_NORMALIZED(arg0->velocity.z);

    if (arg0->unk_060 == 0) {
        if ((SQ(arg0->velocity.x) + SQ(arg0->velocity.z)) < 0.25f) {
            if (arg0->unk_0C0 == 1) {
                arg0->unk_0C0 = 0;
                arg0->unk_0C8 = 1.0f;
            }
    ...
    arg0->position.x = arg0->velocity.x + sp70.x;
    arg0->position.y = arg0->velocity.y + sp70.y;
    arg0->position.z = arg0->velocity.z + sp70.z;

    SushiGame_ClampPlayerToBelt(arg0);
...
unk_D_868084D8* SushiGame_FindPlateNearMouth(unk_D_86807558* arg0) {
    ...
    for (i = 0, var_v1 = D_868084D8; i < 12; i++, var_v1++) {
        if (((var_v1->flags & 1) != 0) && (var_v1->state == 2)) {
            if (SQ(D_86806FBC) >=
...
s32 SushiGame_CheckEatInterrupt(unk_D_86807558* arg0) {
    ...
    if (ModelAnim_IsFinished(&arg0->unk_0E4) != 0) {
        return 2;
    }
    ...
    for (i = 0, var_v0 = D_86807558; i < 4; i++, var_v0++) {
        ...
        temp_fv0 = var_v0->position.x - sp2C.x;
        temp_fv1 = (var_v0->position.y + D_86806FB4) - sp2C.y;
        temp_fa0 = var_v0->position.z - sp2C.z;
...
void SushiGame_ConsumePlate(unk_D_86807558* arg0) {
    s32 sp24;
    s32 sp20;

    if (arg0->unk_0DC->flags & 2) {
        sp24 = 1;
    } else {
        sp24 = 0;
    }

    sp20 = arg0->unk_0DC->sushiType;
    ...
    arg0->unk_018 += SushiGame_GetPlateValue(arg0->unk_0DC) * arg0->unk_03E;
    arg0->unk_02A++;
    arg0->unk_02C[sp20]++;

    SushiGame_SetPlateState(arg0->unk_0DC, 0, NULL);

    if (sp20 == 1) {
        SushiGame_SetPlayerEatState(arg0, 2);
    } else if ((sp24 != 0) && (arg0->flags & 2)) {
        SushiGame_SetPlayerEatState(arg0, 3);
    } else {
        SushiGame_SetPlayerEatState(arg0, 0);
    }
}

void SushiGame_UpdateEatingState(unk_D_86807558* arg0) {
    switch (arg0->unk_0C0) {
        case 2:
            if (ModelAnim_IsFinished(&arg0->unk_0E4) != 0) {
                arg0->unk_0C0 = 3;
        ...
        case 3:
            if (arg0->unk_0DC == NULL) {
                arg0->unk_0DC = SushiGame_FindPlateNearMouth(arg0);
                if (arg0->unk_0DC != NULL) {
                    arg0->unk_0CC = SushiGame_FindCrossedAnimEvent(&arg0->unk_0E4, 0xD);
                    SushiGame_SetPlateState(arg0->unk_0DC, 3, arg0);
                }
            }

            if (arg0->unk_0C8 >= 0.0f) {
                switch (SushiGame_CheckEatInterrupt(arg0)) {
                    case 1:
                    case 2:
                        arg0->unk_0C8 = -1.0f;
                        break;
                    ...
                    case 3:
                        if (SushiGame_FindCrossedAnimEvent(&arg0->unk_0E4, 0xD) < 3) {
                            arg0->unk_0C0 = 4;
                        } else {
                            arg0->unk_0C8 = -1.0f;
                        }
            ...
            } else if (ModelAnim_HasCrossedFrame(&arg0->unk_0E4, 0) != 0) {
                if (arg0->unk_0DC == NULL) {
                    arg0->unk_0C0 = 4;
                } else if (arg0->unk_0DC->sushiType != 1) {
                    arg0->unk_0C0 = 5;
                    arg0->eatTimer = arg0->unk_0D4;
                } else {
                    SushiGame_ConsumePlate(arg0);
                }
                arg0->unk_0C8 = 1.0f;
            }
            break;
        ...
        case 5:
            if (ModelAnim_IsFinished(&arg0->unk_0E4) != 0) {
                ...
                if (arg0->eatTimer <= 0) {
                    ...
                    ModelAnim_SetFrame(&arg0->unk_0E4, 0);
                }
            }
            break;
...
void SushiGame_UpdateReturnToCenterState(unk_D_86807558* arg0) {
    UNUSED s32 pad;
    Vec3f sp30;
    f32 temp_fa0;
    f32 tmp;
    ...
    if ((arg0->unk_028 != 1) || (arg0->unk_018 == 0)) {
        if (ModelAnim_IsFinished(&arg0->unk_0E4) != 0) {
            ModelAnim_SetFrame(&arg0->unk_0E4, 0x3D);
        }
        ...
        sp30.x = D_86808498.unk_0C.x - arg0->position.x;
        sp30.y = 0.0f;
        sp30.z = D_86808498.unk_0C.z - arg0->position.z;
...
void SushiGame_ResolvePlayerCollisions(unk_D_86807558* arg0) {
    s32 i;
    f32 sp68;
    f32 temp_fa0;
    f32 sp60;
    ...
    for (i = 0, var_s1 = D_86807558; i < 4; i++, var_s1++) {
        ...
        temp_fs4 = var_s1->position.x - arg0->position.x;
        temp_fs5 = var_s1->position.y - arg0->position.y;
        sp60 = var_s1->position.z - arg0->position.z;
        ...
        if (temp_fa0 < (4.0f * D_86806FB0 * D_86806FB0)) {
            ...
            temp_fv0_3 = sqrtf(SQ(var_s1->velocity.x) + SQ(var_s1->velocity.y) + SQ(var_s1->velocity.z));
            arg0->flags |= 1;
...
void SushiGame_ApplyCollisionPush(unk_D_86807558* arg0) {
    if (arg0->flags & 1) {
        arg0->position.x += arg0->unk_080.x + arg0->unk_08C.x;
        arg0->position.y += arg0->unk_080.y + arg0->unk_08C.y;
        arg0->position.z += arg0->unk_080.z + arg0->unk_08C.z;

        arg0->velocity = arg0->unk_080;
...
void SushiGame_UpdatePlayerModelTransform(unk_D_86807558* arg0) {
    ...
    if (arg0->flags & 0x10) {
        ptr->materialAlpha = 0xFF;
    } else {
        ptr->materialAlpha = 0;
    }
}

void SushiGame_BroadcastPlayerPhase(u16 arg0, s32 arg1) {
...
void SushiGame_DetermineWinner(void) {
    unk_D_86807558* ptr2;
    s32 tmp;
    s32 i;
    s32 j;
...
void SushiGame_ApplyPlayerPhaseFlags(unk_D_86807558* arg0) {
    switch (D_86808438[arg0->playerIndex]) {
        case 0:
        case 4:
            break;
        ...
        case 5:
            arg0->flags &= ~2;
            SushiGame_SetPlayerEatState(arg0, 4);
            break;
    }

    D_86808438[arg0->playerIndex] = 0;
}

void SushiGame_UpdateScoreTally(unk_D_86807558* arg0) {
    arg0->unk_020++;
    ...
    if (arg0->unk_01C >= arg0->unk_018) {
        ...
        arg0->unk_020 = 0;
        arg0->flags &= ~8;
        if (D_86808448 == arg0->playerIndex) {
            Audio_DispatchSoundBankCommand(0x5000C, 0, 0);
        }
    } else if ((arg0->unk_01C - arg0->unk_024) >= 0xA) {
        arg0->unk_024 = arg0->unk_01C;
        if (D_86808448 == arg0->playerIndex) {
            Audio_DispatchSoundBankCommand(0x5000B, 0, 0);
        }
    }
}

s32 SushiGame_AreAllPlayersIdle(void) {
    s32 var_v1 = 0;
    s32 i;
...
void SushiGame_UpdateNameTagSpringEffect(UNUSED unk_D_86807558* arg0, unk_D_86807558_040* arg1) {
    s32 i;
    ...
    switch (arg1->unk_00) {
        ...
        case 4:
            ...
            if (arg1->unk_02 <= 0) {
                SushiGame_ResetPlayerSubState(arg1);
            }
            break;
    }
}

void SushiGame_InitPlayerSlots(s32 arg0) {
    s32 i;
    MemoryBlock* temp_v0;
    ...
    D_8680847C = Rand_Range(D_8680847E);
    D_86808480 = 0;

    for (i = 0; i < 4; i++) {
        SushiGame_InitPlayerSlot(&D_86807558[i], i, arg0);
    }
}

void SushiGame_UpdatePlayers(void) {
    s32 i;
    unk_D_86807558* var_s0;

    if ((D_8780FC94 == 0) && (D_86808438[0] != 0)) {
        SushiGame_DetermineWinner();
    }
    ...
    for (i = 0; i < 4; i++, var_s0++) {
        ...
        if (D_86808438[i] != 0) {
            SushiGame_ApplyPlayerPhaseFlags(var_s0);
        }
        ...
        switch (var_s0->unk_060) {
            ...
            case 2:
            case 3:
                SushiGame_UpdatePlayerPhysics(var_s0);
                break;

            case 1:
                SushiGame_UpdateEatingState(var_s0);
                break;

            case 4:
                SushiGame_UpdateReturnToCenterState(var_s0);
                break;
        }

        if (var_s0->flags & 8) {
            SushiGame_UpdateScoreTally(var_s0);
        }

        SushiGame_UpdateNameTagSpringEffect(var_s0, &var_s0->unk_040);
    }

    var_s0 = D_86807558;
    for (i = 0; i < 4; i++, var_s0++) {
        if (D_8780FC94 == 0) {
            SushiGame_ResolvePlayerCollisions(var_s0);
        }
    }
    ...
    for (i = 0; i < 4; i++, var_s0++) {
        if (D_8780FC94 == 0) {
            SushiGame_ApplyCollisionPush(var_s0);
        }
        SushiGame_UpdatePlayerModelTransform(var_s0);
    }
}

void SushiGame_UpdateCameraBasis(unk_D_86808498* arg0) {
    f32 temp_fa0;
    Vec3f sp20;
    ...
    sp20.y = 1.0f;
    sp20.z = 0.0f;
    Vec3f_CrossProduct(&arg0->unk_2C, &sp20, &arg0->unk_20);
}
...
void SushiGame_InitCamera(void) {
    ...
    Camera_ComputeEyeFromAngles(&D_86808498.unk_00, &D_86808498.unk_0C, D_86808498.unk_1C, D_86808498.unk_1A, D_86808498.unk_18);
    SushiGame_UpdateCameraBasis(&D_86808498);

    D_86808490->unk_24.near = 50.0f;
    D_86808490->unk_24.far = 6400.0f;
}

void SushiGame_UpdateCamera(void) {
    Camera_ComputeEyeFromAngles(&D_86808498.unk_00, &D_86808498.unk_0C, D_86808498.unk_1C, D_86808498.unk_1A, D_86808498.unk_18);
    SushiGame_UpdateCameraBasis(&D_86808498);
