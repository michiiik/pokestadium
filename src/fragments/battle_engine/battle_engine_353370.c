...
static OwnerLinkedFourStream D_843AB940[4];
...
void OwnerLinkedFourStream_Init(void) {
    s32 i;
    s32 j;
    OwnerLinkedFourStream* var_a2 = &D_843AB940[0];
    OwnerLinkedFourStreamNode* var_v0;
...
void OwnerLinkedFourStream_Start(f32 arg0, f32 arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, u8 arg6, u8 arg7, u8 arg8, u8 arg9,
                   f32 argA, f32 argB, f32 argC, s16 argD) {
    s32 i;
    s32 j;
    OwnerLinkedFourStream* var_v1;
    OwnerLinkedFourStreamNode* var_s0;
    Vec3f sp64;
    Vec3f sp58;
    ...
    for (i = 0; i < 4; i++, var_v1++) {
        if (var_v1->unk_000 == 0) {
            ...
            var_v1->unk_00C = argC;
            var_v1->unk_010 = argA;
            var_v1->unk_034 = BattleAnim_SpawnSecondaryOwnerParticle(sp64, 2);
...
void OwnerLinkedFourStream_UpdateNodeChain(OwnerLinkedFourStream* arg0) {
    OwnerLinkedFourStreamNode* var_s0 = &arg0->unk_038[0];
    s32 i;
    f32 var_ft4;
    ...
    for (i = 0; i < 15; i++, var_s0++) {
        if (i == 0) {
            ...
            BattleAnim_SetParticlePosition(arg0->unk_034, var_s0->unk_0C);

            if (arg0->unk_002 == 1) {
                BattleAnim_SpawnSecondaryOwnerParticle(var_s0->unk_0C, 1);
            }
...
s32 OwnerLinkedFourStream_IsComplete(void) {
    s32 i;
    OwnerLinkedFourStream* var_s0 = &D_843AB940[0];
    ...
    for (i = 0; i < 4; i++, var_s0++) {
        if (var_s0->unk_000 == 1) {
            ...
            if (var_s0->unk_004 < var_s0->unk_002) {
                var_s0->unk_000 = 0;
                BattleAnim_MarkParticleInactive(var_s0->unk_034);
            } else {
                OwnerLinkedFourStream_UpdateNodeChain(var_s0);
            }
        }
    }
    return 0;
...
Gfx* OwnerLinkedFourStream_Draw(Gfx* arg0) {
    ...
    s32 j;
    s32 k;
    OwnerLinkedFourStream* var_s5;
    OwnerLinkedFourStreamNode* temp_s0;
    Mtx* temp_v0;
    Vec3f sp154;
    UNUSED s32 pad[14];
    s16 var_s3;
    ...
    for (i = 0; i < 4; i++, var_s5++) {
        if (var_s5->unk_000 == 1) {
            ...
            if (temp_s0->unk_0C.y > 0.0f) {
                temp_v0 = Gfx_AllocDisplayList(sizeof(Mtx) * 1);
            ...
            var_s5->unk_018 = Gfx_AllocDisplayList(sizeof(Vtx) * 30);
            var_s0 = var_s5->unk_018;

            for (j = 0; j < 15; j++) {
                OwnerLinkedFourStream_Update(temp_s0->unk_08, &sp154, temp_s0->unk_04);
                ...
                OwnerLinkedFourStream_Update(temp_s0->unk_08 + 3.1415927f, &sp154, temp_s0->unk_04);
