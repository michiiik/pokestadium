...
void BattleScene_QueueRowEffectList3(Battler* arg0, s32 arg1) {
    BattleAnim_QueueEffectList3(arg1, &arg0->model, &arg0->model, 0xFF, 0xFF);
}
...
void BattleScene_TickStartRowAnimRecord(Battler* arg0) {
    UNUSED s32 pad;
    s32 idx = arg0->swayStepCount;
    s32 sp24 = gBattleSceneStateRowTable[idx].unk_20;

    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp24];
    if (BattleAnim_TryRegisterAssetTables(arg0) != 0) {
        BattleAnim_SetModelEventTrackAndState(arg0, sp24, 2);
        arg0->presentationPhase = 0;
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
        ModelAnim_SetFrame(&arg0->model, 0);
        ModelAnim_SetAnimation(&arg0->model, D_84390020->animationId);
    }
}
...
void BattleScene_TickQueueRowEffectList3AtAnimEnd(Battler* arg0) {
    ...
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp28];
    if (BattleScene_GetParticipantModelHeight(arg0) != 0.0f) {
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
    } else if ((arg0->presentationPhase == (D_84390020->phaseThreshold + 1)) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
...
void BattleScene_ResetOpponentStateFrameCounter(Battler* arg0) {
    D_84390010[BattleScene_GetParticipantSideIndex(arg0) == 0]->presentationPhase = 0;
}

void BattleAnim_SetOverlayFlagForSpecialMoves(Battler* arg0) {
    BattleMonRuntime* ptr = &arg0->unk_654.monRuntime;

    if (ptr->currentMoveId == 0x46 || ptr->currentMoveId == 0x9D || ptr->currentMoveId == 0x58) {
        D_84390010[0]->model.unk_000.unk_02 |= 2;
        D_84390010[1]->model.unk_000.unk_02 |= 2;
    }
}
...
s32 BattleAnim_IsAssetLoadBusy(Battler* arg0) {
    return arg0->sessionTeams->assetLoadFlags & 0xD0;
}

s32 BattleAnim_PollAssetLoadBusyFlags(Battler* arg0) {
    PokeIcon_PollBackgroundForObject(arg0->sessionTeams);
    return arg0->sessionTeams->assetLoadFlags & 0xC0;
}

s32 BattleAnim_IsSessionBusy(Battler* arg0) {
    return arg0->sessionTeams->modelLoadFlags & 0xD0;
}

s32 BattleAnim_TryRegisterAssetTables(Battler* arg0) {
    if (BattleAnim_PollAssetLoadBusyFlags(arg0) == 0) {
        BattleAnim_RegisterAssetTablesForSession(arg0->sessionTeams);
        return 1;
    }
    return 0;
}
...
void BattleScene_LoadMoveResourceList(Battler* arg0) {
    if (gBattleScene.scene->unk_48 == 0xE) {
        BattleAnim_LoadMoveResourceList(arg0->sessionTeams, BattleScene_GetActiveAnimRowId(arg0));
    } else {
        BattleAnim_LoadMoveResourceList(arg0->sessionTeams, BattleScene_GetActiveAnimRowId(arg0));
    }
}
...
void BattleScene_LoadRowResourceList(Battler* arg0) {
    ...
    BattleAnim_LoadModeResourceList(arg0->sessionTeams, gBattleSceneStateRowTable[idx].unk_24);
}
...
void BattleAnim_BeginSessionRequest(Battler* arg0) {
    arg0->sessionTeams->iconSpeciesId = 0x98;
    arg0->sessionTeams->modelLoadFlags |= 0x80;
}

void BattleAnim_BeginSessionRequestForActiveMon(Battler* arg0) {
    arg0->sessionTeams->activeMon = &arg0->ownRoster->party[arg0->unk_654.partyIndex];
    arg0->sessionTeams->modelLoadFlags |= 0x80;
    arg0->sessionTeams->iconSpeciesId = arg0->unk_654.cachedModelId;
}
...
void Battle_FilterUnusableMoves(Battler* arg0, u16 arg1, SpeciesLearnsetBuffer* arg2, SpeciesLearnsetBuffer* arg3) {
    ...
    temp_s5 = &arg0->unk_654.monRuntime;

    for (i = 0; i < 4; i++) {
        if (temp_s5->moveIds[i] != 0) {
            temp_s4 = &D_80070FA0[arg1];

            for (j = 0; j < ARRAY_COUNT(temp_s4->unk_0A); j++) {
                if ((temp_s4->unk_0A[j] != 0) && (temp_s4->unk_0A[j] == temp_s5->moveIds[i])) {
                    arg0->unk_654.moveHighlightFlags[i] = 0;
                }
            }

            for (j = 0; j < 10; j++) {
                if ((arg2->levelThresholds[j] != 0) && (temp_s5->level >= arg2->levelThresholds[j]) &&
                    (arg2->moveIds[j] == temp_s5->moveIds[i])) {
                    arg0->unk_654.moveHighlightFlags[i] = 0;
                }
            }

            for (j = 0; j < 10; j++) {
                if ((arg3->levelThresholds[j] != 0) && (temp_s5->level >= arg3->levelThresholds[j]) &&
                    (arg3->moveIds[j] == temp_s5->moveIds[i])) {
                    arg0->unk_654.moveHighlightFlags[i] = 0;
                }
            }
            ...
            for (j = 0; j < 0x37; j++) {
                ...
                if (((var_a0 >> (j % 8)) & 1) && (Move_GetIdFromTableIndex(j) == temp_s5->moveIds[i])) {
                    arg0->unk_654.moveHighlightFlags[i] = 0;
                }
            }
        } else {
...
void Battle_InitializeMoveUsabilityMask(Battler* arg0) {
    arg0->unk_654.moveHighlightFlags[0] = 1;
    arg0->unk_654.moveHighlightFlags[1] = 1;
    arg0->unk_654.moveHighlightFlags[2] = 1;
    arg0->unk_654.moveHighlightFlags[3] = 1;

    Battle_FilterUnusableMoves(arg0, arg0->unk_654.monRuntime.speciesId - 1, &arg0->ownLearnsetA, &arg0->ownLearnsetB);

    if (D_84384588[BattleScene_GetParticipantSideIndex(arg0)]->partner1SpeciesId != 0) {
        Battle_FilterUnusableMoves(arg0, D_84384588[BattleScene_GetParticipantSideIndex(arg0)]->partner1SpeciesId - 1, &arg0->partner1LearnsetA, &arg0->partner1LearnsetB);
    }

    if (D_84384588[BattleScene_GetParticipantSideIndex(arg0)]->partner2SpeciesId != 0) {
        Battle_FilterUnusableMoves(arg0, D_84384588[BattleScene_GetParticipantSideIndex(arg0)]->partner2SpeciesId - 1, &arg0->partner2LearnsetA, &arg0->partner2LearnsetB);
    }
}
...
void Battle_LoadSpeciesDataTables(Battler* arg0, s32 arg1) {
    ...
    sp66 = arg0->model.modelId - 1;

    ptr = &arg0->sessionTeams->teams[arg0->unk_654.sideIndex]->party[arg0->unk_654.selectedPartyIndex];

    var_a1 = (u32)_70D3A0_ROM_START + ((u32)D_80075BD0[sp66] & 0xFFFFFF);
    if ((arg0->model.modelId == 0x19) && (ptr->sourceAndFlags & 0x80)) {
    ...
    if (sp68 == 1) {
        ...
        if (ptr2->chainIndex != 0xFF) {
            sp6E = ptr2->chainIndex;

            var_a1 = ((u32)_70D3A0_ROM_START) + (((u32)(D_6E910 + ((ptr2->chainIndex - (tmp = 2)) * 0x20))) & 0xFFFFFF);
            Dma_WriteChunks(ptr2, var_a1, var_a1 + 0x20, 0);

            D_84384578[sp68]->chainIndex = sp6E;
        }
    } else {
        var_a1 = (u32)_70D3A0_ROM_START + ((u32)(D_6E910 + (sp66 << 5)) & 0xFFFFFF);
        Dma_WriteChunks(D_84384578[sp68], var_a1, var_a1 + 0x20, 0);
    ...
    BattleAnim_Vec3fCopy(&arg0->sway.layoutConfig.primaryAmplitude, &D_84390048.primaryAmplitude);
    BattleAnim_Vec3fCopy(&arg0->sway.layoutConfig.secondaryAmplitude, &D_84390048.secondaryAmplitude);

    arg0->sway.layoutConfig.unk_18 = D_84390048.unk_18;
    arg0->sway.layoutConfig.unk_19 = D_84390048.unk_19;
    arg0->sway.layoutConfig.unk_1A = D_84390048.unk_1A;
    arg0->sway.layoutConfig.unk_1B = D_84390048.unk_1B;
    arg0->sway.layoutConfig.primaryAmplitude.x *= arg0->yawBase;
    arg0->sway.layoutConfig.secondaryAmplitude.x *= arg0->yawBase;
    ...
    Battle_DmaLoadAnimRecordPair(sp66, &arg0->ownLearnsetA, &arg0->ownLearnsetB);

    if (D_84384588[sp68]->partner1SpeciesId != 0) {
        Battle_DmaLoadAnimRecordPair(D_84384588[sp68]->partner1SpeciesId - 1, &arg0->partner1LearnsetA, &arg0->partner1LearnsetB);
    }

    if (D_84384588[sp68]->partner2SpeciesId != 0) {
        Battle_DmaLoadAnimRecordPair(D_84384588[sp68]->partner2SpeciesId - 1, &arg0->partner2LearnsetA, &arg0->partner2LearnsetB);
    }
...
void BattleScene_TickRow10CleanupAndEnterState18(Battler* arg0) {
    if (arg0->presentationPhase == 0x14) {
        arg0->sessionTeams->modelLoadFlags |= 0x80;
    }
...
void BattleScene_EnterRow3StartMoveAnim(Battler* arg0) {
    ...
    sp2A = arg0->model.modelId - 1;
    sp24 = &arg0->unk_654.monRuntime;
    sp20 = &arg0->unk_654;
    idx = BattleScene_GetParticipantSideIndex(arg0);

    D_84390020 = &D_84384570[idx]->moveCues[sp24->currentMoveId - 1];

    if (!(sp20->battleStateFlags & 2)) {
        arg0->presentationPhase = 0;

        if (BattleScene_IsPartnerPikachu(arg0) != 0) {
            tmp = BattleScene_GetParticipantSideIndex(arg0);
            func_80048060(tmp, sp24->currentMoveId, 0xC8, 0);
        } else {
            tmp = BattleScene_GetParticipantSideIndex(arg0);
            func_80048060(tmp, sp24->currentMoveId, sp2A + 1, 0);
        }

        if ((sp20->battleStateFlags & 0x4000) && ((sp2A == 0x32) || (sp2A == 0x31))) {
        ...
        ModelAnim_SetAnimation(&arg0->model, D_84390020->animationId);
        BattleAnim_SetModelEventTrackFromRow(arg0, sp24->currentMoveId - 1);

        if (D_84390020->eventFrame != 0) {
            ModelAnim_SetFrame(&arg0->model, D_84390020->eventFrame);
            ModelAnim_SetEventFrame(&arg0->model, D_84390020->eventFrame);
            arg0->presentationPhase = D_84390020->eventFrame;
        } else {
            ModelAnim_SetFrame(&arg0->model, 0);
        }
    }
...
void BattleScene_TickRow3PlayMoveEffectScript(Battler* arg0) {
    UNUSED s32 pad;
    s16 sp32 = arg0->model.modelId - 1;
    BattleMonRuntime* sp24;

    BattleScene_GetParticipantSideIndex(arg0);
    sp24 = &arg0->unk_654.monRuntime;
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp24->currentMoveId - 1];

    if ((sp24->currentMoveId == 0x19) && (sp32 == 0x64)) {
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
    } else if ((arg0->presentationPhase == (D_84390020->phaseThreshold + 1)) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
        if (gBattleScene.scene->unk_48 == 0x14) {
            gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
        } else if (sp24->cachedMove.moveId == 0x5B) {
            gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
        } else {
            if (sp24->cachedMove.moveId == 0x6E) {
                if ((sp32 != 7) && (sp32 != 8) && (sp32 != 0x5A) && (sp32 != 6)) {
                    BattleScene_SetParticipantModelFlags(arg0, 0xC, 0);
                    BattleAnim_PlayMoveEffectScriptA(arg0, sp24->currentMoveId);
                }
            } else {
                if (sp24->cachedMove.moveId == 0x45) {
                    BattleScene_SetParticipantModelFlags(arg0, 8, 0);
                } else if (sp24->cachedMove.moveId == 0x39) {
                    BattleScene_SetParticipantModelFlags(arg0, 0xA, 0);
                } else if (sp24->cachedMove.moveId == 0x60) {
                    BattleScene_SetParticipantModelFlags(arg0, 0xD, 0);
                } else if (sp24->cachedMove.moveId == 0x7F) {
                    BattleScene_SetParticipantModelFlags(arg0, 0xE, 0);
                } else if (sp24->cachedMove.moveId == 0x6B) {
                    BattleScene_SetParticipantModelFlags(arg0, 9, 0);
                } else {
                    BattleScene_SetParticipantModelFlags(arg0, D_84390020->subState, 0);
                }

                if ((sp24->currentMoveId == 0x9A) && (D_84390230 == D_8439022C)) {
                    BattleAnim_PlayMoveEffectScriptB(arg0, sp24->currentMoveId);
                } else {
                    BattleAnim_PlayMoveEffectScriptA(arg0, sp24->currentMoveId);
                }
            }
...
void BattleScene_TickRow3PostEffectCamera(Battler* arg0) {
    BattleMonRuntime* sp24 = &arg0->unk_654.monRuntime;

    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp24->currentMoveId - 1];

    if (arg0->presentationPhase == (D_84390020->phaseThreshold + 1)) {
        if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
            if (gBattleScene.scene->unk_48 == 0x18) {
                ...
                if ((sp24->currentMoveId == 0x2D) || (sp24->currentMoveId == 0x2E) || (sp24->currentMoveId == 0x59)) {
...
void BattleScene_TickRow3QueueEffectList6(Battler* arg0) {
    ...
    sp18 = sp24->currentMoveId;
    BattleScene_GetParticipantSideIndex(arg0);
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp24->currentMoveId - 1];

    if (arg0->presentationPhase == (D_84390020->phaseThreshold2 + 1)) {
        if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
...
void func_843031A0(Battler* arg0) {
    ...
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[temp_v1->currentMoveId - 1];

    if (temp_v1->currentMoveId == 0x6A) {
        Model_SetMaterialTextureMode(&arg0->model, 1);
    }
}
...
void BattleScene_EnterRow21StartAnimRecord0(Battler* arg0) {
    ...
    sp22 = arg0->model.modelId - 1;
    D_84390020 = D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues;

    if (!(temp_v1->battleStateFlags & 2)) {
        arg0->presentationPhase = 0;
        if ((temp_v1->battleStateFlags & 0x4000) && ((sp22 == 0x32) || (sp22 == 0x31))) {
            Battle_ClearRuntimeFlags(arg0, 8);
            arg0->model.unk_000.unk_02 |= 0x20;
            Battle_SetRuntimeFlags(arg0, 0x10);
            Battle_ClearRuntimeFlags(arg0, 0x4000);
...
void BattleScene_TickRow21PlaySpeciesSound(Battler* arg0) {
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[0];
    if ((arg0->presentationPhase == (D_84390020->phaseThreshold + 1)) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
        func_800479C0(1, arg0->model.modelId, 0);
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
    }
}
...
void BattleScene_EnterRow19StartMoveAnimMidFrame(Battler* arg0) {
    ...
    sp20 = &arg0->unk_654;
    ptr = &arg0->unk_654.monRuntime;
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[ptr->currentMoveId - 1];

    if (sp20->battleStateFlags & 2) {
        return;
    }

    arg0->presentationPhase = D_84390020->transitionFrame;
    if (!(sp20->battleStateFlags & 0x4000)) {
        BattleAnim_SetOverlayFlagForSpecialMoves(arg0);
        ModelAnim_SetAnimation(&arg0->model, D_84390020->animationId);
        ModelAnim_SetFrame(&arg0->model, D_84390020->transitionFrame);
        if (D_84390020->eventTrackId != 0xFF) {
            ModelAnim_SetEventTrack(&arg0->model, D_84390020->eventTrackId);
            ModelAnim_SetEventFrame(&arg0->model, D_84390020->transitionFrame);
            sp20->unk_36 = 1;
        }
    }
}
...
void BattleScene_TickRow19PlayMoveEffectScript(Battler* arg0) {
    ...
    sp20 = &arg0->unk_654.monRuntime;
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp20->currentMoveId - 1];
    if (sp20->currentMoveId == 0x9A) {
        var_v0 = D_84390020->phaseThreshold + 0x1E;
    } else {
        var_v0 = D_84390020->phaseThreshold + 1;
    }

    if ((var_v0 == arg0->presentationPhase) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
        if (gBattleScene.scene->unk_48 == 0x14) {
            gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
            return;
        }

        if ((sp20->currentMoveId == 0x9A) && (D_84390230 == D_8439022C)) {
            BattleAnim_PlayMoveEffectScriptB(arg0, sp20->currentMoveId);
        } else {
            BattleAnim_PlayMoveEffectScriptA(arg0, sp20->currentMoveId);
        }

        if (sp20->cachedMove.moveId == 0x45) {
            BattleScene_SetParticipantModelFlags(arg0, 8, 0);
        } else if (sp20->cachedMove.moveId == 0x39) {
            BattleScene_SetParticipantModelFlags(arg0, 0xA, 0);
        } else {
            BattleScene_SetParticipantModelFlags(arg0, D_84390020->subState, 0);
        }
...
void BattleScene_TickRow19PostEffectCamera(Battler* arg0) {
    ...
    sp18 = &arg0->unk_654.monRuntime;
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp18->currentMoveId - 1];

    if (sp18->currentMoveId == 0x9A) {
        var_v0 = D_84390020->phaseThreshold + 0x1E;
    } else {
        var_v0 = D_84390020->phaseThreshold + 1;
    }

    if (var_v0 == arg0->presentationPhase) {
        if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
            if (gBattleScene.scene->unk_48 == 0x18) {
                D_84390234--;
                if (D_84390234 < 0) {
...
void BattleScene_EnterRow4StartHitReactionAnim(Battler* arg0) {
    ...
    if (sp3C->battleStateFlags & 1) {
        temp_v0 = BattleScene_ByteArrayContains(temp_a1->model.modelId, D_84384598, 2);
        if (temp_v0 != 0) {
            D_84390020 = &D_84384570[sp40]->unk_B20;
        }
    }

    D_84390010[sp40]->presentationPhase = 0;

    if (!(sp3C->battleStateFlags & 0x200) && !(sp3C->battleStateFlags & 0x4000) && !(sp3C->battleStateFlags & 2)) {
        if (((D_843C4DEC < 0xA) || (gBattleMoveFailed != 0)) && ((sp28->status & 0x20) == 0)) {
            D_84390020 = &D_84384570[sp40]->unk_A50;
            if (sp3C->battleStateFlags & 0x200) {
                D_84390020 = &D_84384570[sp40]->unk_B00;
            }
        } else if (!(sp3C->battleStateFlags & 1)) {
        ...
        if ((gBattleMoveFailed == 0) && (sp28->currentMoveId == 0x49)) {
            D_84390020 = &D_84384570[sp40]->unk_A80;
        }

        ModelAnim_SetFrame(&D_84390010[sp40]->model, 0);
        ModelAnim_SetAnimation(&D_84390010[sp40]->model, D_84390020->animationId);

        if ((sp28->cachedMove.moveId == 0x17) || (sp28->cachedMove.moveId == 0x22) || (sp28->cachedMove.moveId == 0x45)) {
...
void BattleScene_TickPlayMoveEffectEnd(Battler* arg0) {
    ...
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0) == 0]->moveCues[sp20->currentMoveId - 1];

    if (D_84390010[sp28 == 0]->presentationPhase == (D_84390020->opposingPhaseThreshold + 1)) {
        if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
            BattleAnim_CleanupEffects(1);
            if (sp20->cachedMove.moveId == 0x51) {
                if ((D_843C4E45 != 0) && (D_843C4E44 != 0)) {
                    BattleAnim_PlayMoveEffectEnd(D_84390010[sp28 == 0], sp20->currentMoveId);
                    BattleScene_SetParticipantModelFlags(D_84390010[sp28 == 0], 0x10, 0);
                }
            } else {
                BattleAnim_PlayMoveEffectEnd(D_84390010[sp28 == 0], sp20->currentMoveId);
                if ((sp20->cachedMove.moveId == 0x14) || (sp20->cachedMove.moveId == 0x23) || (sp20->cachedMove.moveId == 0x84)) {
                    BattleScene_SetParticipantModelFlags(D_84390010[sp28 == 0], 0x10, 0);
                }
            }
            gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
...
void BattleScene_TickRow4PostEndCamera(Battler* arg0) {
    ...
    if ((D_84390020->opposingPhaseThreshold + 1) == D_84390010[sp28]->presentationPhase) {
        if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
            if (D_843C4E44 == 1) {
...
void BattleScene_EnterRow15StartAnimA80Seq30(Battler* arg0) {
    ...
    D_84390010[sp1C]->presentationPhase = 0;
    ModelAnim_SetFrame(&arg0->model, 0);
    ModelAnim_SetAnimation(&arg0->model, D_84390020->animationId);
...
s32 BattleScene_IsOpponentRowCheckpointReached(Battler* arg0) {
    ...
    sp1C = &D_84390010[BattleScene_GetParticipantSideIndex(arg0) == 0]->unk_654.monRuntime;
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp1C->currentMoveId - 1];
    if (D_84390020->finalPhase != 0) {
        if (arg0->presentationPhase == D_84390020->finalPhase) {
            return 1;
        }
        return 0;
    }
...
void BattleScene_EnterRowAnim166WithCry(Battler* arg0) {
    ...
    sp30 = &arg0->ownRoster->party[arg0->unk_654.partyIndex];
    sp24 = &arg0->unk_654;
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp34];
    temp_a0 = sp24->battleStateFlags & 2;

    if ((temp_a0 == 0) && !(sp24->battleStateFlags & 0x4000) && (temp_a0 == 0)) {
        if (sp30->status & 7) {
            if (BattleScene_ByteArrayContains(arg0->model.modelId, D_84384590, 8) != 0) {
        ...
        } else if (sp24->battleStateFlags & 0x200) {
        ...
        if (sp24->battleStateFlags & 0x200) {
            if (BattleScene_IsPartnerPikachu(arg0) != 0) {
                func_80048060(BattleScene_GetParticipantSideIndex(arg0) & 0xFF, 0, 0xC8, 0x1A);
            } else {
                func_80048060(BattleScene_GetParticipantSideIndex(arg0) & 0xFF, 0, arg0->model.modelId, 0x1A);
            }
        } else if (BattleScene_IsPartnerPikachu(arg0) != 0) {
            func_80048060(BattleScene_GetParticipantSideIndex(arg0) & 0xFF, 0, 0xC8, 0xA);
        } else {
            func_80048060(BattleScene_GetParticipantSideIndex(arg0) & 0xFF, 0, arg0->model.modelId, 0xA);
        }
    }
}
...
void BattleScene_TickRow1PlayOwnerCry(Battler* arg0) {
    ...
    if ((sp18->battleStateFlags & 0x4000) || (sp18->battleStateFlags & 2) || (ptr->status & 7)) {
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
    } else if (arg0->presentationPhase == 1) {
        if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
            if (arg0->model.modelId >= 0x98) {
                BattleAnim_PlayOwnerCry(arg0, sp18->cachedModelId);
            } else {
                BattleAnim_PlayOwnerCry(arg0, arg0->model.modelId);
            }
            gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
        }
    }
...
void BattleScene_TickRow16PlayCryAndSpeciesSound(Battler* arg0) {
    ...
    if ((arg0->unk_654.battleStateFlags & 0x4000) || (sp24->battleStateFlags & 2) || (ptr->status & 7)) {
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
    } else if ((arg0->presentationPhase == 1) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
        if (arg0->model.modelId >= 0x98) {
            Cry_Play(sp24->cachedModelId, 3);
        } else if (BattleScene_IsPartnerPikachu(arg0) != 0) {
            Cry_Play(0xC8, 3);
        } else {
            Cry_Play(arg0->model.modelId, 3);
        }
        ...
        if (sp24->battleStateFlags & 0x200) {
            if (BattleScene_IsPartnerPikachu(arg0) != 0) {
                ...
                func_80048060(BattleScene_GetParticipantSideIndex(arg0) & 0xFF, 0, arg0->model.modelId, 0x1B);
            }
        } else if (BattleScene_IsPartnerPikachu(arg0) != 0) {
            func_80048060(BattleScene_GetParticipantSideIndex(arg0) & 0xFF, 0, 0xC8, 0xB);
        } else {
            func_80048060(BattleScene_GetParticipantSideIndex(arg0) & 0xFF, 0, arg0->model.modelId, 0xB);
        }
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
    }
}
...
void BattleScene_TickRow18PlayCryAndSpeciesSound(Battler* arg0) {
    ...
    if ((arg0->unk_654.battleStateFlags & 0x4000) || (ptr->status & 0x20) || (ptr->status & 7)) {
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
        return;
    }

    if ((arg0->presentationPhase == 1) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
        sp24 = &arg0->unk_654;
        if (arg0->model.modelId >= 0x98) {
            Cry_Play(sp24->cachedModelId, 4);
        } else if (BattleScene_IsPartnerPikachu(arg0) != 0) {
            Cry_Play(0xC8, 4);
        } else {
            Cry_Play(arg0->model.modelId, 4);
        }
...
void BattleScene_TickAssetLoadQueueRowEffectList3(Battler* arg0) {
    UNUSED s32 pad[2];
    s32 sp24 = arg0->swayStepCount;
    BattlerState* temp_v1 = &arg0->unk_654;

    if (BattleAnim_TryRegisterAssetTables(arg0) != 0) {
        arg0->sessionTeams->iconSpeciesId = arg0->unk_654.monRuntime.speciesId;
        arg0->presentationPhase = 0;
        BattleScene_QueueRowEffectList3(arg0, gBattleSceneStateRowTable[sp24].unk_24);
        Audio_PlayCommand(3, 0, 0);
        arg0->sessionTeams->activeMon = &arg0->sessionTeams->teams[temp_v1->activeSideIndex]->party[temp_v1->selectedPartyIndex];
        gBattleSceneStateTickSlots[gBattleSceneStateTickSlotIndex].unk_04 = gBattleSceneStateTickSentinel;
    }
}
...
void BattleScene_TickRow20CleanupAndEnterState18(Battler* arg0) {
    if (arg0->presentationPhase == 0x4F) {
        arg0->sessionTeams->modelLoadFlags |= 0x80;
    }
...
void BattleScene_EnterRow8StartMappedMoveAnim(Battler* arg0) {
    UNUSED s32 pad[2];
    s32 sp24 = D_84384670[arg0->unk_654.monRuntime.currentMoveId - 1];
...
void BattleScene_TickRow8PlayMoveEffectScriptB(Battler* arg0) {
    ...
    sp22 = arg0->model.modelId - 1;
    temp_s1_2 = &arg0->unk_654.monRuntime;
    temp_s1 = D_84384670[temp_s1_2->currentMoveId - 1];

    BattleScene_GetParticipantSideIndex(arg0);

    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[temp_s1];

    if ((arg0->presentationPhase == (D_84390020->phaseThreshold + 1)) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
        BattleAnim_PlayMoveEffectScriptB(arg0, temp_s1_2->currentMoveId);

        if (temp_s1_2->currentMoveId == 0x13) {
            BattleScene_SetParticipantModelFlags(arg0, 3, 0);
        }

        if ((temp_s1_2->currentMoveId == 0x5B) && (sp22 != 0x31) && (sp22 != 0x32)) {
...
void BattleScene_EnterRow9SetEventTrack(Battler* arg0) {
    ...
    if (!(arg0->unk_654.battleStateFlags & 2)) {
        ...
        D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp1C];
        BattleAnim_SetModelEventTrackFromRow(arg0, sp1C);
    }
}

void BattleScene_EnterRow9QueueEffectList6(Battler* arg0) {
    BattleMonRuntime* ptr = &D_84390010[BattleScene_GetParticipantSideIndex(arg0) == 0]->unk_654.monRuntime;

    if (ptr->lockedEffectFlags & 0x20) {
        if ((ptr->currentMoveId == 0x14) || (ptr->currentMoveId == 0x23) || (ptr->currentMoveId == 0x51)) {
...
void BattleScene_TickQueueList3Selector2OrC(Battler* arg0) {
    ...
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->unk_A70;
    if (D_84390020->phaseThreshold2 == 1) {
        sp24 = D_84390020->cameraFrameCount - 0x4C;
    } else {
        sp24 = D_84390020->cameraFrameCount - 0x31;
    }

    if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
        if (BattleScene_GetParticipantModelHeight(arg0) != 0.0f) {
            if ((sp24 <= 0) || (sp24 == arg0->presentationPhase)) {
                if (D_84390020->phaseThreshold2 == 1) {
        ...
        } else if ((sp24 <= 0) || (sp24 == arg0->presentationPhase)) {
            if (D_84390020->phaseThreshold2 == 1) {
                BattleAnim_QueueEffectList3(2, arg0, arg0, 0xFF, 0xFF);
            } else {
                BattleAnim_QueueEffectList3(0xC, arg0, arg0, 0xFF, 0xFF);
...
void BattleScene_TickQueueList3Selector2OrCFromB10(Battler* arg0) {
    ...
    if ((BattleAnim_IsAssetLoadBusy(arg0) == 0) && ((sp24 <= 0) || (sp24 == arg0->presentationPhase))) {
        if (D_84390020->phaseThreshold2 == 1) {
            BattleAnim_QueueEffectList3(2, arg0, arg0, 0xFF, 0xFF);
        } else {
            BattleAnim_QueueEffectList3(0xC, arg0, arg0, 0xFF, 0xFF);
...
void func_8430506C(Battler* arg0) {
    ...
    if (sp3C->battleStateFlags & 1) {
        if (BattleScene_ByteArrayContains(sp30->model.modelId, D_84384598, 2) != 0) {
            D_84390020 = &D_84384570[sp40]->unk_B20;
        }
    }

    if ((sp3C->battleStateFlags & 1) && BattleScene_ByteArrayContains(sp30->model.modelId, D_84384590, 8)) {
        sp48 = 0xAF;
    }

    D_84390010[sp40]->presentationPhase = 0;

    if (!(sp3C->battleStateFlags & 0x4000) && !(sp3C->battleStateFlags & 2)) {
        if ((sp28->currentMoveId == 0x91) && (D_843C4DEC < 0xA)) {
            D_84390020 = &D_84384570[sp40]->moveCues[sp48];
        }

        if ((D_843C4E44 == 0) || (gBattleMoveFailed != 0)) {
            ptr = D_84384570[sp40];
            ptr2 = ptr;
            D_84390020 = &ptr2->moveCues[sp48];
            if (sp3C->battleStateFlags & 0x200) {
                D_84390020 = &ptr2->moveCues[0xB0];
            }
        } else if (!(sp3C->battleStateFlags & 1)) {
...
void BattleScene_TickRow14PlayMoveEffectEnd(Battler* arg0) {
    ...
    sp24 = &D_84390010[sp2C == 0]->unk_654.monRuntime;
    sp1C = &arg0->unk_654.monRuntime;

    D_84390020 = &D_84384570[sp2C == 0]->moveCues[sp1C->currentMoveId - 1];

    if ((D_84390010[sp2C == 0]->presentationPhase == (D_84390020->opposingPhaseThreshold + 1)) && (BattleAnim_IsAssetLoadBusy(arg0) == 0)) {
        BattleAnim_CleanupEffects(1);
        if (((sp1C->currentMoveId == 0x30) || (sp1C->currentMoveId == 0x6D)) && (sp24->lockedEffectFlags & 0x80) && (gBattleMoveFailed == 0) &&
            (D_843C4E44 == 1)) {
            BattleAnim_PlayBattleSequenceById(D_84390010[sp2C == 0], 0x12);
        }

        BattleAnim_PlayMoveEffectEnd(D_84390010[sp2C == 0], sp1C->currentMoveId);
        if ((gBattleMoveFailed == 0) || (D_843C4E44 == 1)) {
            BattleAnim_PlaySpeciesReactionSound(D_84390010[sp2C == 0], &arg0->unk_654.monRuntime, 1);
        }
...
s32 func_84305458(Battler* arg0) {
    ...
    D_84390020 = &D_84384570[temp_v1]->moveCues[ptr->currentMoveId - 1];

    if (D_843C4E45 != 1) {
        return 2;
    }

    if ((D_84390020->unk_08 + 0x50) == D_84390010[temp_v1]->presentationPhase) {
        return 1;
    }
...
void BattleScene_TickRow11QueueEffectList6(Battler* arg0) {
    ...
    sp28 = BattleScene_GetParticipantSideIndex(arg0) == 0;
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0) == 0]->moveCues[ptr->currentMoveId - 1];
    if (D_84390010[sp28]->presentationPhase == (D_84390020->unk_08 + 1)) {
        if (BattleAnim_IsAssetLoadBusy(arg0) == 0) {
            if (D_843C4E45 == 1) {
...
void BattleScene_TickStateCallbacks(void) {
    D_84390010[0]->presentationPhase++;
    D_84390010[1]->presentationPhase++;
...
void Battle_ResetCryEventIfStruggle(Battler* arg0) {
    if (arg0->unk_654.monRuntime.currentMoveId == 0x6A) {
        arg0->model.textureMode = 0;
    }
}
...
void BattleAnim_SetModelEventTrackFromRow(Battler* arg0, s32 arg1) {
    ...
    if (BattleAnim_IsSessionBusy(arg0) == 0) {
        sp30 = D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[arg1].eventTrackId;
        if ((sp30 != 0xFF) && (sp24->unk_36 != 2)) {
            if ((arg1 == 165) && (arg0->model.modelId == 0x33)) {
                ModelAnim_SetEventFrame(&arg0->model, 0);
                temp_v0 = BattleAnim_RandomRange(3);
                if (temp_v0 >= 3) {
                    temp_v0 = 2;
                }
                ModelAnim_SetEventTrack(&arg0->model, sp30 + temp_v0);
            } else {
                ModelAnim_SetEventFrame(&arg0->model, 0);
                ModelAnim_SetEventTrack(&arg0->model, sp30);
                sp24->unk_36 = 1;
            }
        }
    }
...
s32 BattleAnim_TrySetModelEventTrackFromRow(Battler* arg0, s32 arg1, s32 arg2) {
    ...
    sp20 = D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[arg1].eventTrackId;
    if (sp20 == 0xFF) {
        return 1;
    }

    ModelAnim_SetEventFrame(&arg0->model, 0);
    ModelAnim_SetEventTrack(&arg0->model, sp20);
    ModelAnim_SetEventFrame(&arg0->model, arg0->model.unk_054.unk_04->unk_0A);
...
void BattleAnim_SetModelEventTrackAndState(Battler* arg0, s32 arg1, s32 arg2) {
    ...
    if (BattleAnim_IsSessionBusy(arg0) == 0) {
        temp_a1 = D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[arg1].eventTrackId;
        if (temp_a1 != 0xFF) {
            ModelAnim_SetEventTrack(&arg0->model, temp_a1);
            ModelAnim_SetEventFrame(&arg0->model, 0);
            arg0->unk_654.unk_36 = arg2;
        }
    }
...
s32 BattleScene_IsParticipantIncapacitated(Battler* arg0) {
    ...
    if ((sp20->battleStateFlags & 2) || (ptr->status & 7) || ((sp20->battleStateFlags & 0x200) && !(sp20->battleStateFlags & 0x400)) ||
        (sp20->battleStateFlags & 0x4000)) {
        return 1;
    }
    return 0;
}
...
s32 BattleScene_IsRowWaitComplete(Battler* arg0, s32 arg1) {
    ...
    if (arg0->model.unk_040.unk_00 == -1) {
        return 1;
    }
    return ModelAnim_IsAnimationDone(&arg0->model);
}
...
s32 BattleScene_IsRowWaitCompleteWithEventCount(Battler* arg0, s32 arg1) {
    ...
    if ((D_84390020->cameraFrameCount < 0xB) || (D_84390020->cameraFrameCount == 0xFF)) {
        if (arg0->model.unk_040.unk_00 == -1) {
            return 1;
        }
        return ModelAnim_IsAnimationDone(&arg0->model);
    ...
    if (BattleScene_AdvanceCameraFrameCounter(D_84390020->cameraFrameCount + 1) != 0) {
        return 1;
    }
...
s32 Battle_IsRowAnimationSettled(Battler* arg0, s32 arg1) {
    ...
    sp20 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[ptr->currentMoveId - 1];
    ...
    if (gBattleScene.scene->unk_48 == 0x14) {
        sp20 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[0];
    }

    if (sp20->animationId == sp1C->animationId) {
        if (sp20->cameraFrameCount != 0xFF) {
            gBattleScene.scene->unk_14++;
            if (sp20->cameraFrameCount == arg0->presentationPhase) {
                return 1;
            }
            return 0;
        }
...
s32 BattleScene_IsMoveKeyedRowWaitComplete(Battler* arg0, s32 arg1) {
    ...
    sp28 = &arg0->ownRoster->party[arg0->unk_654.partyIndex];
    sp20 = D_84384670[arg0->unk_654.monRuntime.currentMoveId - 1];
    sp1C = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp20];
    temp_a2 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->unk_A50;

    if ((arg0->unk_654.battleStateFlags & 2) || (sp28->status & 7) ||
        ((arg0->unk_654.battleStateFlags & 0x200) && !(arg0->unk_654.battleStateFlags & 0x400)) || (arg0->unk_654.battleStateFlags & 0x4000)) {
        if (BattleScene_AdvanceCameraFrameCounter(arg1) != 0) {
            return 1;
        }
        return 0;
    ...
    if (sp1C->animationId == temp_a2->animationId) {
        if (sp1C->cameraFrameCount != 0xFF) {
            gBattleScene.scene->unk_14++;
            if (sp1C->cameraFrameCount == arg0->presentationPhase) {
                return 1;
            }
            return 0;
        }
...
s32 BattleScene_IsRowAnimWaitComplete(Battler* arg0, s32 arg1) {
    ...
    if ((arg0->unk_654.battleStateFlags & 2) || ((arg0->unk_654.battleStateFlags & 0x200) && !(arg0->unk_654.battleStateFlags & 0x400))) {
        if (BattleScene_AdvanceCameraFrameCounter(arg1) != 0) {
            return 1;
        }
        return 0;
    ...
    if (arg0->model.unk_040.unk_00 != D_84390020->animationId) {
        return 1;
    }
...
void BattleAnim_QueueModelRecordEffectList3(Battler* arg0) {
    D_84390020 = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->unk_A50;
    if (BattleAnim_IsSessionBusy(arg0) == 0) {
        if ((arg0->model.unk_040.unk_00 != -1) && (arg0->model.unk_000.unk_01 & 1) &&
            (arg0->model.unk_000.unk_02 & 0x20) && (gBattleScene.scene->unk_1C == 1) &&
            (D_84390020->animationId == arg0->model.unk_040.unk_00) &&
            (D_84390020->phaseThreshold == (arg0->model.unk_040.unk_08 >> 0x10)) && (D_84390020->subState != 0) &&
            (BattleAnim_RandomRange(2) == 1)) {
            BattleAnim_QueueEffectList3(D_84390020->subState, &arg0->model, &arg0->model, D_84390020->effectListId, D_84390020->effectListId);
        }
    }
}

void Battle_SetRuntimeFlags(Battler* arg0, u16 arg1) {
    arg0->unk_654.battleStateFlags |= arg1;
}
...
void BattleScene_ResetBothParticipantsAnimationState(void) {
    ...
    if (sp34->battleStateFlags & 4) {
        D_84390010[0]->model.unk_024.y = 200.0f;
        Battle_SetRuntimeFlags(D_84390010[0], 0x200);
        Battle_ClearRuntimeFlags(D_84390010[0], 4);
    }

    if (sp30->battleStateFlags & 4) {
        D_84390010[1]->model.unk_024.y = 200.0f;
        Battle_SetRuntimeFlags(D_84390010[1], 0x200);
        Battle_ClearRuntimeFlags(D_84390010[1], 4);
    }

    if ((sp34->battleStateFlags & 0x4000) && (sp24->model.modelId == 0x33)) {
        D_84390020 = &D_84384570[0]->moveCues[0x5A];
        ModelAnim_SetFrame(&D_84390010[0]->model, 0);
        ModelAnim_SetAnimation(&D_84390010[0]->model, D_84390020->animationId);
    }

    if ((sp30->battleStateFlags & 0x4000) && (sp20->model.modelId == 0x33)) {
        D_84390020 = &D_84384570[1]->moveCues[0x5A];
        ModelAnim_SetFrame(&D_84390010[1]->model, 0);
        ModelAnim_SetAnimation(&D_84390010[1]->model, D_84390020->animationId);
    }
...
void Battle_ClearOpponentHopFlagAndSyncMove(Battler* arg0) {
    ...
    if (sp20->battleStateFlags & 4) {
        D_84390010[BattleScene_GetParticipantSideIndex(arg0) == 0]->model.unk_024.y = 200.0f;
    ...
    if (arg0->unk_654.battleStateFlags & 0x200) {
        Battle_SetRuntimeFlags(arg0, 0x400);
    }
}

void BattleScene_CleanupParticipantHideFlag(Battler* arg0) {
    if (arg0->unk_654.battleStateFlags & 8) {
        arg0->model.unk_024.y = BattleScene_GetParticipantModelHeight(arg0);
        Battle_ClearRuntimeFlags(arg0, 0x608);
    }
}
...
void BattleScene_CleanupOpponentSpecialAnimFlag(Battler* arg0) {
    ...
    if (sp1C->unk_654.battleStateFlags & 0x4000) {
        sp1C->model.unk_000.unk_02 |= 0x20;
        sp1C->model.unk_000.unk_01 |= 1;
...
void BattleScene_CleanupOpponentAnimationFlags(Battler* arg0) {
    ...
    if (ptr->battleStateFlags & 0x4000) {
        temp_s0->model.unk_000.unk_02 |= 0x20;
        temp_s0->model.unk_000.unk_01 |= 1;
        BattleAnim_StopOwnerCategoryParticles(4, temp_s0);
        Battle_ClearRuntimeFlags(temp_s0, 0x4000);
    }

    if (ptr->battleStateFlags & 8) {
        temp_s0->model.unk_024.y = BattleScene_GetParticipantModelHeight(arg0);
        Battle_ClearRuntimeFlags(temp_s0, 0x608);
    }
}

void BattleScene_CleanupParticipantEffectMode(Battler* arg0) {
    switch (arg0->presentationSubState) {
        case 14:
        ...
        case 16:
            BattleScene_SetParticipantModelFlags(arg0, 0, 0);
            if (arg0->unk_654.monRuntime.statChangeFlag == 0) {
        ...
        case 4:
            BattleScene_SetParticipantModelFlags(arg0, 0, 0);
            arg0->model.unk_01E.y = arg0->yawBase << 0xE;
            BattleScene_HideParticipantSecondaryModels(arg0);
            break;
    }
}
...
void BattleAnim_TickParticipantStatusAnimation(Battler* arg0) {
    ...
    if (temp_s1->battleStateFlags & 0x100) {
        arg0->model.unk_000.unk_02 &= 0xFFDF;
    }

    if ((temp_s1->faintSequenceState == 0x10) || (temp_s1->faintSequenceState == 0x13)) {
        Battle_ClearRuntimeFlags(arg0, 0x100);
    }

    temp_s1->modelAlpha = Math_StepToS32(temp_s1->modelAlpha, 0, 0x1E, 0x1E);
    if (temp_s1->modelAlpha != 0) {
        Model_SetMaterialColor(&arg0->model, 0xFF, 0xFF, 0xFF, temp_s1->modelAlpha);
    }
    ...
    switch (temp_s1->unk_36) {
        ...
        case 1:
            if (ModelAnim_IsEventTrackNearEnd(&arg0->model) == 1) {
                ModelAnim_SetEventTrack(&arg0->model, -1);
                ModelAnim_SetEventFrame(&arg0->model, 0);
                temp_s1->unk_36 = 0;
            }
            break;
    ...
    if (temp_s1->battleStateFlags & 0x4000) {
        if ((arg0->model.modelId != 0x32) && (arg0->model.modelId != 0x33)) {
            arg0->model.materialAlpha = 0;
        }
    }
}
...
void BattleAnim_TriggerStatusAfflictionCry(Battler* arg0) {
    ...
    if ((ptr->status & 7) && !(arg0->unk_654.battleStateFlags & 1)) {
...
void BattleScene_AllocateParticipantRecord(BattleSessionTeams* arg0, s32 arg1) {
    ...
    bzero(&D_84390010[arg1]->unk_654.monRuntime, sizeof(BattleMonRuntime));
    bzero(&D_84390010[arg1]->presentation, sizeof(PresentationState));
    bzero(&D_84390010[arg1]->unk_654.monRuntime.cachedMove, sizeof(CachedMoveData));
    ...
    bzero(&D_84390010[arg1]->caption, sizeof(MonCaptionState));
    D_84390010[arg1]->sessionTeams = arg0;
}
...
void BattleScene_InitializeParticipantController(Battler* arg0) {
    Controller* sp24 = &gControllers[arg0->sessionTeams->teams[0]->trainerSlotId];
    ...
    arg0->presentation.trainerIndex = 0;
}
...
void BattleScene_InitializeParticipantModel(Battler* arg0) {
    ...
    ModelRenderer_AttachDisplayObject(&arg0->model);

    if (arg0 == D_84390010[0]) {
        arg0->model.poolIndex = 0;
    } else {
        arg0->model.poolIndex = 1;
    }

    Model_InitDisplayObject(&arg0->model, 0, sp22, sp24);
    Battle_LoadSpeciesDataTables(arg0, 1);
    ModelAnim_SetAnimation(&arg0->model, 0);
    ModelAnim_SetFrame(&arg0->model, 0);

    arg0->sessionTeams->activeMon = arg0->ownRoster->party;
    if ((arg0->model.modelId == 0x32) || (arg0->model.modelId == 0x33)) {
        arg0->model.unk_000.unk_02 &= ~0x40;
    } else {
        arg0->model.unk_000.unk_02 |= 0x40;
    }
...
void BattleScene_InitializeParticipantOwnerModel(Battler* arg0) {
    PresentationState* ptr = &arg0->presentation;
    unk_D_86002F58_004_000_004* sp28;
    s16 sp26;

    sp28 = Battle_GetMoveEffectListEntry(arg0, 0);
    sp26 = Battle_GetTrainerId(arg0, 0);
    ModelRenderer_AttachDisplayObject(&ptr->model);

    if (arg0 == D_84390010[0]) {
        ptr->model.poolIndex = -1;
        Model_InitDisplayObject(&ptr->model, 1, sp26, sp28);
    } else {
        ptr->model.poolIndex = -1;
        Model_InitDisplayObject(&ptr->model, 2, sp26, sp28);
    }

    ModelAnim_SetAnimation(&ptr->model, 0);
    ModelAnim_SetFrame(&ptr->model, 0);
    ptr->model.unk_000.unk_02 &= ~0x40;
    Vec3f_SetComponentsDuplicate(&ptr->model.unk_024, 0.0f, 0.0f, 0.0f);
}
...
void BattleScene_InitializeParticipantSecondaryModels(Battler* arg0, s32* arg1) {
    ...
    for (i = 0; i < 2; i++) {
        ptr = &arg0->swayModels[i];

        ModelRenderer_AttachDisplayObject(ptr);

        if (arg0 == D_84390010[0]) {
            ptr->unk_000.poolIndex = 0xFF;
        } else {
            ptr->unk_000.poolIndex = 0xFF;
        }
...
void BattleScene_InitializeParticipantAuxiliaryModel(Battler* arg0) {
    unk_D_86002F58_004_000* ptr = &arg0->secondaryModel;
    unk_D_86002F58_004_000_004* sp20 = arg0->sessionTeams->auxModelLayout;
...
void BattleScene_InitializePresentation(BattleSessionTeams* arg0) {
    ...
    BattleScene_InitializeParticipantSecondaryModels(D_84390010[0], &D_84390010[0]->swayModels);
    BattleScene_InitializeParticipantSecondaryModels(D_84390010[1], &D_84390010[1]->swayModels);
...
void BattleScene_UpdateParticipantsAndQueueEffects(Battler* arg0, Battler* arg1) {
    ...
    BattleAnim_QueueModelRecordEffectList3(D_84390010[0]);
    BattleAnim_QueueModelRecordEffectList3(D_84390010[1]);
}
