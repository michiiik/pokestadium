...
void BattleScene_ApplyModelAnimationSlot5A(Battler* arg0) {
    ...
    if ((arg0->model.modelId == 0x32) && (ptr->battleStateFlags & 0x4000)) {
        MovePresentationCue* tmp = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[0x5A];

        ModelAnim_SetAnimation(&arg0->model, tmp->animationId);
        arg0->model.unk_000.unk_02 &= ~0x20;
    }
}

void BattleScene_ResetAnimationStep(void) {
    gBattleScene.scene->unk_24 = 0;
}
...
s32 BattleScene_AdvanceOwnerAnimation(Battler* arg0) {
    ...
    if (!(ptr->battleStateFlags & 0x800)) {
        return 0;
    }

    if (gBattleScene.scene->unk_48 == 0x19) {
        return 0;
    }

    if ((ptr->battleStateFlags & 0x800) && (gBattleScene.scene->unk_48 == 0x1C)) {
        return 0;
    }

    switch (gBattleScene.scene->unk_24) {
        case 0:
            BattleAnim_BeginSessionRequestForActiveMon(arg0);
            sp1C = 1;
            gBattleScene.scene->unk_24++;
            break;

        case 1:
            sp1C = 1;
            if (arg0->sessionTeams->modelLoadFlags & 0x10) {
                arg0->sessionTeams->modelLoadFlags &= ~0x90;
...
s32 BattleScene_AdvanceOwnerAnimation98(Battler* arg0) {
    ...
    if (!(arg0->unk_654.battleStateFlags & 0x800)) {
        return 0;
    }
...
s32 BattleScene_AdvanceOwnerAnimationAndClearFlags(Battler* arg0) {
    ...
    if (!(arg0->unk_654.battleStateFlags & 0x1000)) {
        return 0;
    }
    ...
    switch (gBattleScene.scene->unk_24) {
        ...
        case 2:
            ...
            BattleAnim_Vec3fCopy(&gBattleScene.scene->unk_DC->unk_60.at, &sp34);
            break;
    }
    return var_s0;
}
...
s32 BattleScene_AdvanceDoublesOwnerAnimation(Battler* arg0) {
    ...
    if ((gBattleScene.scene->unk_48 == 0x19) || (gBattleScene.scene->unk_48 == 0x1C)) {
        return 0;
    }
...
s32 BattleScene_AdvanceBothOwnerAnimations(void) {
    ...
    if (!(temp_a1->battleStateFlags & 0x800) && !(temp_a2->battleStateFlags & 0x800)) {
        return 0;
    }

    switch (gBattleScene.scene->unk_24) {
        case 0:
            if (temp_a1->battleStateFlags & 0x800) {
                BattleAnim_BeginSessionRequest(D_84390010[0]);
            }
            sp1C = 1;
            gBattleScene.scene->unk_24 = gBattleScene.scene->unk_24 + 1;
            break;

        case 1:
            sp1C = 1;
            if (temp_a1->battleStateFlags & 0x800) {
                if (D_84390010[0]->sessionTeams->modelLoadFlags & 0x10) {
                    D_84390010[0]->sessionTeams->modelLoadFlags &= ~0x90;
        ...
        case 2:
            if (temp_a2->battleStateFlags & 0x800) {
        ...
        case 3:
            sp1C = 1;
            if (temp_a2->battleStateFlags & 0x800) {
                if (D_84390010[1]->sessionTeams->modelLoadFlags & 0x10) {
                    D_84390010[1]->sessionTeams->modelLoadFlags &= ~0x90;
...
void BattleScene_ClearInactiveOwnerAnimationFlags(void) {
    BattleMonRuntime* temp_v0 = &D_84390010[0]->unk_654.monRuntime;
    BattleMonRuntime* temp_v1 = &D_84390010[1]->unk_654.monRuntime;

    if (temp_v0->lockedEffectCounter == 0) {
        temp_v0->lockedEffectFlags &= ~0x20;
    }

    if (temp_v1->lockedEffectCounter == 0) {
        temp_v1->lockedEffectFlags &= ~0x20;
    }
}
...
s32 BattleScene_AnimateDisplayedHpToRuntime(Battler* arg0) {
    BattleMonRuntime* temp_s1 = &arg0->unk_654.monRuntime;
    BattleMon* temp_s2 = &arg0->ownRoster->party[arg0->unk_654.partyIndex];
    f32 temp_fs0;
    UNUSED s16 pad;
    s16 sp30;
    ...
    if (temp_s2->currentHP == temp_s1->currentHP) {
        return 1;
    }

    temp_fs0 = temp_s1->maxHP / 90.0f;
    sp30 = BattleScene_GetParticipantSideIndex(arg0);
    D_843900A8[sp30] = Math_StepToF(D_843900A8[BattleScene_GetParticipantSideIndex(arg0)], temp_s1->currentHP, temp_fs0, temp_fs0);
    temp_s2->currentHP = D_843900A8[BattleScene_GetParticipantSideIndex(arg0)];
    if (temp_s2->currentHP == temp_s1->currentHP) {
        temp_fs0 = D_843900A8[BattleScene_GetParticipantSideIndex(arg0)] - temp_s2->currentHP;
        D_843900A8[BattleScene_GetParticipantSideIndex(arg0)] -= temp_fs0;
        if (arg0->model.modelId == 0x98) {
            return 1;
        }
        return 1;
    }
...
void BattleScene_ClearPhaseFlag(void) {
    gBattleScene.scene->unk_3C = 0;
}

void BattleScene_SetPhaseFlag(void) {
    gBattleScene.scene->unk_3C = 1;
}

void BattleScene_SetPhase(UNUSED unk_D_86002F34_00C* arg0, s32 arg1) {
    gBattleScene.scene->unk_38 = arg1;
    gBattleScene.scene->scenePhase = 0;
}

void BattleScene_SaveCameraFov(unk_D_86002F34_00C* arg0) {
    gBattleScene.scene->cameraFovy = arg0->unk_24.fovy;
}
...
s32 BattleScene_GetAnimationTimingField0D(Battler* arg0) {
    MovePresentationCue* ptr = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[arg0->unk_654.monRuntime.currentMoveId - 1];
...
s32 BattleScene_GetMappedAnimationTimingField0D(Battler* arg0) {
    UNUSED s32 pad;
    s32 sp18 = D_84384670[arg0->unk_654.monRuntime.currentMoveId - 1];
    MovePresentationCue* ptr = &D_84384570[BattleScene_GetParticipantSideIndex(arg0)]->moveCues[sp18];
...
void Battle_StartTurn(void) {
    ...
    sp2C = gBattleScene.scene->activeBattlerIndex;
    gBattleScene.scene->activeBattlerIndex = Battle_DetermineMoveOrder(D_84390010[0], D_84390010[1]);

    ptr = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654.monRuntime;
    if ((ptr->currentMoveId & 0xF0) == 0xF0) {
        gBattleScene.scene->activeBattlerIndex = !gBattleScene.scene->activeBattlerIndex;
    }

    if (D_84390010[0]->ownRoster->slotState & 2) {
        if (gBattleScene.scene->activeBattlerIndex == 0) {
            BattleAI_RecordUsedMove(temp_s0->partyIndex, temp_s1->partyIndex, 0);
        } else {
            BattleAI_RecordUsedMove(temp_s0->partyIndex, temp_s1->partyIndex, 1);
        }
    } else if (D_84390010[1]->ownRoster->slotState & 2) {
        if (gBattleScene.scene->activeBattlerIndex == 1) {
            BattleAI_RecordUsedMove(temp_s1->partyIndex, temp_s0->partyIndex, 0);
        } else {
            BattleAI_RecordUsedMove(temp_s1->partyIndex, temp_s0->partyIndex, 1);
        }
    }

    gBattleScene.scene->unk_2A = gBattleScene.scene->activeBattlerIndex;
    gBattleScene.scene->unk_38 = 0;
    temp_s0->moveResourceFlags = 0;
    temp_s1->moveResourceFlags = 0;
    gBattleScene.scene->unk_44 = 2;
    Battle_ResolveMonAction();
    gBattleScene.scene->activeBattlerIndex = sp2C;
}
...
void BattleScene_InitializeSwitchActions(void) {
    ...
    if ((sp28->faintSequenceState == 0xF) || (sp28->faintSequenceState == 0x10)) {
        if (D_84390010[0]->ownRoster->slotState & 2) {
            BattleAI_RecordUsedMove(sp28->partyIndex, sp24->partyIndex, 2);
        }
        gBattleScene.scene->activeBattlerIndex = 0;
        gBattleScene.scene->unk_2A = 0;
        gBattleScene.scene->unk_38 = 0;
        gBattleScene.scene->unk_44 = 2;
        Battle_InitializeSwitchedInRuntimeMon(D_84390010[0]);
        gBattleScene.scene->activeBattlerIndex = sp2C;
    } else {
        if (D_84390010[0]->ownRoster->slotState & 2) {
            BattleAI_RecordUsedMove(sp24->partyIndex, sp28->partyIndex, 2);
        }
        gBattleScene.scene->activeBattlerIndex = 1;
        gBattleScene.scene->unk_2A = 1;
        gBattleScene.scene->unk_38 = 0;
        gBattleScene.scene->unk_44 = 2;
        Battle_InitializeSwitchedInRuntimeMon(D_84390010[1]);
        gBattleScene.scene->activeBattlerIndex = sp2C;
    }
}
...
s32 BattleScene_PrepareReplacementTransition(void) {
    ...
    BattlerState* temp_a3 = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654;
    BattlerState* sp20 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;

    if ((D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654.faintSequenceState == 0xF) || (sp24->faintSequenceState == 0x10)) {
        if (D_84390010[gBattleScene.scene->activeBattlerIndex]->ownRoster->slotState & 2) {
            BattleAI_RecordUsedMove(temp_a3->partyIndex, sp20->partyIndex, 2);
        }
        Battle_ClearRuntimeFlags(D_84390010[gBattleScene.scene->activeBattlerIndex], 0x1800);
        gBattleScene.scene->scenePhase = 0;
        gBattleScene.scene->unk_14 = 0;
        if (sp24->faintSequenceState == 0x10) {
            gBattleScene.scene->unk_38 = 0x12;
        } else {
            BattleAnim_GetOwnerDefaultAnchorPosition(D_84390010[gBattleScene.scene->activeBattlerIndex], &D_843901B0.unk_00);
            BattleScene_LoadCameraPreset(&D_843848F0, gBattleScene.scene->unk_DC, D_84390010[gBattleScene.scene->activeBattlerIndex]);
            gBattleScene.scene->unk_38 = 0xB;
        }
        return 1;
    }
...
void BattleScene_BeginBattlePhase(void) {
    ...
    if ((BattleScene_IsPresentationCountdownComplete() == 0) && (D_84390134 != 1)) {
        Audio_ResetSequencePlaybackState(1);
    }
    ...
    if ((sp1C->faintSequenceState == 0x10) || (sp18->faintSequenceState == 0x10) || (gBattleScene.scene->unk_2E == 2)) {
        BattleScene_SetCameraSubstate(1, 0);
    } else {
        BattleScene_SetCameraSubstate(1, 1);
    }

    gBattleScene.scene->unk_44 = 1;
...
s32 BattleScene_TransitionToPhaseFull(s32 arg0) {
    ...
    gBattleScene.scene->scenePhase = 0;
    gBattleScene.scene->unk_14 = 0;
    gBattleScene.scene->unk_38 = arg0;
    return 1;
}
...
void Battle_ActSecondAttacker(u8 arg0) {
    ...
    gBattleScene.scene->activeBattlerIndex = !gBattleScene.scene->activeBattlerIndex;
    temp_a3 = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654;

    if ((temp_a3->faintSequenceState == 0xF) || (temp_a3->faintSequenceState == 0x10)) {
        Battle_InitializeSwitchedInRuntimeMon(D_84390010[gBattleScene.scene->activeBattlerIndex]);
    } else {
        Battle_ResolveMonAction();
    }

    gBattleScene.scene->simultaneousActionFlag = 1;
    gBattleScene.scene->unk_A0.z = 0.0f;
    BattleScene_SetPhase(gBattleScene.scene->unk_DC, 0x24);
    gBattleScene.scene->unk_78 = arg0;
}

void BattleScene_PhaseResumeSaved(void) {
    if (BattleScene_AdvanceOwnerAnimation(D_84390010[gBattleScene.scene->activeBattlerIndex]) == 0) {
        gBattleScene.scene->unk_38 = gBattleScene.scene->unk_78;
    }
}
...
void BattleScene_CleanupActionAndAdvance(void) {
    ...
    if (gBattleScene.scene->simultaneousActionFlag == 0) {
        BattleAnim_ClearOverlayFlag(D_84390010[gBattleScene.scene->activeBattlerIndex]);
        Audio_FadeAndClearStoredSounds();
        BattleScene_ResetAnimationStep();

        sp24 = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654.monRuntime;
        sp20 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654.monRuntime;
        sp1C = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;

        if ((((sp24->currentMoveId & 0xF0) == 0xF0) || ((sp20->currentMoveId & 0xF0) == 0xF0)) && (sp1C->faintSequenceState != 0xF) &&
            (sp1C->faintSequenceState != 0x10)) {
            gBattleScene.scene->scenePhase = 0;
            gBattleScene.scene->unk_14 = 0;
            gBattleScene.scene->unk_38 = 4;

            if ((sp24->currentMoveId & 0xF0) == 0xF0) {
                sp24->currentMoveId = 0xA5;
            }

            if ((sp20->currentMoveId & 0xF0) == 0xF0) {
                sp20->currentMoveId = 0xA5;
            }
        } else {
...
s32 BattleScene_HandleFaintStatusCompletion(void) {
    BattleMonRuntime* temp_v0 = &D_84390200->unk_654.monRuntime;

    if (((temp_v0->volatileStatusFlags & 0x80) || (temp_v0->status & 0x18)) && ((temp_v0->currentMoveId & 0xF0) == 0xF0)) {
        BattleAnim_ClearOverlayFlag(D_84390010[gBattleScene.scene->activeBattlerIndex]);
        Audio_FadeAndClearStoredSounds();
        BattleScene_ResetAnimationStep();
        Battle_ActSecondAttacker(3);
...
void BattleScene_CompleteActionPhase(void) {
    if ((gBattleScene.scene->simultaneousActionFlag == 0) && ((D_84390200->unk_654.monRuntime.currentMoveId & 0xF0) != 0xF0)) {
        BattleAnim_ClearOverlayFlag(D_84390010[gBattleScene.scene->activeBattlerIndex]);
        Audio_FadeAndClearStoredSounds();
        BattleScene_ResetAnimationStep();
        Battle_ActSecondAttacker(3);
...
void BattleScene_ResolveDisplayedHpCompletion(unk_D_86002F34_00C* arg0) {
    if ((D_84390220 == 1) && (D_84390224 == 1)) {
        if (Battle_GetActiveMonHp(D_84390010[gBattleScene.scene->activeBattlerIndex]) == 0) {
            BattleScene_SwitchActiveSideAndSetPhase(arg0);
        } else if (Battle_GetActiveMonHp(D_84390010[!gBattleScene.scene->activeBattlerIndex]) == 0) {
            BattleScene_SetPhase(arg0, 5);
        } else {
...
void BattleScene_UpdateDisplayedHpAndTransition(unk_D_86002F34_00C* arg0) {
    ...
    } else if (gBattleScene.scene->unk_4C == 0xA) {
        BattleScene_TransitionToPhaseDuplicate(0xA);
    } else if (gBattleScene.scene->unk_48 == 9) {
        BattleScene_TransitionToPhaseFull(9);
    } else if ((sp1C->status & 0x18) || (sp1C->volatileStatusFlags & 0x80)) {
...
s32 BattleScene_ActionPresentationTransitionCheck(void) {
    switch (gBattleScene.scene->unk_48) {
        case 7:
        case 38:
        case 39:
...
s32 BattleScene_ActionPresentationCleanupCheck(void) {
    s32 tmp = gBattleScene.scene->unk_48;
    ...
    if ((gBattleMoveFailed != 0) || (gBattleScene.scene->unk_48 == 8)) {
...
s32 BattleScene_PrepareResidualStatusPresentation(void) {
    s32 idx = gBattleScene.scene->activeBattlerIndex;
    BattleMonRuntime* temp_v1_2 = &D_84390010[idx]->unk_654.monRuntime;

    if (((temp_v1_2->volatileStatusFlags & 0x80) || (temp_v1_2->status & 0x18)) && ((temp_v1_2->currentMoveId & 0xF0) == 0xF0)) {
...
void BattleScene_UpdateActiveOwnerPointers(void) {
    ...
    D_84390204 = D_84390010[gBattleScene.scene->activeBattlerIndex];
    idx = gBattleScene.scene->activeBattlerIndex == 0;
...
void BattleScene_InitializeBattlePresentation(unk_D_86002F34_00C* arg0) {
    ...
    BattleScene_ResetAnimationStep();
    gBattleScene.scene->simultaneousActionFlag = 0;
    BattleScene_ClearPhaseFlag();
    gBattleScene.scene->unk_14 = 0;
...
void BattleScene_SendOutPresentationFinalize(unk_D_86002F34_00C* arg0) {
    BattlerState* temp_t2 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;
    BattlerState* temp_t1 = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654;
    s16 sp2E = D_84390010[gBattleScene.scene->activeBattlerIndex]->model.modelId;
    MovePresentationCue* sp28 = &D_84384570[gBattleScene.scene->activeBattlerIndex]->unk_A50;
    Battler* sp24 = D_84390010[gBattleScene.scene->activeBattlerIndex];

    if (((temp_t2->faintSequenceState == 0x13) && (temp_t1->faintSequenceState == 0x13)) ||
        ((temp_t2->faintSequenceState == 0x10) && (temp_t1->faintSequenceState == 0x13)) ||
        ((temp_t1->faintSequenceState == 0x10) && (temp_t2->faintSequenceState == 0x13))) {
        BattleBox_Open(0xE);
        ...
        gBattleScene.scene->scenePhase = 8;
        return;
    }

    if (temp_t1->battleStateFlags & 0x4008) {
        sp24->model.materialAlpha = 0xFF;
        BattleAnim_StopOwnerCategoryParticles(4, sp24);
        sp24->model.unk_024.y = D_84390028[gBattleScene.scene->activeBattlerIndex].unk_08;
        sp24->model.unk_000.unk_02 &= ~0x2;
        sp24->model.unk_000.unk_02 |= 0x20;
        sp24->model.unk_000.unk_01 |= 1;
        Battle_ClearRuntimeFlags(sp24, 0x4608);
    }

    if (D_84390010[gBattleScene.scene->activeBattlerIndex]->presentationSubState == 0xA) {
        BattleScene_SetParticipantModelFlags(D_84390010[gBattleScene.scene->activeBattlerIndex], 0, 0);
    }

    if (D_84390010[gBattleScene.scene->activeBattlerIndex]->presentationSubState == 0xD) {
        BattleScene_SetParticipantModelFlags(D_84390010[gBattleScene.scene->activeBattlerIndex], 0, 0);
    }

    if (D_84390010[gBattleScene.scene->activeBattlerIndex]->presentationSubState == 0x10) {
        BattleScene_SetParticipantModelFlags(D_84390010[gBattleScene.scene->activeBattlerIndex], 0, 0);
    }

    D_84390010[gBattleScene.scene->activeBattlerIndex]->model.unk_01E.x = 0;
    if ((sp2E == 0x32) || (sp2E == 0x33)) {
        D_84390010[gBattleScene.scene->activeBattlerIndex]->model.unk_000.unk_02 |= 0x20;
        D_84390010[gBattleScene.scene->activeBattlerIndex]->model.unk_000.unk_01 |= 1;
        ModelAnim_SetAnimation(&D_84390010[gBattleScene.scene->activeBattlerIndex]->model, sp28->animationId);
    }

    Battle_ResetModelToIdleAnim(D_84390010[gBattleScene.scene->activeBattlerIndex]);
    Vec3f_SetComponentsDuplicate(&D_84390010[gBattleScene.scene->activeBattlerIndex]->model.unk_030, 1.0f, 1.0f, 1.0f);
    D_84390010[gBattleScene.scene->activeBattlerIndex]->model.unk_024.y = BattleScene_GetParticipantModelHeight(D_84390010[gBattleScene.scene->activeBattlerIndex]);
    BattleAnim_GetOwnerDefaultAnchorPosition(D_84390010[gBattleScene.scene->activeBattlerIndex], &D_843901B0.unk_00);
    BattleScene_LoadCameraPreset(&D_84384AF8, arg0, D_84390010[gBattleScene.scene->activeBattlerIndex]);
    BattleScene_ApplyCameraPreset(arg0, D_84390010[gBattleScene.scene->activeBattlerIndex], 1);
    Audio_StartBattleMusicSequence();
    gBattleScene.scene->scenePhase = 6;
}
...
s32 BattleScene_ResetOwnerStatusPresentation(Battler* arg0) {
    ...
    if (sp28->battleStateFlags & 0x200) {
        Battle_ClearRuntimeFlags(arg0, 0x60C);
        return 1;
    }

    if (sp28->battleStateFlags & 0x4008) {
        arg0->model.materialAlpha = 0xFF;
        BattleAnim_StopOwnerCategoryParticles(4, arg0);
        arg0->model.unk_024.y = D_84390028[BattleScene_GetParticipantSideIndex(arg0)].unk_08;
        arg0->model.unk_000.unk_02 &= ~0x2;
        arg0->model.unk_000.unk_02 |= 0x20;
        arg0->model.unk_000.unk_01 |= 1;
        Battle_ClearRuntimeFlags(arg0, 0x4608);
    }

    BattleAnim_EndSleepStatusAnimation(arg0);
    sp28->modelAlpha = 0xFF;
    Model_SetMaterialColor(&arg0->model, 0xFF, 0xFF, 0xFF, sp28->modelAlpha);
...
void BattleScene_AdvanceSendOutPreparation(unk_D_86002F34_00C* arg0) {
    if (BattleScene_AdvanceOwnerAnimation(D_84390010[!gBattleScene.scene->activeBattlerIndex]) == 0) {
        ...
        BattleScene_ResetCameraFrameCounter();
        func_8003F1AC(BattleScene_GetParticipantDisplayPlayerNumber(D_84390010[!gBattleScene.scene->activeBattlerIndex]));

        if (BattleScene_ResetOwnerStatusPresentation(D_84390010[!gBattleScene.scene->activeBattlerIndex]) != 0) {
            BattleScene_EnterStateRow(D_84390010[!gBattleScene.scene->activeBattlerIndex], 0x11);
            BattleScene_ClearCameraOffsetVectors();
            gBattleScene.scene->scenePhase = 0xA;
        } else {
            BattleScene_EnterStateRow(D_84390010[!gBattleScene.scene->activeBattlerIndex], 0);
            BattleScene_ClearCameraOffsetVectors();
            gBattleScene.scene->scenePhase++;
        }

        BattleScene_SelectCameraShot(D_84390010[!gBattleScene.scene->activeBattlerIndex], arg0, 3);

        if (BattleScene_IsPartnerPikachu(D_84390010[!gBattleScene.scene->activeBattlerIndex]) != 0) {
            Cry_Play(0xC8, 1);
        } else {
            Cry_Play(D_84390010[!gBattleScene.scene->activeBattlerIndex]->model.modelId, 1);
        }
    }
}
...
void BattleScene_AdvanceSendOutCamera(unk_D_86002F34_00C* arg0) {
    UNUSED s32 pad[2];
    BattlerState* sp24 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;
    MovePresentationCue* sp20 = &D_84384570[!gBattleScene.scene->activeBattlerIndex]->unk_A70;

    if (BattleAnim_IsAssetLoadBusy(D_84390010[!gBattleScene.scene->activeBattlerIndex]) == 0) {
        if (gBattleScene.scene->unk_14 == 0x1D) {
            BattleScene_SelectCameraShot(D_84390010[!gBattleScene.scene->activeBattlerIndex], arg0, 4);
        }

        if (BattleScene_AdvanceCameraFrameCounterUntil(0x1E) != 0) {
            BattleScene_ApproachCameraZoom(arg0, D_84390010[!gBattleScene.scene->activeBattlerIndex]);
        }

        if (((sp20->phaseThreshold >> 1) == (D_84390010[!gBattleScene.scene->activeBattlerIndex]->model.unk_040.unk_08 >> 0x10)) &&
            (sp24->faintSequenceState != 0x12)) {
            BattleBox_Open(9);
        }

        if (sp20->cameraFrameCount == ((D_84390010[!gBattleScene.scene->activeBattlerIndex]->model.unk_040.unk_08 >> 0x10) + 3)) {
            D_84390010[!gBattleScene.scene->activeBattlerIndex]->model.unk_000.unk_02 &= ~0x20;
            Battle_SetRuntimeFlags(D_84390010[!gBattleScene.scene->activeBattlerIndex], 0x100);
            BattleScene_ResetCameraFrameCounter();
            gBattleScene.scene->scenePhase += 1;
        }
        BattleScene_ApproachCameraTarget(arg0, D_84390010[!gBattleScene.scene->activeBattlerIndex], 0);
    }
}

void BattleScene_AdvanceSendOutCameraClose(unk_D_86002F34_00C* arg0) {
    BattleScene_ApproachCameraTarget(arg0, D_84390010[!gBattleScene.scene->activeBattlerIndex], 1);
...
void BattleScene_FinishSendOutCameraClose(unk_D_86002F34_00C* arg0) {
    BattlerState* temp_s0 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;
    ...
    if (BattleScene_AdvanceCameraFrameCounter(5) != 0) {
        ...
        if (temp_s0->faintSequenceState != 0x12) {
            temp_s0->faintSequenceState = 0x10;
        }

        if (temp_s0->faintSequenceState == 0x12) {
            temp_s0->faintSequenceState = 0x13;
        }
...
void BattleScene_CompleteSendOutPresentation(unk_D_86002F34_00C* arg0) {
    ...
    if (BattleScene_AdvanceCameraFrameCounter(0xA) != 0) {
        ...
        if (sp24->faintSequenceState == 0x10) {
            ...
            if ((sp20->faintSequenceState == 0x11) || (sp20->faintSequenceState == 0x12)) {
                gBattleScene.scene->unk_38 = 5;
                gBattleScene.scene->activeBattlerIndex = !gBattleScene.scene->activeBattlerIndex;
            } else if ((sp24->faintSequenceState == 0x13) || (sp20->faintSequenceState == 0x13)) {
                BattleBox_Open(0xE);
                Vec3f_SetComponentsDuplicate(&arg0->unk_60.at, 0.0f, 75.0f, 0.0f);
                Vec3f_SetComponentsDuplicate(&arg0->unk_60.eye, 0.0f, 80.0f, 400.0f);
                Audio_StartBattleMusicSequence();
        ...
        } else if ((sp20->faintSequenceState == 0x12) || (sp20->faintSequenceState == 0x11)) {
            gBattleScene.scene->unk_14 = 0;
            gBattleScene.scene->scenePhase = 0;
            gBattleScene.scene->unk_38 = 5;
            gBattleScene.scene->activeBattlerIndex = !gBattleScene.scene->activeBattlerIndex;
...
void BattleScene_SetupSendOutOwnerShot(unk_D_86002F34_00C* arg0) {
    ...
    if (BattleScene_AnimateCameraPreset(arg0, temp_s0, 1, 0) != 0) {
        ...
        if ((D_84390010[gBattleScene.scene->activeBattlerIndex]->model.modelId == 0x5F) && (gBattleScene.scene->activeBattlerIndex == 1)) {
            sp3B = 0x97;
        }

        sp44 = (D_84384580[gBattleScene.scene->activeBattlerIndex]->positionOffset.y + temp_s0->model.unk_024.y) + D_84384C30[sp3B].z;
        sp40 = ((D_84384580[gBattleScene.scene->activeBattlerIndex]->positionOffset.z + D_84384C30[sp3B].y) * temp_s0->yawBase) +
               temp_s0->model.unk_024.x;

        Vec3f_SetComponentsDuplicate(&arg0->unk_60.at, sp40, sp44, temp_s0->model.unk_024.z);

        sp40 = D_84384580[gBattleScene.scene->activeBattlerIndex]->positionOffset.x * D_84384C30[sp3B].x;
        sp3E = D_84384580[gBattleScene.scene->activeBattlerIndex]->rotationOffset;
        tmp1 = (temp_s0->yawBase * D_84384580[gBattleScene.scene->activeBattlerIndex]->rotationScale) + BattleScene_GetParticipantFacingAngle(temp_s0);
...
void BattleScene_CompleteSendOutCameraFade(UNUSED unk_D_86002F34_00C* arg0) {
    if (BattleScene_AdvanceCameraFrameCounter(0x50) != 0) {
        gBattleScene.scene->battleOutcome = gBattleScene.scene->activeBattlerIndex + 1;
        BattleBox_Close();
...
void BattleScene_AdvanceSendOutFollowupCamera(unk_D_86002F34_00C* arg0) {
    UNUSED s32 pad[2];
    BattlerState* sp24 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;
    MovePresentationCue* sp20 = &D_84384570[!gBattleScene.scene->activeBattlerIndex]->unk_B10;
    ...
    if (BattleAnim_IsAssetLoadBusy(D_84390010[!gBattleScene.scene->activeBattlerIndex]) == 0) {
        ...
        if (sp20->cameraFrameCount == ((D_84390010[!gBattleScene.scene->activeBattlerIndex]->model.unk_040.unk_08 >> 0x10) + 3)) {
            ...
            Battle_SetRuntimeFlags(D_84390010[!gBattleScene.scene->activeBattlerIndex], 0x100);
            BattleScene_ResetCameraFrameCounter();
            BattleScene_UpdateCameraModelOffset(D_84390010[!gBattleScene.scene->activeBattlerIndex], arg0);
            gBattleScene.scene->scenePhase = 2;
        }
...
void BattleScene_CompleteSendOutFollowup(UNUSED unk_D_86002F34_00C* arg0) {
    BattlerState* sp1C = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;
...
void BattleScene_ResetOwnerPresentationFlags(Battler* arg0) {
    ...
    if (ptr->battleStateFlags & 0x200) {
        arg0->model.unk_024.y = D_84390028[BattleScene_GetParticipantSideIndex(arg0)].unk_08;
        Battle_ClearRuntimeFlags(arg0, 0x608);
    } else if (ptr->battleStateFlags & 0x4008) {
        arg0->model.materialAlpha = 0xFF;
        BattleAnim_StopOwnerCategoryParticles(4, arg0);
        arg0->model.unk_024.y = D_84390028[BattleScene_GetParticipantSideIndex(arg0)].unk_08;
        arg0->model.unk_000.unk_02 &= ~0x2;
...
void BattleScene_InitializeIntroCamera(unk_D_86002F34_00C* arg0) {
    ...
    if ((sp20->battleStateFlags & 0x4000) || ((sp1C->battleStateFlags & 0x4000) != 0)) {
        sp24 = 2;
    } else if ((sp20->battleStateFlags & 0x200) || (sp1C->battleStateFlags & 0x200)) {
        sp24 = 4;
    } else if ((sp20->faintSequenceState == 0x10) || (sp1C->faintSequenceState == 0x10)) {
        sp24 = 2;
    }
...
void BattleScene_SetMonMoveResourceFlag(Battler* arg0) {
    arg0->unk_654.moveResourceFlags = 0x800;
}
...
void BattleScene_SelectActionCameraPreset(unk_D_86002F34_00C* arg0) {
    ...
    if (gBattleScene.scene->unk_48 == 0xE) {
        var_t0 = BattleScene_GetMappedAnimationTimingField0D(D_84390010[gBattleScene.scene->activeBattlerIndex]);
    } else if ((gBattleScene.scene->unk_48 == 0x1C) || (gBattleScene.scene->unk_48 == 0x11) ||
               (gBattleScene.scene->unk_48 == 0x1F)) {
        var_t0 = 0;
    } else {
        var_t0 = BattleScene_GetAnimationTimingField0D(D_84390010[gBattleScene.scene->activeBattlerIndex]);
    }

    if ((sp1C->currentMoveId == 0x3A) || (sp1C->currentMoveId == 0x8F)) {
        if ((gBattleScene.scene->unk_48 != 0x1C) && (gBattleScene.scene->unk_48 != 0x11) &&
            (gBattleScene.scene->unk_48 != 0x1F)) {
            var_t0 = 0x16;
        }
    }
    ...
    switch (var_t0) {
        case 20:
            BattleScene_SelectCameraPreset(D_84390204, arg0,
                          gBattleScene.scene->unk_50 = D_84385B70[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B70))], 1);
            break;

        case 21:
            BattleScene_SelectCameraPreset(D_84390204, arg0,
                          gBattleScene.scene->unk_50 = D_84385B78[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B78))], 1);
            break;

        case 22:
            BattleScene_SelectCameraPreset(D_84390204, arg0,
                          gBattleScene.scene->unk_50 = D_84385B7C[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B7C))], 1);
            break;

        case 23:
            BattleScene_SelectCameraPreset(D_84390204, arg0,
                          gBattleScene.scene->unk_50 = D_84385B80[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B80))], 1);
            break;

        case 24:
            BattleScene_SelectCameraPreset(D_84390204, arg0,
                          gBattleScene.scene->unk_50 = D_84385B88[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B88))], 1);
            break;

        default:
            BattleScene_SelectCameraPreset(D_84390204, arg0, gBattleScene.scene->unk_50 = var_t0, 1);
            if (sp18->battleStateFlags & 0x4000) {
...
s32 BattleScene_AdvanceActionPresentationSetup(unk_D_86002F34_00C* arg0) {
    ...
    if (gBattleScene.scene->unk_48 == 0x14) {
        BattleScene_EnterStateRow(D_84390010[gBattleScene.scene->activeBattlerIndex], 0x15);
    } else if (gBattleScene.scene->unk_48 == 0x18) {
        BattleScene_EnterStateRow(D_84390010[gBattleScene.scene->activeBattlerIndex], 3);
    } else if (sp20->battleStateFlags & 0x4400) {
        BattleScene_EnterStateRow(D_84390010[gBattleScene.scene->activeBattlerIndex], 3);
        BattleScene_SelectCameraPreset(D_84390010[gBattleScene.scene->activeBattlerIndex], arg0, gBattleScene.scene->unk_50 = 2, 1);
    } else {
        BattleScene_EnterStateRow(D_84390010[gBattleScene.scene->activeBattlerIndex], 3);
    }
...
void BattleScene_ActionSetupCameraStep(unk_D_86002F34_00C* arg0) {
    ...
    switch (gBattleScene.scene->unk_3C) {
        case 0:
            BattleScene_CleanupParticipantEffectMode(D_84390010[0]);
            BattleScene_CleanupParticipantEffectMode(D_84390010[1]);

            if ((BattleScene_PrepareReplacementTransition() == 0) &&
                (BattleScene_PrepareResidualStatusPresentation() == 0)) {
...
void BattleScene_RefreshActionCameraPreset(unk_D_86002F34_00C* arg0) {
    ...
    if (D_84390230 != D_8439022C) {
        temp_v0 = BattleScene_GetAnimationTimingField0E(D_84390010[gBattleScene.scene->activeBattlerIndex]) & 0xFFFFFFFF;
        switch (temp_v0) {
            case 20:
                do {
                    temp_t0 = D_84385B70[BattleAnim_RandomIntWithWarmup(5.0f)];
                } while (temp_t0 == gBattleScene.scene->unk_50);
                gBattleScene.scene->unk_50 = temp_t0;
                BattleScene_SelectCameraPreset(D_84390204, arg0, gBattleScene.scene->unk_50, 1);
                break;
            ...
            default:
                if (temp_v0 != gBattleScene.scene->unk_50) {
...
void BattleScene_SelectActionCameraPresetFromTiming(unk_D_86002F34_00C* arg0, s32 arg1) {
    ...
    if ((gBattleScene.scene->unk_50 != 1) && (gBattleScene.scene->unk_50 != 4) && (gBattleScene.scene->unk_50 != 5) &&
        (gBattleScene.scene->unk_50 != 8) && (gBattleScene.scene->unk_50 != 9) && (gBattleScene.scene->unk_50 != 0xA) &&
        (gBattleScene.scene->unk_50 != 0xB)) {
        if (arg1 == 1) {
            sp18 = BattleScene_GetMappedAnimationTimingField0E(D_84390010[gBattleScene.scene->activeBattlerIndex]);
        } else {
            sp18 = BattleScene_GetAnimationTimingField0E(D_84390010[gBattleScene.scene->activeBattlerIndex]);
        }
        ...
        switch (sp18) {
            case 20:
                gBattleScene.scene->unk_50 = D_84385B70[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B70))];
                if (sp18 != gBattleScene.scene->unk_50) {
                    BattleScene_SelectCameraPreset(D_84390204, arg0, gBattleScene.scene->unk_50, 1);
                }
                break;

            case 21:
                gBattleScene.scene->unk_50 = D_84385B78[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B78))];
                if (sp18 != gBattleScene.scene->unk_50) {
                    BattleScene_SelectCameraPreset(D_84390204, arg0, gBattleScene.scene->unk_50, 1);
                }
                break;
            ...
            case 22:
                gBattleScene.scene->unk_50 = D_84385B7C[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B7C))];
                if (sp18 != gBattleScene.scene->unk_50) {
                    BattleScene_SelectCameraPreset(D_84390204, arg0, gBattleScene.scene->unk_50, 1);
                }
                break;
            ...
            case 23:
                gBattleScene.scene->unk_50 = D_84385B80[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B80))];
                if (sp18 != gBattleScene.scene->unk_50) {
                    BattleScene_SelectCameraPreset(D_84390204, arg0, gBattleScene.scene->unk_50, 1);
                }
                break;
            ...
            case 24:
                gBattleScene.scene->unk_50 = D_84385B88[BattleAnim_RandomIntWithWarmup(ARRAY_COUNT(D_84385B88))];
                if (sp18 != gBattleScene.scene->unk_50) {
                    BattleScene_SelectCameraPreset(D_84390204, arg0, gBattleScene.scene->unk_50, 1);
                }
                break;
...
s32 BattleScene_ApplyActionCameraMode(unk_D_86002F34_00C* arg0, s32 arg1) {
    ...
    switch (gBattleScene.scene->unk_50) {
        case 1:
        ...
        default:
            if ((D_84390204->presentationSubState != 6) && (D_84390204->presentationSubState != 4) && (arg1 != 0)) {
        ...
        case 0:
            ...
            if (Battle_IsRowAnimationSettled(D_84390204, 0x32) != 0) {
                ...
                if ((D_84390230 < 0) || (gBattleMoveFailed != 0)) {
                    ...
                    gBattleScene.scene->unk_3C++;
                } else {
                    BattleScene_EnterStateRow(D_84390010[gBattleScene.scene->activeBattlerIndex], 0x13);
                    Audio_FadeAndClearStoredSounds();
                    BattleAnim_CleanupEffects(1);
                    gBattleScene.scene->unk_3C = 0;
                }
...
void BattleScene_ActionSetupAnimationVariantC(unk_D_86002F34_00C* arg0) {
    UNUSED s32 pad;
    BattleMonRuntime* sp18 = &D_84390204->unk_654.monRuntime;
    ...
    switch (gBattleScene.scene->unk_3C) {
        case 0:
            BattleScene_ResetCameraFrameCounter();
            BattleScene_SetPhaseFlag();
            Vec3f_SetComponentsDuplicate(&D_843901B0.unk_00, D_84390204->yawBase * -175.0f, 25.0f, 0.0f);
            BattleScene_LoadCameraPreset(&D_84384958, arg0, D_84390204);
            if ((D_84390204->model.modelId != 0x33) && (D_84390204->model.modelId != 0x32)) {
                BattleAnim_PlayMoveEffectScriptA(D_84390204, sp18->currentMoveId);
            }
            break;
...
void BattleScene_ActionSetupAnimationStep(unk_D_86002F34_00C* arg0) {
    BattlerState* temp_a2 = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654;
    u32 var_v1 = 0;

    if (gBattleScene.scene->unk_48 == 0x18) {
        var_v1 = 0xA;
    } else if (gBattleScene.scene->unk_48 == 0x14) {
        var_v1 = 0xB;
    } else if (temp_a2->battleStateFlags & 0x4000) {
        var_v1 = 0xC;
    } else if (temp_a2->battleStateFlags & 0x10) {
        var_v1 = 0xC;
    } else if (temp_a2->battleStateFlags & 0x400) {
        var_v1 = 0xD;
    }
    ...
    switch (gBattleScene.scene->unk_3C) {
        case 0:
            if (BattleScene_AdvanceOwnerAnimation98(D_84390200) == 0) {
                ...
                Battle_WriteBackRuntimeState(D_84390200);
                BattleBox_Open(1);
            }
            break;
...
void BattleScene_RunMoveEffectEndHpTransition(unk_D_86002F34_00C* arg0) {
    BattleMonRuntime* sp34 = &D_84390204->unk_654.monRuntime;
    UNUSED s32 pad;
    UNUSED s16 pad2;
    s16 sp2C;
    ...
    switch (gBattleScene.scene->unk_3C) {
        case 0:
            if (BattleScene_AdvanceOwnerAnimation98(D_84390200) == 0) {
                ...
                BattleAnim_QueueMoveEffectEnd(sp34->currentMoveId, D_84390204, D_84390200, sp2C, Battle_GetSideAnimTableFieldC(D_84390200));
...
void BattleScene_RunActionEffectHpTransition(unk_D_86002F34_00C* arg0) {
    BattleMonRuntime* sp24 = &D_84390200->unk_654.monRuntime;
    UNUSED s32 pad;
    s32 sp1C;
    s32 temp_v0;
    s32 var_a0;
    ...
    switch (gBattleScene.scene->unk_3C) {
        case 0:
            if (BattleScene_AdvanceOwnerAnimation98(D_84390200) == 0) {
                ...
                if (gBattleScene.scene->unk_1A == 3) {
                    BattleScene_EnterStateRow(D_84390204, 0xB);
                } else {
...
void BattleScene_RunRepeatedHitHpTransition(unk_D_86002F34_00C* arg0) {
    BattleMonRuntime* sp24 = &D_84390204->unk_654.monRuntime;
    MovePresentationCue* temp_v1 = &D_84384570[BattleScene_GetParticipantSideIndex(D_84390200)]->moveCues[sp24->currentMoveId - 1];
    volatile s32 sp1C;
    s32 temp_v0_2;

    if (D_84390200->model.modelId == 0x98) {
        sp1C = 0xF;
    } else if (temp_v1->cameraFrameCount == 0xFF) {
        sp1C = D_84390204->model.unk_040.unk_04->unk_0A - temp_v1->transitionFrame;
    } else {
        sp1C = temp_v1->cameraFrameCount - temp_v1->transitionFrame;
    }
...
void BattleScene_ActionSetupFinalizeStep(unk_D_86002F34_00C* arg0) {
    BattleScene_ResetCameraFov(arg0);
    Battle_WriteBackRuntimeState(D_84390010[!gBattleScene.scene->activeBattlerIndex]);
    if (gBattleScene.scene->unk_48 == 0x16) {
        BattleScene_RunBasicHpTransition(arg0);
    } else if (gBattleScene.scene->unk_48 == 0x20) {
        BattleScene_RunMoveEffectEndHpTransition(arg0);
    } else if (gBattleScene.scene->unk_48 == 0x1A) {
        BattleScene_RunConditionalHpTransition(arg0);
    } else if (gBattleScene.scene->unk_1A == 1) {
...
s32 BattleScene_PhaseSelectMoveAnim(void) {
    BattleScene_ApplyActionCameraMode(gBattleScene.scene->unk_DC, 0);

    if (BattleScene_AdvanceCameraFrameCounter(BattleScene_GetCameraShotDuration(D_84390204)) == 0) {
        return 0;
    }

    if ((gBattleScene.scene->unk_48 != 0x1E) && (gBattleScene.scene->unk_48 != 0x27)) {
        BattleBox_Open(3);
    }

    if (gBattleScene.scene->unk_48 == 0x1B) {
...
void BattleScene_Phase7(unk_D_86002F34_00C* arg0) {
    BattleMonRuntime* sp1C = &D_84390204->unk_654.monRuntime;
    MovePresentationCue* sp18 = &D_84384570[BattleScene_GetParticipantSideIndex(D_84390204)]->moveCues[sp1C->currentMoveId - 1];
    ...
    switch (gBattleScene.scene->scenePhase) {
        case 0:
            ...
            BattleScene_ResetCameraFrameCounter();
            BattleScene_ResetCameraSubstepCounter();
            if (sp18->phaseThreshold < 0x15) {
                Battle_WriteBackRuntimeState(D_84390204);
            }
            gBattleScene.scene->scenePhase++;
            break;
        ...
        case 1:
            BattleScene_ApplyActionCameraMode(arg0, 1);
            if (D_84390204->presentationPhase == (sp18->phaseThreshold + 1)) {
                Battle_WriteBackRuntimeState(D_84390204);
            }

            if (D_84390204->presentationPhase >= (sp18->phaseThreshold + 0xA)) {
                D_84390220 = BattleScene_AnimateDisplayedHpToRuntime(D_84390010[gBattleScene.scene->activeBattlerIndex]);
                D_84390224 = BattleScene_AnimateDisplayedHpToRuntime(D_84390010[!gBattleScene.scene->activeBattlerIndex]);
            }

            if ((D_84390204->presentationPhase == (sp18->phaseThreshold + 0x12)) && (sp1C->currentMoveId == 0x64)) {
                BattleBox_Open(0xF);
            }
        ...
        case 2:
            ...
            if ((D_84390220 == 1) && (D_84390224 == 1) && (BattleScene_AdvanceCameraFrameCounter(0xF) != 0)) {
                if ((D_84390200->unk_654.monRuntime.currentMoveId & 0xF0) == 0xF0) {
                    gBattleScene.scene->simultaneousActionFlag = 3;
                }
                BattleScene_ResetCameraFrameCounter();
                BattleScene_ResetAnimationStep();
...
void BattleScene_Phase30(unk_D_86002F34_00C* arg0) {
    BattleMonRuntime* sp1C = &D_84390200->unk_654.monRuntime;
    ...
    switch (gBattleScene.scene->scenePhase) {
        ...
        case 3:
            if (BattleScene_AdvanceOwnerAnimationAndClearFlags(D_84390200) == 0) {
                BattleScene_ReframeAndRecomputeDistance(arg0, D_84390200);
                if (gBattleScene.scene->unk_14 == 0) {
                    BattleBox_Open(1);
                }
                D_84390220 = BattleScene_AnimateDisplayedHpToRuntime(D_84390010[gBattleScene.scene->activeBattlerIndex]);
                D_84390224 = BattleScene_AnimateDisplayedHpToRuntime(D_84390010[!gBattleScene.scene->activeBattlerIndex]);
...
void BattleScene_Phase15(unk_D_86002F34_00C* arg0) {
    UNUSED s32 pad[3];
    BattleMonRuntime* sp30 = &D_84390204->unk_654.monRuntime;
    BattleMonRuntime* sp2C = &D_84390200->unk_654.monRuntime;
    ...
    switch (gBattleScene.scene->scenePhase) {
        case 0:
            ...
            if (sp30->volatileStatusFlags & 0x10) {
                if (sp2C->auxStatusFlags & 8) {
                    sp28->cachedModelId = D_84390204->sessionTeams->iconSpeciesId = sp24->unk_BE;
                } else if (D_84390200->sessionTeams->iconSpeciesId == 0x98) {
                    sp28->cachedModelId = D_84390204->sessionTeams->iconSpeciesId = sp2C->speciesId;
                } else {
                    sp28->cachedModelId = D_84390204->sessionTeams->iconSpeciesId = D_84390200->sessionTeams->iconSpeciesId;
                }
            } else if (sp2C->auxStatusFlags & 8) {
                D_84390204->sessionTeams->iconSpeciesId = sp24->unk_BE;
            } else if (D_84390200->sessionTeams->iconSpeciesId == 0x98) {
                D_84390204->sessionTeams->iconSpeciesId = sp2C->speciesId;
            } else {
                D_84390204->sessionTeams->iconSpeciesId = D_84390200->sessionTeams->iconSpeciesId;
            }
            D_84390204->sessionTeams->activeMon = &D_84390204->ownRoster->party[D_84390204->unk_654.partyIndex];
            D_84390204->sessionTeams->modelLoadFlags |= 0x80;
            gBattleScene.scene->scenePhase += 1;
            break;

        case 1:
            BattleScene_RecenterCameraOnOwner(arg0, D_84390204);
            if (D_84390204->sessionTeams->modelLoadFlags & 0x10) {
                D_84390204->sessionTeams->modelLoadFlags &= ~0x90;
                Battle_LoadOwnerModelForSpecies(D_84390204);
                BattleScene_TickOwnerCameraFraming(D_84390204);
                BattleAnim_PlayMoveEffectScriptA(D_84390204, sp30->currentMoveId);
        ...
        case 3:
            BattleScene_RecenterCameraOnOwner(arg0, D_84390204);
            D_84390204->presentation.layout->unk_00.unk_01 |= 1;
            D_84390204->presentation.model.unk_000.unk_01 |= 1;
...
void BattleScene_Phase25(unk_D_86002F34_00C* arg0) {
    ...
    switch (gBattleScene.scene->scenePhase) {
        case 0:
            BattleScene_SaveCameraFov(arg0);
            BattleAnim_PlayMoveEffectScriptA(D_84390204, sp1C->currentMoveId);
            BattleScene_SelectActionCameraPresetFromTiming(arg0, 0);
            if (!(sp18->battleStateFlags & 0x800)) {
...
s32 BattleScene_EndStatusAnimationsAndCommit(Battler* arg0) {
    ...
    BattleAnim_EndSleepStatusAnimation(arg0);
    Battle_WriteBackRuntimeState(arg0);
}
...
void BattleScene_Phase29(unk_D_86002F34_00C* arg0) {
    switch (gBattleScene.scene->scenePhase) {
        ...
        case 2:
            ...
            Vec3f_SetComponentsDuplicate(&D_84390204->model.unk_030, 1.0f, 1.0f, 1.0f);
            Vec3f_SetComponentsDuplicate(&D_84390200->model.unk_030, 1.0f, 1.0f, 1.0f);
            BattleScene_ResetCameraFrameCounter();
            BattleScene_ResetAnimationStep();
            BattleScene_WaitForDisplayedHpAnimations(arg0);
            break;
...
void BattleScene_Phase12(unk_D_86002F34_00C* arg0) {
    MovePresentationCue* sp4C = &D_84384570[gBattleScene.scene->activeBattlerIndex]->unk_B00;
    UNUSED s32 pad;
    Vec3f sp3C;
    ...
    switch (gBattleScene.scene->scenePhase) {
        ...
        case 1:
            if (D_84390204->model.unk_024.y >= 100.0f) {
                ...
                BattleScene_SetCameraEyeFromPosition(arg0, sp3C, 0x11C6, BattleScene_GetParticipantFacingAngle(D_84390204) - (D_84390204->yawBase * 0x754E),
                ...
                BattleAnim_CleanupEffects(2);
                ModelAnim_SetAnimation(&D_84390204->model, sp4C->animationId);
                arg0->unk_24.fovy = 60.0f;
                gBattleScene.scene->scenePhase += 1;
            } else {
                BattleScene_ApproachCameraTargetFromOwner(arg0, D_84390204);
        ...
        case 2:
            ...
            if (D_84390204->model.unk_024.y >= 200.0f) {
                gBattleScene.scene->scenePhase += 1;
            }
            break;
        ...
        case 3:
            ...
            if ((D_84390220 == 1) && (D_84390224 == 1) && (BattleScene_AdvanceCameraFrameCounterUntil(0x1E) != 0)) {
                Battle_SetRuntimeFlags(D_84390010[gBattleScene.scene->activeBattlerIndex], 4);
...
void BattleScene_Phase13(unk_D_86002F34_00C* arg0) {
    ...
    switch (gBattleScene.scene->scenePhase) {
        ...
        case 1:
            if (D_84390204->presentationSubStateArg == 2) {
                BattleScene_UpdateCameraVerticalFraming(arg0, D_84390204);
                D_84390204->model.unk_000.unk_02 &= 0xFFBF;
            }

            if ((D_84390204->model.modelId == 0x32) || (D_84390204->model.modelId == 0x33)) {
                if (BattleScene_IsRowWaitComplete(D_84390204, 0x1E) != 0) {
                    BattleBox_Close();
                    Battle_SetRuntimeFlags(D_84390204, 0x4000);
                    D_84390204->model.unk_000.unk_02 &= 0xFFDF;
                    gBattleScene.scene->scenePhase += 1;
                }
            } else if (BattleAnim_IsAssetLoadBusy(D_84390204) == 0) {
                if (BattleScene_ByteArrayContains(D_84390204->model.modelId, (u8*)&sp24, 2) != 0) {
                    sp28 = 10.0f;
                } else {
                    sp28 = 3.5f;
                }

                if (D_84390204->model.unk_024.y <= (-BattleAnim_GetOwnerModelHeight(D_84390204) * sp28)) {
                    Battle_SetRuntimeFlags(D_84390204, 0x4000);
                    D_84390204->model.unk_000.unk_02 &= 0xFFDF;
                    gBattleScene.scene->scenePhase += 1;
                }
        ...
        case 2:
            if ((D_84390204->model.modelId != 0x32) && (D_84390204->model.modelId != 0x33)) {
                D_84390204->model.unk_000.unk_02 |= 0x40;
            }
            BattleScene_UpdateCameraVerticalFraming(arg0, D_84390204);
            D_84390220 = BattleScene_AnimateDisplayedHpToRuntime(D_84390010[gBattleScene.scene->activeBattlerIndex]);
            D_84390224 = BattleScene_AnimateDisplayedHpToRuntime(D_84390010[!gBattleScene.scene->activeBattlerIndex]);
...
void BattleScene_Phase31(unk_D_86002F34_00C* arg0) {
    switch (gBattleScene.scene->scenePhase) {
        case 0:
            BattleScene_SaveCameraFov(arg0);
            Battle_WriteBackRuntimeState(D_84390204);
            D_84390204->runtimeStateWritten = 1;
            BattleScene_ResetCameraFrameCounter();
            gBattleScene.scene->scenePhase += 1;
            break;
    ...
    switch (gBattleScene.scene->scenePhase) {
        ...
        case 1:
            if (BattleScene_AdvanceOwnerAnimation98(D_84390204) == 0) {
                ...
                BattleScene_SetDamageShakeAmplitude(D_84390204);
                BattleScene_ResetAnimationStep();
                ModelAnim_SetAnimation(&D_84390204->model, sp1C->animationId);
                gBattleScene.scene->scenePhase += 1;
            }
            break;
    ...
    switch (gBattleScene.scene->scenePhase) {
        case 0:
            if (BattleScene_AdvanceOwnerAnimation98(D_84390200) == 0) {
                ...
                if (sp1C->battleStateFlags & 0x200) {
                    BattleScene_SelectCameraShot(D_84390200, arg0, D_84390228 = 2);
                } else {
                    if (D_84390200->model.modelId == 0xF) {
                        BattleScene_SelectCameraShot(D_84390200, arg0, 0);
                    }
        ...
        case 1:
            if ((D_84390200->model.modelId == 0xF) && !(sp1C->battleStateFlags & 0x200)) {
                BattleScene_FrameCamera(arg0, D_84390200);
            }
...
void BattleScene_PhaseAttackHit(unk_D_86002F34_00C* arg0) {
    BattleMonRuntime* sp24 = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654.monRuntime;
    BattleMonRuntime* sp20 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654.monRuntime;

    switch (gBattleScene.scene->scenePhase) {
        case 0:
            Battle_ResetCryEventIfStruggle(D_84390204);
            BattleScene_SetCameraOwnerStandardShot(arg0, D_84390010[gBattleScene.scene->activeBattlerIndex]);
            BattleScene_ResetAnimationStep();
            BattleScene_CleanupParticipantEffectMode(D_84390204);
            BattleAnim_CleanupEffects(2);
            gBattleScene.scene->scenePhase += 1;
        ...
        case 1:
            if (BattleScene_AdvanceOwnerAnimation(D_84390010[gBattleScene.scene->activeBattlerIndex]) == 0) {
                ...
                BattleAnim_CleanupEffects(1);
                BattleScene_SetCameraOwnerStandardShot(arg0, D_84390010[gBattleScene.scene->activeBattlerIndex]);
                BattleScene_EnterStateRow(D_84390010[gBattleScene.scene->activeBattlerIndex], 0xD);

                if (sp24->status & 0x18) {
                    BattleBox_Open(4);
                    sp24->currentHP = sp24->poisonBurnPendingHP;
                    sp20->currentHP = sp20->poisonBurnPendingHP;
                    if (sp24->status & 0x10) {
                    ...
                    sp24->currentHP = sp24->leechSeedPendingHP;
                    sp20->currentHP = sp20->leechSeedPendingHP;
                    BattleAnim_QueueEffectList(0xA, D_84390204);
                    BattleScene_ResetCameraFrameCounter();
                    gBattleScene.scene->scenePhase = 3;
                }
            }
            break;
        ...
        case 2:
            ...
            if ((D_84390220 == 1) && (D_84390224 == 1) && (BattleScene_AdvanceCameraFrameCounterUntil(0x32) != 0)) {
                ...
                if (Battle_GetActiveMonHp(D_84390010[gBattleScene.scene->activeBattlerIndex]) == 0) {
                    ...
                    BattleScene_SetPhase(arg0, 5);
                    gBattleScene.scene->activeBattlerIndex = !gBattleScene.scene->activeBattlerIndex;
                } else if (sp24->volatileStatusFlags & 0x80) {
                    BattleScene_ResetCameraFrameCounter();
                    Audio_PlayCommand(0x22, 0, 0);
                    sp24->currentHP = sp24->leechSeedPendingHP;
                    sp20->currentHP = sp20->leechSeedPendingHP;
                    ...
                    gBattleScene.scene->scenePhase = 4;
                }
            }
            break;
...
void BattleScene_PhaseDrainDamage(unk_D_86002F34_00C* arg0) {
    ...
    switch (gBattleScene.scene->scenePhase) {
        case 0:
            BattleScene_CleanupParticipantEffectMode(D_84390204);
            BattleAnim_CleanupEffects(2);
            BattleScene_SetCameraOwnerWideShot(arg0, D_84390010[gBattleScene.scene->activeBattlerIndex]);
            gBattleScene.scene->scenePhase += 1;
            break;
        ...
        case 1:
            if (BattleScene_AdvanceOwnerAnimation(D_84390010[gBattleScene.scene->activeBattlerIndex]) == 0) {
                ...
                BattleScene_ResetCameraFrameCounter();
                BattleScene_SetCameraOwnerWideShot(arg0, D_84390010[gBattleScene.scene->activeBattlerIndex]);
                sp1C->currentHP = sp1C->recoilPendingHP;
                sp18->currentHP = sp18->recoilPendingHP;
                BattleBox_Open(6);
                gBattleScene.scene->scenePhase += 1;
            }
            break;
        ...
        case 2:
            if (BattleScene_ApproachCloseCameraShot(arg0, D_84390010[gBattleScene.scene->activeBattlerIndex]) != 0) {
                BattleScene_SelectCameraShot(D_84390204, arg0, 3);
...
void BattleScene_PhaseCheckFaintedEndTurn(unk_D_86002F34_00C* arg0) {
    ...
    switch (gBattleScene.scene->scenePhase) {
        ...
        case 1:
            ...
            Audio_FadeAndClearStoredSounds();
            BattleAnim_CleanupEffects(1);
            BattleScene_CameraShotTargetClose(arg0, D_84390010[gBattleScene.scene->activeBattlerIndex]);
            BattleScene_EnterStateRow(D_84390010[gBattleScene.scene->activeBattlerIndex], 0xD);
            sp1C->currentHP = sp1C->poisonBurnPendingHP;
            sp18->currentHP = sp18->poisonBurnPendingHP;
            gBattleScene.scene->scenePhase += 1;
            break;
...
void BattleScene_PhaseWithdrawFainted(unk_D_86002F34_00C* arg0) {
    BattlerState* sp34 = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654;
    Battler* temp_s0 = D_84390010[gBattleScene.scene->activeBattlerIndex];
    BattleMonRuntime* sp2C = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654.monRuntime;

    if (gBattleScene.scene->activeBattlerIndex) {}
    ...
    switch (gBattleScene.scene->scenePhase) {
        ...
        case 2:
            ...
            if (BattleScene_AdvanceCameraFrameCounter(0x69) != 0) {
                Vec3f_SetComponentsDuplicate(&arg0->unk_60.at, temp_s0->yawBase * -150.0f, 0.0, 0.0f);
                if (gBattleScene.scene && gBattleScene.scene) {}
                Vec3f_SetComponentsDuplicate(&arg0->unk_60.eye, temp_s0->yawBase * -50.0f, 5.0f, 0.0f);
        ...
        case 3:
            if (temp_s0->secondaryModel.unk_024.y == 2.5f) {
                temp_s0->secondaryModel.unk_000.unk_02 |= 0x20;
            }

            if (ModelAnim_IsAnimationDone(&temp_s0->secondaryModel) == 1) {
                gBattleScene.scene->scenePhase += 1;
            }
            break;

        case 4:
            temp_s0->secondaryModel.unk_000.unk_01 &= ~1;
            temp_s0->sessionTeams->activeMon = &temp_s0->sessionTeams->teams[sp34->sideIndex]->party[sp34->selectedPartyIndex];
            temp_s0->sessionTeams->modelLoadFlags |= 0x80;
            gBattleScene.scene->scenePhase += 1;
            break;

        case 5:
            if (temp_s0->sessionTeams->modelLoadFlags & 0x10) {
                temp_s0->sessionTeams->modelLoadFlags &= ~0x90;
                Battle_LoadOwnerModelForSwitchIn(temp_s0);
                BattleScene_TickOwnerCameraFraming(temp_s0);
                D_843900A8[gBattleScene.scene->activeBattlerIndex] = temp_s0->unk_654.monRuntime.currentHP;
                BattleAnim_QueueEffectList3(3, temp_s0, temp_s0, 0xFF, 0xFF);
                Audio_PlayCommand(2, 0, 0);
                BattleScene_RebindParticipantToSide(temp_s0, sp34->sideIndex);
        ...
        case 7:
            ...
            if (BattleScene_IsRowWaitCompleteWithEventCount(temp_s0, 0x3C) != 0) {
                ...
                BattleAnim_CleanupEffects(2);
                BattleScene_ResetCameraFrameCounter();
                Vec3f_SetComponentsDuplicate(&temp_s0->model.unk_030, 1.0f, 1.0f, 1.0f);
                if (sp2C->currentMoveId == 0xFE) {
                    sp2C->currentMoveId = 0xA5;
                }
                BattleScene_CleanupActionAndAdvance();
                sp34->battleStateFlags &= ~0x1800;
                BattleBox_Close();
                gBattleScene.scene->unk_54 = !gBattleScene.scene->activeBattlerIndex + 1;
            }
            break;
    }
}
...
void BattleScene_PhaseWithdrawSwitch(unk_D_86002F34_00C* arg0) {
    BattlerState* sp3C = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654;
    BattlerState* sp38 = &D_84390010[!gBattleScene.scene->activeBattlerIndex]->unk_654;
    UNUSED s32 pad;
    Battler* temp_s0 = D_84390010[gBattleScene.scene->activeBattlerIndex];
    BattleMonRuntime* sp2C = &D_84390010[gBattleScene.scene->activeBattlerIndex]->unk_654.monRuntime;
    ...
    switch (gBattleScene.scene->scenePhase) {
        case 0:
            if (gBattleScene.scene->simultaneousActionFlag == 1) {
                ...
                BattleScene_ResetCameraFrameCounter();
                BattleBox_Open(0xB);
                BattleAnim_LoadModeResourceList(temp_s0->sessionTeams, 3);
                Vec3f_SetComponentsDuplicate(&arg0->unk_60.at, temp_s0->yawBase * -150.0f, 0.0, 0.0f);
                Vec3f_SetComponentsDuplicate(&arg0->unk_60.eye, temp_s0->yawBase * -50.0f, 5.0f, 0.0f);
                Vec3f_SetComponentsDuplicate(&temp_s0->model.unk_024, temp_s0->yawBase * -150.0f, 25.0f, 0.0f);
                gBattleScene.scene->scenePhase += 1;
            } else {
                BattleAnim_ApproachF(&arg0->unk_24.fovy, 30.0f, 0.05f);
        ...
        case 1:
            if (BattleAnim_TryRegisterAssetTables(temp_s0) != 0) {
                temp_s0->sessionTeams->iconSpeciesId = sp2C->speciesId;
                BattleScene_SetParticipantModelFlags(temp_s0, 2, 0);
                BattleAnim_QueueEffectList3(0xD, temp_s0, temp_s0, 0xFF, 0xFF);
                gBattleScene.scene->scenePhase += 1;
            }
        ...
        case 3:
            temp_s0->secondaryModel.unk_000.unk_01 &= ~1;
            temp_s0->sessionTeams->modelLoadFlags |= 0x80;
            temp_s0->sessionTeams->activeMon = &temp_s0->sessionTeams->teams[sp3C->sideIndex]->party[sp3C->selectedPartyIndex];
            gBattleScene.scene->scenePhase += 1;
            break;
        ...
        case 4:
            if (temp_s0->sessionTeams->modelLoadFlags & 0x10) {
                ...
                Battle_LoadOwnerModelForSwitchIn(temp_s0);
                BattleScene_TickOwnerCameraFraming(temp_s0);
                D_843900A8[BattleScene_GetParticipantSideIndex(temp_s0)] = temp_s0->unk_654.monRuntime.currentHP;
                Audio_PlayCommand(2, 0, 0);
                BattleScene_RebindParticipantToSide(temp_s0, sp3C->sideIndex);
                BattleScene_ResetCameraFrameCounter();
                BattleAnim_QueueEffectList3(3, temp_s0, temp_s0, 0xFF, 0xFF);
                arg0->unk_24.fovy = 40.0f;
                Battle_TriggerTrainerPresentationCue(temp_s0);
        ...
        case 6:
            BattleScene_ReframeAndRecomputeDistanceForSwitch(arg0, temp_s0);
            if (BattleScene_IsRowWaitCompleteWithEventCount(temp_s0, 0x3C) != 0) {
                if ((sp2C->currentMoveId & 0xF0) == 0xF0) {
                    sp2C->currentMoveId = 0xA5;
                }
                Audio_FadeAndClearStoredSounds();
                BattleAnim_CleanupEffects(2);
                BattleScene_ResetCameraFrameCounter();
                Vec3f_SetComponentsDuplicate(&temp_s0->model.unk_030, 1.0f, 1.0f, 1.0f);
                if (sp38->faintSequenceState != 0x10) {
                    gBattleScene.scene->simultaneousActionFlag = 3;
                }
                gBattleScene.scene->unk_2E = 2;
                BattleScene_CleanupActionAndAdvance();
                sp3C->battleStateFlags &= 0xE7FF;
                gBattleScene.scene->unk_54 = !gBattleScene.scene->activeBattlerIndex + 1;
            }
            break;
    }
