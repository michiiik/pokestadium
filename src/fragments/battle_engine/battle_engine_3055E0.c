...
s32 BattleScene_AdvanceCameraSubstepCounter(s32 arg0) {
    gBattleScene.scene->unk_10++;
    if (gBattleScene.scene->unk_10 >= arg0) {
...
s32 BattleScene_AdvanceCameraFrameCounter(s32 arg0) {
    ...
    if (gBattleScene.scene->unk_14 >= arg0) {
...
void BattleScene_SetActiveBattlerIndex(s32 arg0) {
    gBattleScene.scene->activeBattlerIndex = arg0;
}
...
void BattleScene_GetOwnerCameraAnchor(Battler* arg0, Vec3f* arg1) {
    ...
    if (BattleScene_ByteArrayContains(arg0->model.modelId, sp18, 9) != 0) {
...
void BattleScene_GetOwnerBoneOrDefaultAnchor(Battler* arg0, Vec3f* arg1, s32 arg2) {
    if (GeoRender_FindAnchorPosition(&arg0->model, arg2, arg1) == NULL) {
...
void BattleScene_SetCameraModeAndStep(s32 arg0, s32 arg1) {
    gBattleScene.scene->unk_1C = arg0;
    gBattleScene.scene->scenePhase = arg1;
}
...
void BattleScene_SetCameraSubstate(s32 arg0, u16 arg1) {
    gBattleScene.scene->unk_30 = arg0;
    gBattleScene.scene->unk_2E = arg1;
}

void BattleScene_ApplyCameraPhaseDefaults(void) {
    if (gBattleScene.scene->unk_18 == 2) {
        if (gBattleScene.scene->unk_44 == 1) {
            BattleScene_SetCameraModeAndStep(1, 0x32);
        }

        if (gBattleScene.scene->unk_44 == 2) {
            gBattleScene.scene->activeBattlerIndex = gBattleScene.scene->unk_2A;
...
void BattleScene_SetDamageShakeAmplitude(Battler* arg0) {
    ...
    gBattleScene.scene->hpDamageShakeMagnitude = ((ptr->currentHP - arg0->unk_654.monRuntime.currentHP) / 996.0f) * 1400.0f;

    if (gBattleScene.scene->hpDamageShakeMagnitude == 0.0f) {
        gBattleScene.scene->hpDamageShakeMagnitude = 0.0f;
    } else if (gBattleScene.scene->hpDamageShakeMagnitude <= 20.0f) {
        gBattleScene.scene->hpDamageShakeMagnitude = 20.0f;
    } else if (gBattleScene.scene->hpDamageShakeMagnitude >= 50.0f) {
        gBattleScene.scene->hpDamageShakeMagnitude = 50.0f;
    }

    gBattleScene.scene->shakeAngle = 0;

    if (D_84390288 != 0) {
        gBattleScene.scene->hpDamageShakeMagnitude = 25.0f;
    }
}
...
void BattleScene_ApplyCameraShake(unk_D_86002F34_00C* arg0) {
    ...
    gBattleScene.scene->shakeAngle += 0x38E0;
    BattleAnim_ApproachF(&gBattleScene.scene->hpDamageShakeMagnitude, 0.0f, 0.18f);

    temp_fv0 = COSS(gBattleScene.scene->shakeAngle) * gBattleScene.scene->hpDamageShakeMagnitude;
...
void BattleScene_StartCameraShake(UNUSED Battler* arg0) {
    gBattleScene.scene->hpDamageShakeMagnitude = 30.0f;
    gBattleScene.scene->shakeAngle = 0;
}
...
s32 BattleScene_ApproachCameraRoll(unk_D_86002F34_00C* arg0, s16 arg1, s16 arg2) {
    if (arg1 > 0) {
        gBattleScene.scene->cameraRoll -= arg1;
        if ((gBattleScene.scene->cameraRoll < arg2) && ((arg2 - arg1) < gBattleScene.scene->cameraRoll)) {
            gBattleScene.scene->cameraRoll = arg2;
            return 1;
        }
    } else {
        gBattleScene.scene->cameraRoll -= arg1;
        if ((arg2 < gBattleScene.scene->cameraRoll) && (gBattleScene.scene->cameraRoll < (arg2 - arg1))) {
            gBattleScene.scene->cameraRoll = arg2;
            return 1;
        }
    }

    Camera_ComputeEyeFromAngles(&arg0->unk_60.at, &arg0->unk_60.eye, gBattleScene.scene->cameraDistance, gBattleScene.scene->cameraYaw,
                  gBattleScene.scene->cameraRoll);
    return 0;
}
...
s32 BattleScene_ApproachCameraRollNoEyeUpdate(UNUSED unk_D_86002F34_00C* arg0, s16 arg1, s16 arg2) {
    ...
    } else if ((gBattleScene.scene->cameraRoll >= arg2) && ((arg2 - arg1) >= gBattleScene.scene->cameraRoll)) {
        gBattleScene.scene->cameraRoll = arg2;
        return 1;
    }
    return 0;
...
void BattleScene_SetCameraAnglesAndDistance(s16 arg0, s16 arg1, f32 arg2) {
    gBattleScene.scene->cameraYaw = arg0;
    gBattleScene.scene->cameraRoll = arg1;
    gBattleScene.scene->cameraDistance = arg2;
}
...
void BattleScene_SetCameraSendOutShot(unk_D_86002F34_00C* arg0, s32 arg1) {
    ...
    sp58.y /= 3.0f;
    if (temp_s0->unk_654.battleStateFlags & 0x4000) {
        sp58.y = 0.0f;
    }

    BattleScene_SetCameraAtFromAnchor(temp_s0, arg0, sp58, 0, 0, 0.0f, 0.0f);

    if ((sp6C->faintSequenceState != 0x10) && !(sp6C->battleStateFlags & 0x4000)) {
        BattleScene_EnterStateRow(temp_s0, 1);
    }

    temp_s0 = D_84390010[arg1];
    if (temp_s0->sway.layoutConfig.secondaryAmplitude.x == 0.0f) {
        BattleAnim_GetOwnerDefaultAnchorPosition(temp_s0, &sp58);
    } else {
        BattleAnim_Vec3fCopy(&sp58, &temp_s0->sway.layoutConfig.secondaryAmplitude);
        sp58.y += temp_s0->model.unk_024.y - BattleScene_GetParticipantModelHeight(temp_s0);
    }

    sp54 = BattleScene_ScaleCameraDistance(temp_s0, 3.0f, 300.0f);
    if ((BattleScene_ByteArrayContains(temp_s0->model.modelId, &sp50, 1) != 0) && (arg1 == 1)) {
        BattleScene_SetCameraEyeFromPosition(arg0, sp58, 0, BattleScene_GetParticipantFacingAngle(temp_s0) - (temp_s0->yawBase * 0x6AA4), sp54, 20.0f);
    } else if (BattleScene_ByteArrayContains(temp_s0->model.modelId, (u8*)&sp4C, 2) != 0) {
        BattleScene_SetCameraEyeFromPosition(arg0, sp58, 0, BattleScene_GetParticipantFacingAngle(temp_s0) - (temp_s0->yawBase * 0x6AA4), sp54, 20.0f);
    } else {
        BattleScene_SetCameraEyeFromPosition(arg0, sp58, 0, BattleScene_GetParticipantFacingAngle(temp_s0) - (temp_s0->yawBase * 0x754E), sp54, 0.0f);
    }
}
...
void BattleScene_UpdateCameraModelOffset(Battler* arg0, unk_D_86002F34_00C* arg1) {
    SwayState* sp38 = &arg0->sway;
    UNUSED s32 pad[5];
    f32 sp3C = 0.0f;

    if (BattleScene_ByteArrayContains(arg0->model.modelId, &D_843845F0, 1) != 0) {
        sp3C = BattleAnim_GetOwnerModelHeight(arg0) / 1.5f;
    } else if (BattleScene_ByteArrayContains(arg0->model.modelId, &D_843845F4, 1) != 0) {
        sp3C = BattleAnim_GetOwnerModelHeight(arg0) * 0.5f;
    } else if ((BattleScene_ByteArrayContains(arg0->model.modelId, &D_843845F8, 1) != 0) && (arg0->unk_654.battleStateFlags & 0x200)) {
        sp3C = 2.0f * BattleAnim_GetOwnerModelHeight(arg0);
    } else if ((BattleScene_ByteArrayContains(arg0->model.modelId, D_843845FC, 2) != 0) && (arg0->unk_654.battleStateFlags & 0x200)) {
        sp3C = BattleAnim_GetOwnerModelHeight(arg0) * 1.5f;
    }

    Vec3f_SetComponentsDuplicate(&arg0->sway.anchorPosition, arg0->sway.layoutConfig.primaryAmplitude.x, arg0->sway.layoutConfig.primaryAmplitude.y,
                  arg0->sway.layoutConfig.primaryAmplitude.z);
    arg0->sway.anchorPosition.y = (arg0->model.unk_024.y - BattleScene_GetParticipantModelHeight(arg0)) + arg0->sway.anchorPosition.y + sp3C;
    BattleAnim_Vec3fCopy(&gBattleScene.scene->unk_B8, &arg1->unk_60.at);
    BattleAnim_Vec3fCopy(&gBattleScene.scene->unk_C4, &arg1->unk_60.eye);
    Vec3f_CalculateDistanceAngles(&gBattleScene.scene->unk_B8, &gBattleScene.scene->unk_C4, &gBattleScene.scene->unk_70, &sp38->cameraYaw,
                  &sp38->cameraPitch);
    Vec3f_CalculateDistanceAngles(&arg0->sway.anchorPosition, &arg1->unk_60.at, &sp38->cameraDistance, &sp38->cameraYaw, &sp38->cameraPitch);
    gBattleScene.scene->unk_6C = 0.0f;
    gBattleScene.scene->unk_74 = 0.0f;
}

void BattleScene_ClearCameraOffsetVectors(void) {
    Vec3f_SetComponentsDuplicate(&gBattleScene.scene->unk_94, 0.0f, 0.0f, 0.0f);
    Vec3f_SetComponentsDuplicate(&gBattleScene.scene->unk_A0, 0.0f, 0.0f, 0.0f);
}
...
void BattleScene_ApplyOwnerFramingAdjustments(unk_D_86002F34_00C* arg0, Battler* arg1, UNUSED f32 arg2) {
    ...
    Vec3f_CalculateDistanceAngles(&sp64, &arg1->sway.anchorPosition, &sp3C, &sp36, &sp34);

    switch (arg1->model.modelId) {
        case 0x5F:
        ...
        case 0x82:
            ...
            if (sp3C < (BattleScene_GetParticipantModelRadius(arg1) * 0.5f)) {
                BattleAnim_Vec3fCopy(&sp64, &arg1->sway.anchorPosition);
            }
            break;
    ...
    sp64.y = arg1->sway.anchorPosition.y;
    Camera_ComputeEyeFromAngles(&sp64, &sp58, sp2C->cameraDistance, sp2C->cameraYaw, sp2C->cameraPitch);
    sp4C.y = sp58.y;
    ...
    if (arg1->presentationSubState == 0xD) {
        var_fv1 = 0;
    } else if ((arg1->model.modelId == 0x58) || (arg1->model.modelId == 0x59)) {
        temp_fv1 = sp3C / BattleScene_GetParticipantModelRadius(arg1);
        if (temp_fv1 <= 0.05f) {
...
void BattleScene_RecomputeCameraDistance(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    Vec3f_CalculateDistanceAngles(&gBattleScene.scene->unk_B8, &gBattleScene.scene->unk_C4, &sp38, &sp36, &sp34);
    Vec3f_CalculateDistanceAngles(&arg0->unk_60.at, &arg0->unk_60.eye, &sp44, &sp3E, &sp3C);

    temp_lo = sp34 / 182;
    if ((temp_lo == 0x5A) || (temp_lo == -0x5A)) {
        if (BattleScene_ByteArrayContains(arg1->model.modelId, sp2C, sizeof(sp2C)) != 0) {
            sp44 = sp38;
        } else {
            sp44 = Math_StepToF(sp44, sp38, 30.0f, 5.0f);
        }
    } else {
        var_fv0_2 = gBattleScene.scene->unk_70 - sp44;
        if (var_fv0_2 < 0.0f) {
            var_fv0_2 *= -1.0f;
        }

        if (sp44 < sp38) {
            sp44 = Math_StepToF(sp44, gBattleScene.scene->unk_70, var_fv0_2 * 0.4f, var_fv0_2 * 0.08f);
        }
    }
...
void BattleScene_UpdateCameraTargetFromOwner(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    Vec3f_CalculateDistanceAngles(&sp54, &arg1->sway.anchorPosition, &sp38, &sp32, &sp30);

    if (sp38 < (BattleScene_GetParticipantModelRadius(arg1) * 1.1f)) {
        BattleAnim_Vec3fCopy(&sp54, &arg1->sway.anchorPosition);
    }

    Camera_ComputeEyeFromAngles(&sp54, &sp48, ptr->cameraDistance, ptr->cameraYaw, ptr->cameraPitch);
...
s32 BattleScene_FrameCamera(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    temp_v1 = &D_84390010[BattleScene_GetParticipantSideIndex(arg1) == 0]->unk_654.monRuntime;

    if (arg1->unk_654.battleStateFlags & 0x4000) {
        return 1;
    }

    if (temp_v1->currentMoveId == 0x53) {
    ...
    if ((arg1->model.modelId != 0x5F) && (arg1->presentationSubState != 0xD)) {
    ...
    BattleAnim_ApproachF(&gBattleScene.scene->unk_94.z, 0.2f, 0.03f);
    BattleAnim_StepToS16VariableRate(&sp52, sp50, gBattleScene.scene->unk_94.z);
    BattleAnim_StepToS16VariableRate(&sp4E, sp4C, gBattleScene.scene->unk_94.z);
...
void BattleScene_ApproachCameraTargetFromOwner(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    Camera_ComputeEyeFromAngles(&sp58, &sp4C, ptr->cameraDistance, ptr->cameraYaw, ptr->cameraPitch);
    Vec3f_CalculateDistanceAngles(&sp34, &sp4C, &sp30, &sp2A, &sp28);
    gBattleScene.scene->unk_94.z = Math_StepToF(gBattleScene.scene->unk_94.z, 0.8f, 0.05f, 0.05f);
    Camera_ComputeEyeFromAngles(&sp34, &arg0->unk_60.at, gBattleScene.scene->unk_94.z * sp30, sp2A, sp28);
}
...
void BattleScene_UpdateCameraVerticalFraming(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    Camera_ComputeEyeFromAngles(&sp60, &sp54, ptr->cameraDistance, ptr->cameraYaw, ptr->cameraPitch);
...
void BattleScene_ApproachCameraTarget(unk_D_86002F34_00C* arg0, Battler* arg1, UNUSED s32 arg2) {
    ...
    Camera_ComputeEyeFromAngles(&sp50, &sp44, ptr->cameraDistance, ptr->cameraYaw, ptr->cameraPitch);
...
s32 BattleScene_AnimateCameraPreset(unk_D_86002F34_00C* arg0, Battler* arg1, s32 arg2, s32 arg3) {
    ...
    BattleAnim_ApproachF(&gBattleScene.scene->unk_94.z, D_843901B0.unk_34, D_843901B0.unk_38);
    ...
    Camera_ComputeEyeFromAngles(&sp48, &arg0->unk_60.eye, gBattleScene.scene->unk_94.z * sp38, sp32, sp30);
    ...
    Camera_ComputeEyeFromAngles(&sp60, &arg0->unk_60.at, gBattleScene.scene->unk_94.z * sp34, sp32, sp30);
...
s32 BattleScene_AnimateCameraPresetToOwner(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    Camera_ComputeEyeFromAngles(&sp54, &arg0->unk_60.eye, gBattleScene.scene->unk_94.z * sp40, sp36, sp34);
    BattleScene_GetOwnerCameraAnchor(arg1, &sp6C);
    Vec3f_CalculateDistanceAngles(&D_843901B0.unk_00, &sp6C, &sp44, &sp36, &sp34);
    ...
    Camera_ComputeEyeFromAngles(&sp6C, &arg0->unk_60.at, gBattleScene.scene->unk_94.z * sp3C, sp36, sp34);
...
void BattleScene_LoadCameraPreset(unk_D_86B0C160* arg0, unk_D_86002F34_00C* arg1, Battler* arg2) {
    ...
    BattleScene_SetCameraPresetAtAngles(arg0->unk_00, sp20 - (arg0->unk_02 * arg2->yawBase), arg0->unk_14,
                  BattleScene_GetParticipantFacingAngle(arg2) - (arg0->unk_16 * arg2->yawBase));
    BattleScene_SetCameraPresetAtDistances(sp34, sp30);
    sp20 = BattleScene_GetParticipantFacingAngle(arg2);
    BattleScene_SetCameraPresetEyeAngles(arg0->unk_06, sp20 - (arg0->unk_08 * arg2->yawBase), arg0->unk_1A,
                  BattleScene_GetParticipantFacingAngle(arg2) - (arg0->unk_1C * arg2->yawBase));
...
s32 BattleScene_AnimateCameraIntro(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    BattleAnim_ApproachF(&arg0->unk_24.fovy, 30.0f, 0.06f);
    Vec3f_SetComponentsDuplicate(&sp64, arg1->yawBase * -150.0f, 5.0f, 0.0f);
    BattleAnim_ApproachF(&gBattleScene.scene->unk_94.z, 0.2f, 0.06f);
    ...
    Camera_ComputeEyeFromAngles(&sp40, &arg0->unk_60.eye, gBattleScene.scene->unk_94.z * sp30, sp2A, sp28);
    ...
    if (sp30 >= 1.0f) {
        Camera_ComputeEyeFromAngles(&sp58, &arg0->unk_60.at, gBattleScene.scene->unk_94.z * sp30, sp2A, sp28);
        return 0;
    }
    return 1;
}
...
void BattleScene_SetCameraBattlerHeightShot(unk_D_86002F34_00C* arg0, s32 arg1) {
    ...
    BattleScene_SetCameraEyeFromPosition(arg0, sp60, 0, sp40->yawBase << 0xE, 100.0f, 0.0f);
...
s32 BattleScene_ApproachCameraBattlerHeightShot(unk_D_86002F34_00C* arg0, s32 arg1) {
    ...
    BattleAnim_ApproachF(&gBattleScene.scene->unk_94.z, 0.1f, 0.05f);
    ...
    Camera_ComputeEyeFromAngles(&sp58, &arg0->unk_60.at, gBattleScene.scene->unk_94.z * sp30, sp2E, sp2C);
...
void BattleScene_SetCameraOwnerShot(unk_D_86002F34_00C* arg0, Battler* arg1) {
    BattleAnim_GetOwnerDefaultAnchorPosition(arg1, &gBattleScene.scene->unk_D0);

    gBattleScene.scene->unk_D0.x = BattleScene_GetParticipantModelXOffset(arg1);
    gBattleScene.scene->unk_D0.z = 0.0f;

    if (arg1->unk_654.monRuntime.cachedMove.moveId == 0x6E) {
        D_843901F0 = BattleScene_ScaleCameraDistance(arg1, 4.5f, 300.0f);
        if (D_843901F0 <= 100.0f) {
            D_843901F0 = 100.0f;
        }

        if (gBattleScene.scene->unk_D0.y < 20.0f) {
            gBattleScene.scene->unk_D0.y = 20.0f;
        }
    } else {
        D_843901F0 = BattleScene_ScaleCameraDistance(arg1, 3.5f, 300.0f);
    }

    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1), 0.0f, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1), D_843901F0, 0.0f);
}
...
void BattleScene_SetCameraOwnerWideShot(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1), 0.0f, 0.0f);
    BattleScene_SetCameraEyeFromAt(arg0, 0, arg1->yawBase << 0xE, sp3C, 0.0f);
}
...
void BattleScene_SetCameraPresetClose(unk_D_86002F34_00C* arg0, Battler* arg1, s32 arg2) {
    ...
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1), D_843901F0, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1) - (arg1->yawBase * 0x31C7), D_843901F4, 0.0f);
...
void BattleScene_SetCameraPresetAngledClose(unk_D_86002F34_00C* arg0, Battler* arg1, s32 arg2) {
    ...
    D_843901F4 = BattleScene_ScaleCameraDistance(arg1, 5.0f, 300.0f);
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1), D_843901F0, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0x71C, BattleScene_GetParticipantFacingAngle(arg1) - (arg1->yawBase * 0x1555), D_843901F4,
                  0.0f);
    if (arg2 == 1) {
        BattleScene_UpdateCameraModelOffset(arg1, arg0);
    } else {
...
void BattleScene_SetCameraPresetOffsetClose(unk_D_86002F34_00C* arg0, Battler* arg1, s32 arg2) {
    ...
    D_843901F4 = BattleScene_ScaleCameraDistance(arg1, 5.0f, 300.0f);
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1), D_843901F0, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0xE38, BattleScene_GetParticipantFacingAngle(arg1), D_843901F4, 0.0f);
    if (arg2 == 1) {
        BattleScene_UpdateCameraModelOffset(arg1, arg0);
    } else {
        BattleScene_ReframeAndRecomputeDistance(arg0, arg1);
...
void BattleScene_SetCameraPresetLowClose(unk_D_86002F34_00C* arg0, Battler* arg1, s32 arg2) {
    ...
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0, sp3E - (arg1->yawBase * 0x1555), D_843901F4,
...
void BattleScene_CameraShotTargetStandard(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, arg1->yawBase << 0xE, 0.0f, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0, arg1->yawBase * 0xE38, D_843901F0, 0.0f);
    BattleScene_UpdateCameraModelOffset(arg1, arg0);
}
...
void BattleScene_CameraShotTargetAngled(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    D_843901F0 = BattleScene_ScaleCameraDistance(arg1, 5.0f, 400.0f);
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, arg1->yawBase << 0xE, 0.0f, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0x1555, arg1->yawBase * 0xE38, D_843901F0, 0.0f);
    BattleScene_UpdateCameraModelOffset(arg1, arg0);
}
...
void BattleScene_CameraShotTargetHigh(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    D_843901F0 = BattleScene_ScaleCameraDistance(arg1, 5.0f, 400.0f);
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, arg1->yawBase << 0xE, 0.0f, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0, arg1->yawBase * 0xE38, D_843901F0, 2.0f * BattleAnim_GetOwnerModelHeight(arg1));
    BattleScene_UpdateCameraModelOffset(arg1, arg0);
}
...
void BattleScene_CameraShotTargetLow(unk_D_86002F34_00C* arg0, Battler* arg1) {
    ...
    D_843901F0 = BattleScene_ScaleCameraDistance(arg1, 5.0f, 400.0f);
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, arg1->yawBase << 0xE, 0.0f, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0, arg1->yawBase * 0xE38, D_843901F0, -BattleAnim_GetOwnerModelHeight(arg1) * 0.8f);
...
void BattleScene_SetCameraFollowPresetNear(unk_D_86002F34_00C* arg0, Battler* arg1, s32 arg2) {
    ...
    BattleScene_SetCameraAtFromAnchor(arg1, arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1), D_843901F4, 0.0f);
    BattleScene_SetCameraEyeFromPosition(arg0, gBattleScene.scene->unk_D0, 0, BattleScene_GetParticipantFacingAngle(arg1) - (arg1->yawBase * 0x1555), D_843901F0, 0.0f);
    if (arg2 == 1) {
        BattleScene_UpdateCameraModelOffset(arg1, arg0);
    }
}
