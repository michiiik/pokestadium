...
BattleMon* BattleScene_GetParticipantSessionMon(Battler* arg0) {
    BattleMon* ptr = &arg0->sessionTeams->teams[arg0->unk_654.sideIndex]->party[arg0->unk_654.partyIndex];
...
s32 BattleScene_IsPartnerPikachu(Battler* arg0) {
    ...
    if ((arg0->model.modelId == 0x19) && (temp_v0->sourceAndFlags & 0x80)) {
        return 1;
    }
    return 0;
}
...
void BattleScene_PositionParticipantModel(Battler* arg0) {
    if (BattleScene_GetParticipantSideIndex(arg0) == 0) {
        if (arg0->model.modelId == 0x82) {
            Vec3f_SetComponentsDuplicate(&arg0->model.unk_024, -225.0f, BattleScene_GetParticipantModelHeight(arg0), 0.0f);
        } else if ((arg0->model.modelId == 3) || (arg0->model.modelId == 0x83)) {
            Vec3f_SetComponentsDuplicate(&arg0->model.unk_024, -175.0f, BattleScene_GetParticipantModelHeight(arg0), 0.0f);
        } else if (arg0->model.modelId == 0x5F) {
            Vec3f_SetComponentsDuplicate(&arg0->model.unk_024, -225.0f, BattleScene_GetParticipantModelHeight(arg0), 7.5000005f);
        } else {
            Vec3f_SetComponentsDuplicate(&arg0->model.unk_024, -150.0f, BattleScene_GetParticipantModelHeight(arg0), 0.0f);
        }
    } else if ((arg0->model.modelId == 0x82) || (arg0->model.modelId == 0x5F)) {
        Vec3f_SetComponentsDuplicate(&arg0->model.unk_024, 225.0f, BattleScene_GetParticipantModelHeight(arg0), 0.0f);
    } else if ((arg0->model.modelId == 3) || (arg0->model.modelId == 0x83)) {
        Vec3f_SetComponentsDuplicate(&arg0->model.unk_024, 175.0f, BattleScene_GetParticipantModelHeight(arg0), 0.0f);
    } else {
...
f32 BattleScene_GetParticipantModelXOffset(Battler* arg0) {
    if (BattleScene_GetParticipantSideIndex(arg0) == 0) {
        if ((arg0->model.modelId == 0x82) || (arg0->model.modelId == 0x5F)) {
            return -200.0f;
        }

        if ((arg0->model.modelId == 3) || (arg0->model.modelId == 0x83)) {
            return -175.0f;
        }
        return -150.0f;
    }
...
void BattleScene_SetParticipantModelScale(Battler* arg0, f32 arg1) {
    arg0->model.unk_030.x = arg1;
    arg0->model.unk_030.y = arg1;
    arg0->model.unk_030.z = arg1;
}

s32 BattleScene_GetSelectedSideTeamSize(Battler* arg0) {
    return arg0->sessionTeams->teams[arg0->unk_654.activeSideIndex]->partyCount;
}

s32 BattleScene_GetOpposingSelectedSideTeamSize(Battler* arg0) {
    s32 idx = arg0->unk_654.activeSideIndex == 0;

    return arg0->sessionTeams->teams[idx]->partyCount;
}
...
f32 Battle_GetScaledHeightY(Battler* arg0) {
    return ((BattleScene_GetParticipantModelWidth(arg0) * 2) / 50.0f) * arg0->model.unk_030.y;
}
...
s16 BattleScene_GetActiveAnimRowId(Battler* arg0) {
    return arg0->unk_654.monRuntime.currentMoveId;
}

void BattleScene_GetParticipantModelBoundsScaled(Battler* arg0, Vec3f* arg1) {
    arg1->x = ((BattleScene_GetParticipantModelRadius(arg0) * 2) / 50.0f) * arg0->model.unk_030.x;
    arg1->y = ((BattleScene_GetParticipantModelWidth(arg0) * 2) / 50.0f) * arg0->model.unk_030.y;
    arg1->z = ((BattleScene_GetParticipantModelRadius(arg0) * 2) / 50.0f) * arg0->model.unk_030.x;
}

void BattleScene_GetParticipantModelRotation(Battler* arg0, Vec3s* arg1) {
    arg1->x = arg0->model.unk_01E.x;
    arg1->y = arg0->model.unk_01E.y;
    arg1->z = arg0->model.unk_01E.z;
}

u16 Battle_GetActiveMonHp(Battler* arg0) {
    BattleMon* ptr = &arg0->ownRoster->party[arg0->unk_654.partyIndex];

    return ptr->currentHP;
}

s16 BattleScene_GetParticipantFacingAngle(Battler* arg0) {
    return arg0->yawBase << 0xE;
}

s32 BattleAnim_GetSpeciesBySideIndex(s32 arg0) {
    return D_84390010[arg0]->model.modelId;
}

s32 BattleAnim_GetOwnerSpecies(Battler* arg0) {
    return arg0->model.modelId;
}

u8 BattleScene_IsParticipantModelVisible(Battler* arg0) {
    s32 ret = arg0->model.unk_000.unk_01 & 1;
    return ret;
}

void BattleScene_GetParticipantModelPosition(Battler* arg0, Vec3f* arg1) {
    arg1->x = arg0->model.unk_024.x;
    arg1->y = arg0->model.unk_024.y;
    arg1->z = arg0->model.unk_024.z;
}
...
void BattleAnim_GetOwnerDefaultAnchorPosition(Battler* arg0, Vec3f* arg1) {
    ...
    if (BattleScene_GetParticipantModelHeight(arg0) != 0.0f) {
        arg1->x = arg0->model.unk_024.x;
        arg1->y = arg0->model.unk_024.y + var_fs0;
        arg1->z = arg0->model.unk_024.z;
    } else {
        arg1->x = arg0->model.unk_024.x;
        arg1->y = BattleAnim_GetOwnerModelHeight(arg0) + arg0->model.unk_024.y + var_fs0;
        arg1->z = arg0->model.unk_024.z;
    }
...
void BattleScene_GetParticipantAuxiliaryModelPosition(Battler* arg0, Vec3f* arg1) {
    arg1->x = arg0->secondaryModel.unk_024.x;
    arg1->y = arg0->secondaryModel.unk_024.y + 2.5f;
    arg1->z = arg0->secondaryModel.unk_024.z;
}

f32 BattleAnim_GetOwnerModelHeight(Battler* arg0) {
    if (arg0->presentationSubState == 0x10) {
        return BattleScene_GetParticipantModelWidth(arg0);
    }
    return BattleScene_GetParticipantModelWidth(arg0) * arg0->model.unk_030.y;
}

f32 BattleScene_GetParticipantModelRadiusScaled(Battler* arg0) {
    return BattleScene_GetParticipantModelRadius(arg0) * arg0->model.unk_030.y;
}

unk_D_86002F58_004_000_004* Battle_GetMoveEffectListEntry(Battler* arg0, s32 arg1) {
    return arg0->sessionTeams->moveEffectListRoot->unk_00[2]->unk_00[arg1];
}

s32 Battle_GetTrainerId(Battler* arg0, UNUSED s32 arg1) {
    return arg0->sessionTeams->iconSpeciesId;
}

char* Battle_GetActiveMoveName(Battler* arg0) {
    return Text_GetString(NULL, 0, D_843900B8, arg0->unk_654.monRuntime.currentMoveId - 1);
}

u8* Battle_GetActiveMonNickname(Battler* arg0) {
    return arg0->ownRoster->party[arg0->unk_654.partyIndex].nickname;
}

void BattleScene_SetParticipantModelFlags(Battler* arg0, s32 arg1, s32 arg2) {
    arg0->presentationSubState = arg1;
    arg0->presentationSubStateArg = arg2;
}
...
void Battle_AdvanceSecondaryModelAnimIfFinished(Battler* arg0, Battler* arg1) {
    ...
    if (!(sp20->battleStateFlags & 0x4002)) {
        if ((BattleAnim_IsSessionBusy(arg0) == 0) && (arg1->model.unk_040.unk_00 != -1) &&
            (ModelAnim_IsFinished(&arg1->model) == 1)) {
            if (sp20->battleStateFlags & 0x200) {
                ModelAnim_SetAnimation(&arg1->model, sp2C->animationId);
            } else if ((sp20->battleStateFlags & 1) && (BattleScene_ByteArrayContains(arg1->model.modelId, D_84384590, 8) != 0)) {
                ModelAnim_SetAnimation(&arg1->model, sp28->animationId);
            } else {
                if (arg1->model.modelId == 0x84) {
                    idx = BattleAnim_RandomRange(5);
                    ModelAnim_SetAnimation(&arg1->model, idx + 0xE);
                } else {
                    ModelAnim_SetAnimation(&arg1->model, sp30->animationId);
                }

                if (!(sp20->battleStateFlags & 1)) {
                    BattleAnim_SetModelEventTrackAndState(arg0, 0xA5, 1);
                }
            }

            ModelAnim_SetFrame(&arg1->model, 0);
        }
    }
}
...
void Battle_ResetModelToIdleAnim(Battler* arg0) {
    ...
    if (!(sp24->battleStateFlags & 0x4002) && (BattleAnim_IsSessionBusy(arg0) == 0) && (arg0->model.unk_040.unk_00 != -1)) {
        ModelAnim_SetFrame(&arg0->model, 0);
        if (sp24->battleStateFlags & 0x200) {
            ModelAnim_SetAnimation(&arg0->model, sp30->animationId);
        } else if ((sp24->battleStateFlags & 1) && (BattleScene_ByteArrayContains(arg0->model.modelId, D_84384590, 8) != 0)) {
            ModelAnim_SetAnimation(&arg0->model, sp2C->animationId);
        } else {
            if (arg0->model.modelId == 0x84) {
                ModelAnim_SetAnimation(&arg0->model, BattleAnim_RandomRange(5) + 0xE);
            } else {
                ModelAnim_SetAnimation(&arg0->model, sp34->animationId);
            }

            if (!(sp24->battleStateFlags & 1)) {
                BattleAnim_SetModelEventTrackAndState(arg0, 0xA5, 1);
            }
        }
    }
...
void BattleScene_RebindParticipantToSide(Battler* arg0, s32 arg1) {
    ...
    temp_v0->partyIndex = temp_v0->selectedPartyIndex;
    arg0->presentation.trainerIndex = temp_v0->activeSideIndex;
}
...
s32 Battle_HasUsableSleepStatusTarget(Battler* arg0) {
    ...
    for (i = 0; i < BattleScene_GetSelectedSideTeamSize(arg0); i++) {
        ptr = &arg0->ownRoster->party[i];
        if ((ptr->status & 0x20) && (arg0->unk_654.monRuntime.unk_16[temp_s0->partyIndex + temp_s0->activeSideIndex * 3] == 0)) {
            return 1;
        }
    }
    ...
    if (arg0->sessionTeams->playerCount == 2) {
        for (i = 0; i < BattleScene_GetOpposingSelectedSideTeamSize(arg0); i++) {
            ptr = &arg0->sessionTeams->teams[temp_s0->activeSideIndex == 0]->party[i];
            if ((ptr->status & 0x20) &&
                (arg0->unk_654.monRuntime.unk_16[temp_s0->partyIndex + (temp_s0->activeSideIndex == 0) * 3] == 0)) {
                return 1;
            }
        }
    }
...
s32 Battle_HasUsableMajorStatusTarget(Battler* arg0) {
    ...
    for (i = 0; i < BattleScene_GetSelectedSideTeamSize(arg0); i++) {
        ptr = &arg0->ownRoster->party[i];
        if ((ptr->status & 7) && (arg0->unk_654.monRuntime.unk_16[temp_s0->partyIndex + temp_s0->activeSideIndex * 3] == 0)) {
            return 1;
        }
    }
    ...
    if (arg0->sessionTeams->playerCount == 2) {
        for (i = 0; i < BattleScene_GetOpposingSelectedSideTeamSize(arg0); i++) {
            ptr = &arg0->sessionTeams->teams[temp_s0->activeSideIndex == 0]->party[i];
            if ((ptr->status & 7) && (arg0->unk_654.monRuntime.unk_16[temp_s0->partyIndex + (temp_s0->activeSideIndex == 0) * 3] == 0)) {
                return 1;
            }
        }
    }
...
s32 BattleScene_GetCombinedTeamSize(Battler* arg0) {
    if (arg0->sessionTeams->playerCount != 2) {
        return arg0->sessionTeams->teams[0]->partyCount;
    }
    return arg0->sessionTeams->teams[1]->partyCount + arg0->sessionTeams->teams[0]->partyCount;
}

u8 BattleScene_GetRosterTeamSize(TeamRoster* arg0) {
    return arg0->partyCount;
}

s32 BattleScene_GetParticipantDisplayPlayerNumber(Battler* arg0) {
    return arg0->sessionTeams->teams[arg0->presentation.trainerIndex]->trainerSlotId + 1;
}
...
void BattleScene_ReinitParticipantBodyModel(Battler* arg0, Battler* arg1, s32 arg2, s32 arg3) {
    ...
    ModelRenderer_ClearDisplayObject(&arg1->model);

    if (arg0 == D_84390010[0]) {
        arg1->model.poolIndex = 0;
    } else {
        arg1->model.poolIndex = 1;
    }

    Model_InitDisplayObject(&arg1->model, 0, arg2, sp20);
    Battle_LoadSpeciesDataTables(arg0, arg3);
    ModelAnim_SetFrame(&arg1->model, 0);
    ModelAnim_SetAnimation(&arg1->model, 0);

    if ((arg1->model.modelId == 0x32) || (arg1->model.modelId == 0x33)) {
        arg1->model.unk_000.unk_02 &= 0xFFBF;
    } else {
        arg1->model.unk_000.unk_02 |= 0x40;
    }

    if (!(arg0->unk_654.battleStateFlags & 0x200)) {
        if (arg0 == D_84390010[0]) {
            BattleScene_PositionParticipantModel(arg0);
            arg1->model.unk_01E.y = 0x4000;
        } else {
            BattleScene_PositionParticipantModel(arg0);
            arg1->model.unk_01E.y = -0x4000;
        }
...
void BattleScene_ReinitParticipantOwnerModel(Battler* arg0, PresentationState* arg1, s16 arg2) {
    ...
    if (arg0 == D_84390010[0]) {
        arg1->model.poolIndex = 0xFF;
    } else {
        arg1->model.poolIndex = 0xFF;
    }

    if (arg0 == D_84390010[0]) {
        Model_InitDisplayObject(&arg1->model, 1, arg2, sp24);
    } else {
        Model_InitDisplayObject(&arg1->model, 2, arg2, sp24);
    }
...
void BattleScene_ReinitParticipantSecondaryModels(Battler* arg0, s16 arg1) {
    ...
    for (i = 0; i < 2; i++) {
        var_s0 = &arg0->swayModels[i];

        ModelRenderer_ClearDisplayObject(&var_s0->unk_000);
        if (arg0 == D_84390010[0]) {
            var_s0->unk_000.poolIndex = 0xFF;
        } else {
            var_s0->unk_000.poolIndex = 0xFF;
        }
...
void Battle_LoadOwnerModelForSpecies(Battler* arg0) {
    ...
    BattleScene_ReinitParticipantOwnerModel(arg0, &arg0->presentation, sp26);
    BattleScene_ReinitParticipantSecondaryModels(arg0, sp26);
    Battle_ResetEventTrack(arg0);
    ptr->battleStateFlags &= 0x1800;
...
void Battle_LoadOwnerModelForSwitchIn(Battler* arg0) {
    ...
    BattleScene_ReinitParticipantSecondaryModels(arg0, sp26);
    Battle_ResetEventTrack(arg0);
    ptr->faintSequenceState = 0;
    ptr->battleStateFlags &= 0x1800;
    Vec3f_SetComponentsDuplicate(&arg0->model.unk_030, 1.0f, 1.0f, 1.0f);
}

void Battle_ResetOwnerModelToNeutralPlaceholder(Battler* arg0) {
    Model_SetMaterialColor(&arg0->model, 0xFF, 0xFF, 0xFF, arg0->unk_654.modelAlpha = 0xFF);
    arg0->unk_654.cachedModelId = arg0->model.modelId;
...
void Battle_ReloadModelForActiveMove(Battler* arg0) {
    ...
    ptr->modelAlpha = 0xFF;
    Model_SetMaterialColor(&arg0->model, 0xFF, 0xFF, 0xFF, ptr->modelAlpha);
