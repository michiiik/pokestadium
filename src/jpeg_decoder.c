...
void Jpeg_BuildDspInput(unk_func_80003680_sp27* arg0, JpegHuffmanTable* arg1, unk_func_80003680_sp300* arg2) {
    ...
    arg0->subsamplingVariant = 2;
    arg0->dcLumaTable = &arg1[0];
    arg0->acLumaTable = &arg1[2];
    arg0->dcChromaTable = &arg1[1];
    arg0->acChromaTable = &arg1[3];
    arg0->unk_18 = arg2->hasRestartMarkers;
}
...
void* Storage_LoadAssetByLbaRange(unk_func_800041C0* arg0, s32 arg1) {
    ...
    LeoLBAToByte(arg0->startLba, arg0->lbaCount, &sp44);
    sp44 = ALIGN16(sp44);

    temp_v0 = main_pool_alloc(sp44, var_s0);

    if (temp_v0 != NULL) {
        temp_s0 = arg0->headerOffset + temp_v0;

        Storage_QueueDiskTransfer(0, temp_v0, arg0->startLba, arg0->lbaCount, &D_800A62C0, 0);
        ...
        if (((u32*)temp_s0->magic)[0] == 'PERS' && (((u32*)temp_s0->magic)[1] == '-SZP')) {
            ...
            sp40 = Asset_CopyUncompressed(temp_v0, arg0->headerOffset, arg0->byteSize, arg1);
        }
    }
...
unk_func_800041C0* Storage_SetLbaRange(unk_func_800041C0* arg0, s32 arg1, s32 arg2) {
    arg0->startLba = arg1;
    arg0->lbaCount = arg2 - arg1;
    arg0->headerOffset = 0;

    LeoLBAToByte(arg0->startLba, arg0->lbaCount, &arg0->byteSize);
...
unk_func_800041C0* Storage_SetByteRange(unk_func_800041C0* arg0, u32 arg1, u32 offset, u32 size) {
    ...
    arg0->startLba = sp28 + arg1;
    arg0->lbaCount = (sp24 - sp28) + 1;
    arg0->headerOffset = offset - sp2C;
    arg0->byteSize = size;
...
Fragment* BinArchive_LoadFileFromRom(BinArchive* arg0, BinArchiveFile* arg1) {
    u8* temp_a0 = arg0->romStart + arg1->offset;
...
void* BinArchive_LoadFileBuffered(BinArchive* arg0, BinArchiveFile* arg1) {
    ...
    Storage_SetByteRange(&sp1C, arg0->romStart, arg1->offset, arg1->size);
...
void* BinArchive_GetFile(BinArchive* archive, s32 file_number) {
    ...
    if (file_number < archive->num_files) {
        if (archive->flags & 1) {
        ...
        } else if (!(archive->flags & 4) && (sp18->cachedPtr != NULL)) {
            var_a2 = sp18->cachedPtr;
        } else {
            ...
            if (var_a2 != NULL) {
                if ((((u32*)var_a2->magic)[0] == 'FRAG') && (((u32*)var_a2->magic)[1] == 'MENT')) {
                    Fragment_Register(archive->fragmentModuleId, var_a2);
                }

                sp18->cachedPtr = var_a2;
            }
        }
    }
