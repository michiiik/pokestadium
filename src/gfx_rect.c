...
void Gfx_SetScissorRect(Gfx** gfx_p, s16 x, s16 y, s16 width, s16 height) {
    if (D_80068BB0 != NULL) {
        ...
        *gfx_p = gfx;
        ...
        GfxRect_SetBounds(&D_800A7440, x, y, x + width - 1, y + height - 1);
    }
}
...
unk_D_80068BB0* GfxImage_Allocate(s32 fmt, s32 size, s32 width, s32 height, s32 side) {
    ...
    if (sp34 != NULL) {
        ...
        GfxImage_Initialize(sp34, fmt, size, width, height, (u8*)sp34 + sizeof(unk_D_80068BB0));
    }
...
void GfxImage_ResetCurrent(void) {
    D_80068BB0 = NULL;
    GfxRect_SetBounds(&D_800A7440, 0, 0, 0, 0);
}
...
void GfxImage_SetRenderTarget(Gfx** gfx_p, unk_D_80068BB0* arg1) {
    ...
    D_80068BB0 = arg1;
    Gfx_SetScissorRect(&gfx, 0, 0, arg1->width, arg1->height);
...
void GfxImage_FillCurrent(Gfx** gfx_p, u16 fill_colour) {
    GfxImage_FillRectangle(gfx_p, 0, 0, D_80068BB0->width, D_80068BB0->height, (fill_colour << 0x10) | fill_colour);
}
