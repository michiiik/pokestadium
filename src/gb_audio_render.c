...
s16 GbAudio_SampleSquare2(void);
s16 GbAudio_SampleNoise(void);

#ifdef NON_MATCHING
void GbAudio_RenderSamples(u32 arg0) {
    s32 pad[3];
    s16 sp4C[4];
    u32 i;
    f32 var_fs0;
    ...
    for (i = 0; i < arg0; i++) {
        ...
        if (D_800FD008.unk_2C & 0x80) {
            ...
            sp4C[0] = GbAudio_SampleSquare1();
            sp4C[1] = GbAudio_SampleSquare2();
            sp4C[3] = GbAudio_SampleNoise();
